...
@Import({ SpringFunctionaltestWebRsclInfraConfig.class,
        SpringFunctionaltestWebRsclCodelistConfig.class })
public class SpringFunctionaltestWebRsclDomainConfig {
