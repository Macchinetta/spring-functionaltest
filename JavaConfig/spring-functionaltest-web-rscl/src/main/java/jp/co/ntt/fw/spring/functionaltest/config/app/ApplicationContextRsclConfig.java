...
public class ApplicationContextRsclConfig {
    ...
    public HttpComponentsClientHttpRequestFactory httpComponentsClientAuthHttpRequestFactory() throws Exception {
        return new HttpComponentsClientHttpRequestFactory(proxyAuthHttpClientBuilder()
                .build());
    }
