...
<c:set var="titleKey" value="title.rscl.sendConvertUserInf" />
...
<div id="wrapper">
	...
	<h1 id="screenTitle">コンバートメッセージ入力</h1>

	<form:form action="${pageContext.request.contextPath}/jsp/rscl/${testId}"
