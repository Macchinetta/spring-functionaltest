    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <br />
                <form:form method="POST" action="${pageContext.request.contextPath}/jsp/sendmail" modelAttribute="emailSendingForm" enctype="multipart/form-data" cssClass="form-horizontal">
                    <fieldset>
                        <legend>メール送信</legend>
