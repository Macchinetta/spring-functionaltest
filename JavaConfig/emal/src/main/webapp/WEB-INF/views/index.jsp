    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <div>[EMAL07] JNDI経由でのメール送信方法</div>
                <ul>
                    <li>emal0701001 (<a id="emal0701001_jsp" href="${pageContext.request.contextPath}/jsp/0701/001">JSP</a> / Thymeleaf)</li>
                    <li>emal0701002 (<a id="emal0701002_jsp" href="${pageContext.request.contextPath}/jsp/0701/002">JSP</a> / Thymeleaf)</li>
                </ul>
            </div>
        </div>
