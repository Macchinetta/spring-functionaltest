...
database=H2
database.url=jdbc:h2:tcp://localhost:9202/mem:spring-functionaltest;DB_CLOSE_DELAY=-1;LOCK_TIMEOUT=2000
database.username=sa
database.password=
database.driverClassName=org.h2.Driver
database.url.open=jdbc:h2:tcp://localhost:9202/mem:spring-functionaltest-open;DB_CLOSE_DELAY=-1
database.url.close=jdbc:h2:tcp://localhost:9202/mem:spring-functionaltest-close;DB_CLOSE_DELAY=-1
