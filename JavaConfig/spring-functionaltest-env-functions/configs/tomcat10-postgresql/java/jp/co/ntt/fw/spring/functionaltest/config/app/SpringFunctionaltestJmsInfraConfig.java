...
public class SpringFunctionaltestJmsInfraConfig {
     ...
     * @param cachingConnectionFactory Bean defined by SpringFunctionaltestJmsEnvConfig#cachingConnectionFactory()
    ...
    public ChainedTransactionManager sendChainedTransactionManager(
        ...
        ChainedTransactionManager bean = new ChainedTransactionManager(sendJmsTransactionManager, (DataSourceTransactionManager) transactionManager);
        return bean;
    }
