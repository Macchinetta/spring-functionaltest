...
<c:set var="titleKey" value="title.dmly.process" />
...
<div class="row">
  ...
  <form:form modelAttribute="deliveryOrderProcessForm"
    action="${pageContext.request.contextPath}/jsp/deliveryorder/process">
    <fieldset>
      <legend>伝播モード</legend>
      <div class="container">
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-10">
            <label class="form-label">jakarta.transaction.Transactional</label>
          </div>
        </div>
        <br>
