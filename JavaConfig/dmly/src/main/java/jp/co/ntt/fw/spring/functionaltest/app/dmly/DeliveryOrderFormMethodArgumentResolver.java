...
public class DeliveryOrderFormMethodArgumentResolver implements HandlerMethodArgumentResolver {

    private static final DateTimeFormatter DATE_TIME_FORMATTER =
            DateTimeFormatter.ofPattern("uuuu/MM/dd HH:mm:ss").withLocale(Locale.JAPANESE)
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        params.setDeliveryNo(Integer.parseInt(webRequest.getParameter("deliveryNo")));
        ...
        if (StringUtils.hasText(acceptDatetime)) {
            params.setAcceptDatetime(LocalDateTime.parse(acceptDatetime, DATE_TIME_FORMATTER));
        }
        String completionDatetime = webRequest.getParameter("completionDatetime");
        if (StringUtils.hasText(completionDatetime)) {
            params.setCompletionDatetime(
                    LocalDateTime.parse(completionDatetime, DATE_TIME_FORMATTER));
        }
