...
public class DeliveryOrderListFormMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        params.setFromAcceptDatetime(LocalDateTime
                .parse(webRequest.getParameter("fromAcceptDatetime"), DATE_TIME_FORMATTER));
        params.setToAcceptDatetime(LocalDateTime.parse(webRequest.getParameter("toAcceptDatetime"),
                DATE_TIME_FORMATTER));
        params.setUpdateCompletionDatetime(LocalDateTime
                .parse(webRequest.getParameter("updateCompletionDatetime"), DATE_TIME_FORMATTER));
        return params;
    }
