...
import jp.co.ntt.fw.spring.functionaltest.app.spsm.SPSMController;
import jp.co.ntt.fw.spring.functionaltest.app.spsm.SPSM_JSP_02Controller;
import jp.co.ntt.fw.spring.functionaltest.app.spsm.SPSM_JSP_03Controller;
import jp.co.ntt.fw.spring.functionaltest.app.spsm.SPSM_JSP_04Controller;
import jp.co.ntt.fw.spring.functionaltest.app.spsm.SPSM_JSP_05Controller;
import jp.co.ntt.fw.spring.functionaltest.app.spsm.SPSM_Thymeleaf_02Controller;
import jp.co.ntt.fw.spring.functionaltest.app.spsm.SPSM_Thymeleaf_03Controller;
import jp.co.ntt.fw.spring.functionaltest.app.spsm.SPSM_Thymeleaf_04Controller;
import jp.co.ntt.fw.spring.functionaltest.app.spsm.SPSM_Thymeleaf_05Controller;
...
public class SpringMvcConfig implements WebMvcConfigurer {
    ...
    /**
     * Configure {@link SPSMController} bean.
     * @return Bean of configured {@link SPSMController}
     */
    @Bean
    public SPSMController sPSMController() {
        return new SPSMController();
    }

    /**
     * Configure {@link SPSM_JSP_02Controller} bean.
     * @return Bean of configured {@link SPSM_JSP_02Controller}
     */
    @Bean
    public SPSM_JSP_02Controller sPSM_JSP_02Controller() {
        return new SPSM_JSP_02Controller();
    }

    /**
     * Configure {@link SPSM_JSP_03Controller} bean.
     * @return Bean of configured {@link SPSM_JSP_03Controller}
     */
    @Bean
    public SPSM_JSP_03Controller sPSM_JSP_03Controller() {
        return new SPSM_JSP_03Controller();
    }

    /**
     * Configure {@link SPSM_JSP_04Controller} bean.
     * @return Bean of configured {@link SPSM_JSP_04Controller}
     */
    @Bean
    public SPSM_JSP_04Controller sPSM_JSP_04Controller() {
        return new SPSM_JSP_04Controller();
    }

    /**
     * Configure {@link SPSM_JSP_05Controller} bean.
     * @return Bean of configured {@link SPSM_JSP_05Controller}
     */
    @Bean
    public SPSM_JSP_05Controller sPSM_JSP_05Controller() {
        return new SPSM_JSP_05Controller();
    }

    /**
     * Configure {@link SPSM_Thymeleaf_02Controller} bean.
     * @return Bean of configured {@link SPSM_Thymeleaf_02Controller}
     */
    @Bean
    public SPSM_Thymeleaf_02Controller sPSM_Thymeleaf_02Controller() {
        return new SPSM_Thymeleaf_02Controller();
    }

    /**
     * Configure {@link SPSM_Thymeleaf_03Controller} bean.
     * @return Bean of configured {@link SPSM_Thymeleaf_03Controller}
     */
    @Bean
    public SPSM_Thymeleaf_03Controller sPSM_Thymeleaf_03Controller() {
        return new SPSM_Thymeleaf_03Controller();
    }

    /**
     * Configure {@link SPSM_Thymeleaf_04Controller} bean.
     * @return Bean of configured {@link SPSM_Thymeleaf_04Controller}
     */
    @Bean
    public SPSM_Thymeleaf_04Controller sPSM_Thymeleaf_04Controller() {
        return new SPSM_Thymeleaf_04Controller();
    }

    /**
     * Configure {@link SPSM_Thymeleaf_05Controller} bean.
     * @return Bean of configured {@link SPSM_Thymeleaf_05Controller}
     */
    @Bean
    public SPSM_Thymeleaf_05Controller sPSM_Thymeleaf_05Controller() {
        return new SPSM_Thymeleaf_05Controller();
    }
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        registry.addViewController("/jsp/invalidSessionError")
                .setViewName("jsp/spsm/invalidSessionError");
        registry.addViewController("/thymeleaf/invalidSessionError")
                .setViewName("thymeleaf/spsm/invalidSessionError");
    }
}
