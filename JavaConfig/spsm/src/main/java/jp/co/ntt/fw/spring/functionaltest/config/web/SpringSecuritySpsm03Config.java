...
public class SpringSecuritySpsm03Config {
    ...
    public SecurityFilterChain filterChainJsp0301(HttpSecurity http,
        ...
        http.authorizeHttpRequests(authz -> authz.requestMatchers(antMatcher("/jsp/0301/**"))
    ...
    public SecurityFilterChain filterChainThymeleaf0301(HttpSecurity http,
        ...
        http.httpBasic(Customizer.withDefaults());
        http.authorizeHttpRequests(authz -> authz.requestMatchers(antMatcher("/thymeleaf/0301/**"))
                .authenticated().requestMatchers(antMatcher("/**")).permitAll());
