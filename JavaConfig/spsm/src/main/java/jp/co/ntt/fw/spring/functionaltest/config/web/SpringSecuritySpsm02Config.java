...
public class SpringSecuritySpsm02Config {
    ...
    public SecurityFilterChain filterChainJsp0201001(HttpSecurity http,
        ...
        http.sessionManagement(
                sessionManagement -> sessionManagement.enableSessionUrlRewriting(true));
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/0201/001/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0201/001/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0201/**")).authenticated()
    ...
    public SecurityFilterChain filterChainJsp0202001(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/jsp/0202/001/**"));
        http.authenticationManager(userLoginManagerForAthn);
        http.sessionManagement(
                sessionManagement -> sessionManagement.enableSessionUrlRewriting(true)
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/0202/001/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0202/001/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0202/**")).authenticated()
                        .requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainJsp0202002(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/jsp/0202/002/**"));
        http.authenticationManager(userLoginManagerForAthn);
        http.sessionManagement(
                sessionManagement -> sessionManagement.enableSessionUrlRewriting(true)
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/0202/002/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0202/002/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0202/**")).authenticated()
                        .requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf0201(HttpSecurity http,
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/0201/001/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0201/001/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0201/**"))
    ...
    public SecurityFilterChain filterChainThymeleaf0202(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/thymeleaf/0202/001/**"));
        http.authenticationManager(userLoginManagerForAthn);
        http.sessionManagement(
                sessionManagement -> sessionManagement.enableSessionUrlRewriting(true));
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/0202/001/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0202/001/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0202/**"))
                        .authenticated().requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf0202002(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/thymeleaf/0202/002/**"));
        http.authenticationManager(userLoginManagerForAthn);
        http.sessionManagement(
                sessionManagement -> sessionManagement.enableSessionUrlRewriting(true)
                        .sessionFixation(fixation -> fixation.newSession()));
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/0202/002/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0202/002/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0202/**"))
                        .authenticated().requestMatchers(antMatcher("/**")).permitAll());
