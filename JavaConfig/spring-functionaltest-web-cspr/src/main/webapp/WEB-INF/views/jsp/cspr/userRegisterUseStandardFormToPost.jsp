...
<c:set var="titleKey" value="title.cspr.userRegisterUseStandardFormToPost" />
...
<body>
  ...
  <div class="container">
<div id="wrapper">
  <h3 id="screenTitle">ユーザ登録画面(html標準のformタグを使用/POST)</h3>

  <form id="userForm" action="${pageContext.request.contextPath}/jsp" class="form-horizontal"
    method="post">
    <spring:nestedPath path="userForm">
      <fieldset>
        ...
        <div class="form-group col col-md-5">
          <input id="confirm" type="submit" name="confirmUseStandardFormToPost"
            class="btn btn-default" value="確認" />
          <sec:csrfInput />
        </div>
      </fieldset>
    </spring:nestedPath>
