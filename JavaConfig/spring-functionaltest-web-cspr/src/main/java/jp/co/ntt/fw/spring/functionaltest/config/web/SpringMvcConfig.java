...
@ComponentScan(basePackages = {
        "jp.co.ntt.fw.spring.functionaltest.app" }, excludeFilters = {
                ...
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = CSPR_Thymeleaf_0201005Controller.class) })
@Configuration
@EnableWebMvc
...
public class SpringMvcConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        registry.addViewController("jsp/cspr/login").setViewName(
                "jsp/cspr/login");
        registry.addViewController("thymeleaf/cspr/login").setViewName(
                "thymeleaf/cspr/login");
    }
