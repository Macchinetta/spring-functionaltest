...
@Import({ SpringFunctionaltestWebCsprInfraConfig.class,
        SpringFunctionaltestWebCsprCodelistConfig.class })
public class SpringFunctionaltestWebCsprDomainConfig {
