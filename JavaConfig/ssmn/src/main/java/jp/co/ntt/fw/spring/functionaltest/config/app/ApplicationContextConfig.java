...
@Import({SpringFunctionaltestWebSsmnDomainConfig.class})
public class ApplicationContextConfig {
    ...
    public MessageSource messageSource() {
        ...
        bean.setBasenames("i18n/application-messages", "i18n/application-messages-ssmn");
        return bean;
    }
    ...
    public ExceptionCodeResolver exceptionCodeResolver() {
        ...
        map.put("HttpSessionRequiredException", "e.sf.fw.8002");
