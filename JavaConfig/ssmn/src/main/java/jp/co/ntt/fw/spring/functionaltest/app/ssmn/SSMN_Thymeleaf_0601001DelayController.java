...
public class SSMN_Thymeleaf_0601001DelayController {

    private static final Logger logger =
            LoggerFactory.getLogger(SSMN_Thymeleaf_0601001DelayController.class);
    ...
    public String handle01001(Model model, SessionStatus sessionStatus) {
        ...
        return "redirect:/thymeleaf/0601/001/synchronism/delay?createForm";
    }

    @GetMapping(params = "createForm")
    public String createMemberForm() {
        return "thymeleaf/ssmn/createMemberAll";
    }
    ...
    public String createMember(
        ...
        return "redirect:/thymeleaf/0601/001/synchronism/delay?complete";
    }
