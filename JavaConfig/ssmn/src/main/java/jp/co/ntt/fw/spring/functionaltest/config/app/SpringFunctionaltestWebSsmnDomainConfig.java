...
@Import({SpringFunctionaltestWebSsmnInfraConfig.class,
        SpringFunctionaltestWebSsmnCodelistConfig.class})
public class SpringFunctionaltestWebSsmnDomainConfig {
