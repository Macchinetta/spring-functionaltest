...
@RequestMapping(value = "jsp/0301/001")
public class SSMN_JSP_0301001Controller {

    private static final Logger logger = LoggerFactory.getLogger(SSMN_JSP_0301001Controller.class);
    ...
    public String handle01001(SessionStatus sessionStatus) {
        ...
        return "redirect:/jsp/0301/001?personalForm";
    }
