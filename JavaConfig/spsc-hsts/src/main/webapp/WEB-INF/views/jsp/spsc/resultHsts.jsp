...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.spsc.result" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h3 id="screenTitle">結果画面(Http)</h3>
                <p><a id="httpReload" href="http://${connectIp}/spsc-hsts/jsp/${testNo}">Http Reload</a></p>
                <p><a id="httpsReload" href="https://${connectIp}/spsc-hsts/jsp/${testNo}">Https Reload</a></p>
                <br />
                <a id="spsc0101001" href="${pageContext.request.contextPath}">go to SPSC index</a>
            </div>
        </div>
