...
@Import({SpringFunctionaltestWebRestInfraConfig.class,
        SpringFunctionaltestWebRestCodelistConfig.class})
public class SpringFunctionaltestWebRestDomainConfig {
