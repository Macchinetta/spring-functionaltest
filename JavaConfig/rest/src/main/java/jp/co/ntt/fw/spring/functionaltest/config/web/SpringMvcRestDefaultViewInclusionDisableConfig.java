...
@EnableWebMvc
@Configuration
public class SpringMvcRestDefaultViewInclusionDisableConfig implements WebMvcConfigurer {
    ...
    public ObjectMapper objectMapper() {
        ...
        bean.setFeaturesToDisable(MapperFeature.DEFAULT_VIEW_INCLUSION);
        bean.setFeaturesToEnable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);
