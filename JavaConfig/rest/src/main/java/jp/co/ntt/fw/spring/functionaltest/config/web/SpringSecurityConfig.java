...
public class SpringSecurityConfig {
    ...
    @Bean
    @Order(1)
    public SecurityFilterChain filterChainApiView(HttpSecurity http) throws Exception {
        http.securityMatcher(antMatcher("/api/v1/DEFAULT_VIEW_INCLUSION-*/**"));
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authz -> authz.requestMatchers(antMatcher("/**")).denyAll());
