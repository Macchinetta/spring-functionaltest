...
public class ApplicationContextConfig {
    ...
    public MessageSource messageSource() {
        ...
        bean.setBasenames("i18n/application-messages", "i18n/application-messages-rest");
        return bean;
    }
    ...
    public ExceptionCodeResolver exceptionCodeResolver() {
        ...
        map.put("HttpRequestMethodNotSupportedException", "e.sf.fw.6001");
        map.put("MethodArgumentNotValidException", "e.sf.fw.7002");
        map.put("UnrecognizedPropertyException", "e.sf.fw.7004");
        map.put("OptimisticLockingFailureException", "e.sf.fw.8006");
        map.put("PessimisticLockingFailureException", "e.sf.fw.8006");
