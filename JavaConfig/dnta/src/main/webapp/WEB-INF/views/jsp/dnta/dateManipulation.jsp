    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <br />
                <form:form action="${pageContext.request.contextPath}/jsp/dateManipulation" method="get" modelAttribute="calcDateForm" class="form-horizonal">
                    <legend>日時の計算</legend>
                ...
                <br />
                <form:form action="${pageContext.request.contextPath}/jsp/dateManipulation" class="form-horizontal" method="get" modelAttribute="compareDateTimeForm">
                    <fieldset>
                        <legend>日時比較</legend>
                        <div class="form-group">
                            <table>
                ...
                <br />
                <form:form action="${pageContext.request.contextPath}/jsp/dateManipulation" cssClass="form-horizontal" method="get" modelAttribute="changeTypeForm">
                    <legend>日時判定</legend>
                    <div class="form-group">
                        <div class="col col-md-2">
