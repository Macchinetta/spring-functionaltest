...
public class DateAndTimeTest {
    ...
    public void testDNTA0101_001() throws InterruptedException {
        ...
        assertThrows(DateTimeException.class,
                () -> localTimeNow.format(DateTimeFormatter.ofPattern("yyyy-MM-dd")));

        // 時刻でフォーマット可能なこと
        assertThat(localTimeNow.format(DateTimeFormatter.ofPattern("HH:mm:ss.SSSSSSSSS")),
                is(notNullValue()));
    }
    ...
    public void testDNTA0101_002() {
        ...
        // 時刻が存在しないこと
        assertThrows(DateTimeException.class,
                () -> localDate.format(DateTimeFormatter.ofPattern("HH:mm:ss.SSSSSSSSS")));

        // 日付でフォーマット可能なこと
        assertThat(localDate.format(DateTimeFormatter.ofPattern("yyyy-MM-dd")), is(notNullValue()));
    }
    ...
    public void testDNTA0102_005() {
        ...
        LocalDate localDate2 = localDate1.with(TemporalAdjusters.next(DayOfWeek.MONDAY));
    ...
    public void testDNTA0103_001() throws InterruptedException {
        ...
        // 日付が存在しないこと
        assertThrows(DateTimeException.class,
                () -> offsetTimeNow.format(DateTimeFormatter.ofPattern("yyyy-MM-dd")));

        // 時刻でフォーマット可能なこと
        assertThat(offsetTimeNow.format(DateTimeFormatter.ofPattern("HH:mm:ss.SSSSSSSSS")),
                is(notNullValue()));
        // +09:00
    ...
    public void testDNTA0201_003() {
        ZonedDateTime zonedDateTime1 =
                ZonedDateTime.of(2014, 3, 9, 1, 2, 3, 0, ZoneId.of("America/Los_Angeles"));
        ZonedDateTime zonedDateTime2 =
                ZonedDateTime.of(2014, 3, 9, 4, 5, 6, 0, ZoneId.of("America/Los_Angeles"));
    ...
    public void testDNTA0301_002() {
        ...
        assertThat(localDateTime.getMonthValue(), is(localDate.getMonthValue()));
        assertThat(localDateTime.getDayOfMonth(), is(localDate.getDayOfMonth()));
    ...
    public void testDNTA0301_004() {
        ...
        assertThat(localDate.getMonthValue(), is(localDateTime.getMonthValue()));
        assertThat(localDate.getDayOfMonth(), is(localDateTime.getDayOfMonth()));
    }
    ...
    public void testDNTA0301_006() {
        ...
        assertThat(zonedDateTime.getMonthValue(), is(offsetDateTime.getMonthValue()));
        assertThat(zonedDateTime.getDayOfMonth(), is(offsetDateTime.getDayOfMonth()));
    ...
    public void testDNTA0301_007() {
        ...
        assertThat(offsetDateTime.getMonthValue(), is(zonedDateTime.getMonthValue()));
        assertThat(offsetDateTime.getDayOfMonth(), is(zonedDateTime.getDayOfMonth()));
    ...
    public void testDNTA0302_001() {
        ...
        DateTimeFormatter dateAndTimeFormatter = DateTimeFormatter.ofPattern("uuuu-MM-dd HH:mm:ss");

        assertThat(dateFormat.format(date), is(localDateTime.format(dateAndTimeFormatter)));
    }
    ...
    public void testDNTA0302_002() {
        ...
        assertThat(localDateTime.format(dateAndTimeFormatter), is(dateFormat.format(date)));
    }

    @Test
    public void testDNTA0302_003() {
        LocalTime localTime = LocalTime.now();
        LocalDateTime localDateTime1 = localTime.atDate(LocalDate.of(2015, 12, 25));

        LocalDate localDate = LocalDate.now();
        LocalDateTime localDateTime2 = localDate.atTime(LocalTime.of(12, 10, 30));
        ...
        assertThat(dateFormat.format(date1), is(localDateTime1.format(dateAndTimeFormatter)));
        assertThat(dateFormat.format(date2), is(localDateTime2.format(dateAndTimeFormatter)));
    }
    ...
    public void testDNTA0401_003() {
        LocalDateTime localDateTime1 = LocalDateTime.of(2015, 12, 25, 22, 30, 50);
        ...
        assertThrows(UnsupportedTemporalTypeException.class,
                () -> Clock.offset(clock, Duration.of(1L, ChronoUnit.MONTHS)));
    }
    ...
    public void testDNTA0402_003() {
        ...
        Clock clock2 = Clock.fixed(Instant.now().plusSeconds(1L), ZoneId.systemDefault());
    ...
    public void testDNTA0403_001() {
        ...
        assertThrows(DateTimeParseException.class,
                () -> LocalTime.parse(strDateTime, timeFormatter));

        assertThrows(DateTimeParseException.class,
                () -> LocalDate.parse(strDateTime, dateFormatter));
    }
    ...
    public void testDNTA0404_001() {
        LocalDateTime localDateTime = LocalDateTime.of(2015, 2, 1, 12, 30, 50, 567);
    ...
    public void testDNTA0501_001() {
        ...
        assertThrows(DateTimeException.class, () -> JapaneseDate.of(1872, 12, 31));
    }
