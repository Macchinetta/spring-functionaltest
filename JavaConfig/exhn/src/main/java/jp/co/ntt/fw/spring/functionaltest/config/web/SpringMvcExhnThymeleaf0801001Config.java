...
public class SpringMvcExhnThymeleaf0801001Config implements WebMvcConfigurer {
    ...
    public SystemExceptionResolver systemExceptionResolver(
        ...
        exceptionMappings.setProperty("BusinessException", "thymeleaf/common/error/businessError");
        ...
        statusCodes.setProperty("thymeleaf/common/error/businessError",
                String.valueOf(HttpStatus.CONFLICT.value()));
        statusCodes.setProperty("thymeleaf/common/error/transactionTokenError",
                String.valueOf(HttpStatus.CONFLICT.value()));
        statusCodes.setProperty("thymeleaf/common/error/dataAccessError",
                String.valueOf(HttpStatus.INTERNAL_SERVER_ERROR.value()));
        statusCodes.setProperty("thymeleaf/common/error/operationError",
                String.valueOf(HttpStatus.BAD_REQUEST.value()));
        statusCodes.setProperty("thymeleaf/common/error/fileUploadError",
                String.valueOf(HttpStatus.BAD_REQUEST.value()));
