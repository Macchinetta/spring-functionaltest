...
@ComponentScan(basePackages = {"jp.co.ntt.fw.spring.functionaltest.app.exhn"}, excludeFilters = {
        ...
        @Filter(type = FilterType.ASSIGNABLE_TYPE,
                classes = EXHN_Thymeleaf_0601004Controller.class),
...
public class SpringMvcExhn0201001Config implements WebMvcConfigurer {
    ...
    public SystemExceptionResolver systemExceptionResolver(
        ...
        exceptionMappings.setProperty("BusinessException", "jsp/exhn/businessError");
        ...
        statusCodes.setProperty("jsp/exhn/businessError",
