...
import jp.co.ntt.fw.spring.functionaltest.domain.exception.SuperClassException;
...
public class SpringMvcExhn0601006Config implements WebMvcConfigurer {
    ...
    public SystemExceptionResolver systemExceptionResolver(
        ...
        bean.setExcludedExceptions(SuperClassException.class);
        bean.setCheckSubClass(true);
