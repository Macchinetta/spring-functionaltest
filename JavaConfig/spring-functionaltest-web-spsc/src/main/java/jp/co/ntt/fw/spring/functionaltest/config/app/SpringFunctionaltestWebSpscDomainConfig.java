...
@Import({ SpringFunctionaltestWebSpscInfraConfig.class,
        SpringFunctionaltestWebSpscCodelistConfig.class })
public class SpringFunctionaltestWebSpscDomainConfig {
