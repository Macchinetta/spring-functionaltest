...
@Import({ SpringFunctionaltestWebDmlyInfraConfig.class,
        SpringFunctionaltestWebDmlyCodelistConfig.class })
public class SpringFunctionaltestWebDmlyDomainConfig {
