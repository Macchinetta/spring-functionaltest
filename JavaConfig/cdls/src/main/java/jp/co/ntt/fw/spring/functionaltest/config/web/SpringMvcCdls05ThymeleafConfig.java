...
public class SpringMvcCdls05ThymeleafConfig implements WebMvcConfigurer {
    ...
    /**
     * Configure {@link CDLS_Thymeleaf_05Controller} bean.
     * @return Bean of configured {@link CDLS_Thymeleaf_05Controller}
     */
    @Bean
    public CDLS_Thymeleaf_05Controller cDLS_Thymeleaf_05Controller() {
        return new CDLS_Thymeleaf_05Controller();
    }
}
