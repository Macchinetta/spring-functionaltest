...
@Import({SpringFunctionaltestWebCdlsInfraConfig.class,
        SpringFunctionaltestWebCdlsCodelistConfig.class})
public class SpringFunctionaltestWebCdlsDomainConfig {
