...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.cdls.enumCodeList" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <div>CDLS0104002</div>
                <div>
                    <form:form modelAttribute="clEnumOrderStatusForm" method="post" action="${pageContext.request.contextPath}/jsp/0104/002">
                        <form:select id="cdls0104002_jsp" items="${CL_ENUM_ORDERSTATUS}" path="id" />
                        <form:errors path="id" />
                        <button id="cdls0104002_jspSubmit" type="submit" name="post">Submit</button>
                    </form:form>
                    <div id="cdls0104002_jspResult">${f:h(enumOrderStatusCodeListValue)}</div>
                </div>
            </div>
        </div>
