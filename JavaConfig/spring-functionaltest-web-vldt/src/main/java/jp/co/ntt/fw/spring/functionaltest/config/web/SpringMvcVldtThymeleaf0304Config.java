...
import jp.co.ntt.fw.spring.functionaltest.app.vldt.VLDT_Thymeleaf_0304001Controller;
...
@EnableWebMvc
@Configuration
public class SpringMvcVldtThymeleaf0304Config implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(final ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/uploadedTemporaryFiles/**")
                .addResourceLocations("file://" + temporaryDirectory)
                .setCachePeriod(60 * 60);
        registry.addResourceHandler("/uploadedFiles/**").addResourceLocations(
                "file://" + directory).setCachePeriod(60 * 60);
    }
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        addInterceptor(registry, successLoggingInterceptor(), "/aply/0402/**",
                null);
    }
     ...
     */
    private void addInterceptor(InterceptorRegistry registry,
            HandlerInterceptor interceptor, String path, String excludePath) {
    ...
    public SystemExceptionResolver systemExceptionResolver(
        ...
        statusCodes.setProperty("common/error/operationError", String.valueOf(
                HttpStatus.BAD_REQUEST.value()));
        statusCodes.setProperty("common/error/fileUploadError", String.valueOf(
                HttpStatus.BAD_REQUEST.value()));
        statusCodes.setProperty("common/error/intentionalError", String
    ...
    /**
     * Configure {@link VLDT_Thymeleaf_0304001Controller} bean.
     * @return Bean of configured {@link VLDT_Thymeleaf_0304001Controller}
     */
    @Bean
    public VLDT_Thymeleaf_0304001Controller vLDT_Thymeleaf_0304001Controller() {
        return new VLDT_Thymeleaf_0304001Controller();
    }
}
