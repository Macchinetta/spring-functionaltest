...
@Import({ SpringFunctionaltestWebVldtInfraConfig.class,
        SpringFunctionaltestWebVldtCodelistConfig.class })
public class SpringFunctionaltestWebVldtDomainConfig {
    ...
    /**
     * Configure {@link MethodValidationPostProcessor} bean.
     * @param notAsciiValidator Bean defined by SpringFunctionaltestEnvConfig#notAsciiValidator
     * @return Bean of configured {@link MethodValidationPostProcessor}
     */
    @Bean
    public MethodValidationPostProcessor notAsciiValidationMethodValidationPostProcessor(
            @Qualifier("notAsciiValidator") LocalValidatorFactoryBean notAsciiValidator) {
        MethodValidationPostProcessor bean = new MethodValidationPostProcessor();
