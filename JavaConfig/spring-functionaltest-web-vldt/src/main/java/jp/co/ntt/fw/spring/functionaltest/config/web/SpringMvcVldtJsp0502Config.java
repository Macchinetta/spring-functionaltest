...
import jp.co.ntt.fw.spring.functionaltest.app.vldt.VLDT_JSP_0502Controller;
...
@EnableWebMvc
@Configuration
public class SpringMvcVldtJsp0502Config implements WebMvcConfigurer {
     ...
     */
    @Bean
    public VLDT_JSP_0502Controller vLDT_JSP_0502Controller() {
        return new VLDT_JSP_0502Controller();
    }
}
