...
@ComponentScan(basePackages = {
        "jp.co.ntt.fw.spring.functionaltest.app" }, excludeFilters = {
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = VLDT_JSP_0304001Controller.class),
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = VLDT_JSP_0502Controller.class),
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = VLDT_Thymeleaf_0304001Controller.class),
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = VLDT_Thymeleaf_0502Controller.class) })
