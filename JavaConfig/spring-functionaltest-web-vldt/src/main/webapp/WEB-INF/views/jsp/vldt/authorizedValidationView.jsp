...
<div id="wrapper">
  ...
  <form:form method="post" action="${pageContext.request.contextPath}/jsp/0103/003/authentication"
  ...
  <form:form method="post" action="${pageContext.request.contextPath}/jsp/0103/003/logout"
    class="form-horizontal">
  ...
  <form:form method="post" action="${pageContext.request.contextPath}/jsp/0103/003"
