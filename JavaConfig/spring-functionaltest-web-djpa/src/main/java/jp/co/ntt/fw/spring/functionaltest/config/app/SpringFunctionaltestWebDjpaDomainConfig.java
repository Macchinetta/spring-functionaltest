...
@Import({ SpringFunctionaltestWebDjpaInfraConfig.class,
        SpringFunctionaltestWebDjpaCodelistConfig.class })
public class SpringFunctionaltestWebDjpaDomainConfig {
