...
@Import({SpringFunctionaltestWebMsmnDomainConfig.class})
public class ApplicationContextConfig {
    ...
    /**
     * Configure {@link MessageSource} bean.<br>
     * The bean name “messageSource” is searched for, so this bean is valid.
    ...
    /**
     * Configure {@link MessageSource} bean.<br>
     * Because it is searched by the bean name messageSource, this bean is not used unless it is
     * injected.
     * @return Bean of configured {@link ResourceBundleMessageSource}
     */
    @Bean("messageSourceUTF8")
    public MessageSource messageSourceUTF8() {
        ResourceBundleMessageSource bean = new ResourceBundleMessageSource();
        bean.setBasenames("i18n/application-messages-utf8");
