...
public class MessageIds {
    ...
    /**
     * w.ex.an.2001=The recommended change interval has passed password. Please change your
     * password.
     */
    ...
    /**
     * i.ex.od.0001=Please confirm order content. <font style="color: red; font-size: 16px;">If this
     * orders submitted, cannot cancel.</font>
     */
