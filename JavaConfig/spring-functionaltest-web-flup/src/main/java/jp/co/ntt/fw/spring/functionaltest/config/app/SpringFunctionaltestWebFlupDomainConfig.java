...
@Import({ SpringFunctionaltestWebFlupInfraConfig.class,
        SpringFunctionaltestWebFlupCodelistConfig.class })
public class SpringFunctionaltestWebFlupDomainConfig {
