...
@Controller
public class DTOP_Thymeleaf_05Controller {
    ...
    public String handle05001(Model model) {
        return "thymeleaf/dtop/thymeleafTagLibrary";
    }
    ...
    @GetMapping(value = "thymeleaftag/thymeleafTagDateTime")
    ...
    @GetMapping(value = "thymeleaftag/thymeleafTagLocalDateTime")
    public String handleGetNowLocalDateTime(Model model) {
        ...
        model.addAttribute("resultDateWithStyl", DateTimeFormat.forStyle("SM")
                .print(dateTime));
        model.addAttribute("resultDate", dateTime);
        return "thymeleaf/dtop/showLocalDateTime";
    }

    @GetMapping(value = "thymeleaftag/thymeleafTagLocalDate")
    ...
    @GetMapping(value = "thymeleaftag/thymeleafTagLocalTime")
    public String handleGetNowLocalTime(Model model) {
        ...
        return "thymeleaf/dtop/showLocalTime";
    }
}
