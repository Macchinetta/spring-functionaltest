...
@Import({ SpringFunctionaltestWebDtopInfraConfig.class,
        SpringFunctionaltestWebDtopCodelistConfig.class })
public class SpringFunctionaltestWebDtopDomainConfig {
