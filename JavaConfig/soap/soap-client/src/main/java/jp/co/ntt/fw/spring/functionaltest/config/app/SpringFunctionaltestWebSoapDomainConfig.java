...
import jp.co.ntt.fw.spring.functionaltest.config.ws.SpringFunctionaltestWebSoapDomainWsConfig;
...
@Import({SpringFunctionaltestWebSoapInfraConfig.class,
        SpringFunctionaltestWebSoapDomainWsConfig.class,
        SpringFunctionaltestWebSoapCodelistConfig.class})
@ComponentScan(basePackages = {"jp.co.ntt.fw.spring.functionaltest.domain"})
public class SpringFunctionaltestWebSoapDomainConfig {
