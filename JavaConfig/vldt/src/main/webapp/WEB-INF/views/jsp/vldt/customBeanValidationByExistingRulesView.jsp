...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.customBeanValidationByExistingRulesView" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0401/001" modelAttribute="customBeanValidationByExistingRulesForm" class="form-horizontal">
