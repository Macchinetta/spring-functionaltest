...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.groupedValidationView" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0103/001" modelAttribute="groupedValidationForm" class="form-horizontal">
