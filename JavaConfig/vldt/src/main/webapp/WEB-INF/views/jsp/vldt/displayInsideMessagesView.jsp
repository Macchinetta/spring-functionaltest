...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.displayInsideMessagesView" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0101/003" modelAttribute="displayInsideMessagesForm" class="form-horizontal">
