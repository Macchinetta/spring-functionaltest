...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.correlationValidationBySpringValidatorViewForMultiFieldHighlight" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0201/003" modelAttribute="userForm" class="form-horizontal">
                    <div class="form-group">
                        <form:label path="password" class="col-sm-2 control-label">Password</form:label>
                        <div class="col-sm-10">
                            <form:password path="password" class="form-control" placeholder="Password" cssErrorClass="form-control error-input" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <form:password path="confirmPassword" class="form-control" placeholder="ConfirmPassword" cssErrorClass="form-control error-input" />
