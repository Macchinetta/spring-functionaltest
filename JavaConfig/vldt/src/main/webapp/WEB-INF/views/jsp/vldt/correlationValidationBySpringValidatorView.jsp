...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.correlationValidationBySpringValidatorView" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0201/001" modelAttribute="userForm" class="form-horizontal">
