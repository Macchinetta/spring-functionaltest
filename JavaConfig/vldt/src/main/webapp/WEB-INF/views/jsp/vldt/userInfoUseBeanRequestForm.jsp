...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.userInfoUseBeanRequestForm" />
    ...
    <body>
        ...
        <div class="container">
            <form:form modelAttribute="userInfoForm" action="${pageContext.request.contextPath}/jsp/0602/regist" method="post">
                <fieldset>
