...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.groupedValidationByDefaultView" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0103/002" modelAttribute="groupedValidationByDefaultForm" class="form-horizontal">
