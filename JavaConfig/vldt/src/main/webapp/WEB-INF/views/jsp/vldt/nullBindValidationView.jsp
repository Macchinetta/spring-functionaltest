...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.nullBindValidationView" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0104/001" modelAttribute="nullBindValidationForm" class="form-horizontal">
