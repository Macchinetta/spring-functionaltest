...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.customBeanValidationByOriginalRulesView" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0402/001" modelAttribute="customBeanValidationByOriginalRulesForm" class="form-horizontal">
