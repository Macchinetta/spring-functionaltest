...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.customBeanValidationByServiceView" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0402/002" modelAttribute="customBeanValidationByServiceForm" class="form-horizontal">
