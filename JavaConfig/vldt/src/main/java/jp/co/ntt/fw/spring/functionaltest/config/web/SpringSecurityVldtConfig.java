...
public class SpringSecurityVldtConfig {
    ...
    public SecurityFilterChain filterChainJsp(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/jsp/0103/003/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/0103/003/logout")
                .logoutSuccessUrl("/jsp/0103/003").deleteCookies("JSESSIONID"));
    ...
    public SecurityFilterChain filterChainThymeleaf(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/thymeleaf/0103/003/**"));
        http.authenticationManager(userLoginManager);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0103/003/logout")
                .logoutSuccessUrl("/thymeleafp/0103/003").deleteCookies("JSESSIONID"));
        http.authorizeHttpRequests(authz -> authz.requestMatchers(antMatcher("/**")).permitAll());
    ...
    public AuthenticationProvider authenticationProvider(UserDetailsService vldtUserDetailsService,
