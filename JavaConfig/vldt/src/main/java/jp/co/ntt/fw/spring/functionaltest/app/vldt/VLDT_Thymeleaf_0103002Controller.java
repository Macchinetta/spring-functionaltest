...
@Controller
@RequestMapping("thymeleaf/0103/002")
public class VLDT_Thymeleaf_0103002Controller {
    ...
    public String handle() {
        return "thymeleaf/vldt/groupedValidationByDefaultView";
    }
    ...
    public String handleValidateForJapanese(
        ...
        return "redirect:/thymeleaf/0103/002";
    }
    ...
    public String handleValidate(@Validated({Default.class}) GroupedValidationByDefaultForm form,
            BindingResult result) {
