...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/jsp/changeType" cssClass="form-horizontal"
  ...
  <br />
  <form action="${pageContext.request.contextPath}/jsp/changeType" class="form-horizontal"
    method="get">
    <fieldset>
