...
public class SpringMvcCdls05JspConfig implements WebMvcConfigurer {
    ...
    /**
     * Configure {@link CDLS_JSP_05Controller} bean.
     * @return Bean of configured {@link CDLS_JSP_05Controller}
     */
    @Bean
    public CDLS_JSP_05Controller cDLS_JSP_05Controller() {
        return new CDLS_JSP_05Controller();
    }
}
