...
@Import({ SpringFunctionaltestWebDbspInfraConfig.class,
        SpringFunctionaltestWebDbspCodelistConfig.class })
public class SpringFunctionaltestWebDbspDomainConfig {
