...
@Import({ SpringFunctionaltestWebDbspDomainConfig.class })
public class ApplicationContextConfig {

    //We will verify whether the bean definition is necessary in the later process, so we would like to formally adjust it at that time.
    /**
