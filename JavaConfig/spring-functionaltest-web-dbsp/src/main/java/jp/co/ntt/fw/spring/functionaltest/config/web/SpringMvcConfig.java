...
import jp.co.ntt.fw.spring.functionaltest.app.dbsp.DBSP_Thymeleaf_0303Controller;
...
@ComponentScan(basePackages = {
        "jp.co.ntt.fw.spring.functionaltest.app" }, excludeFilters = {
                ...
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = DBSP_Thymeleaf_0303Controller.class) })
@Configuration
@EnableWebMvc
