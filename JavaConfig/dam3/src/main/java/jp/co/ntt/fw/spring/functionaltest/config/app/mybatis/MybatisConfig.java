...
public class MybatisConfig {
    ...
    private static void setTypeAliases(TypeAliasRegistry typeAliasRegistry) {
        typeAliasRegistry.registerAlias(TodoSearchCriteria.class);
        typeAliasRegistry.registerAliases("jp.co.ntt.fw.spring.functionaltest.domain.model");
        typeAliasRegistry
                .registerAliases("jp.co.ntt.fw.spring.functionaltest.infra.mybatis.typehandler");
        typeAliasRegistry.registerAliases(
                "jp.co.ntt.fw.spring.functionaltest.infra.mybatis.manual.typehandler");
    }
    ...
    private static void setTypeHandlers(TypeHandlerRegistry typeHandlerRegistry) {
        typeHandlerRegistry
                .register("jp.co.ntt.fw.spring.functionaltest.infra.mybatis.typehandler");
    }
}
