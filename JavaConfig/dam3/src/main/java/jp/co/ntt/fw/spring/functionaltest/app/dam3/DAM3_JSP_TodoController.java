...
public class DAM3_JSP_TodoController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DAM3_JSP_TodoController.class);

    private static final DateTimeFormatter DATE_TIME_FORMATTER =
            DateTimeFormatter.ofPattern("uuuu/MM/dd").withLocale(Locale.JAPANESE)
    ...
    private List<TodoMB3> getTodoListFromCSVFile(File tempFile) {
        ...
        try (FileReader fileRdr = new FileReader(file);
            ...
            while ((line = bufRdr.readLine()) != null) {
                ...
                todoMB3.setCreatedAt(LocalDate.parse(todoArr[3], DATE_TIME_FORMATTER));
