...
public class EXCN_JSP_0602Controller {
    ...
    private static final Logger logger = LoggerFactory.getLogger(EXCN_JSP_0602Controller.class);
    ...
    public String handle001(StockForm form, Model model) {
        beanMapper.mapJPA(stockOptimisticLockService.findOne("EXCN0602001"), form);
        return "jsp/excn/jpaOptimisticLockViewExcpHandler";
    }

    @GetMapping(value = "002")
    public String handle002(StockForm form, Model model) {
        beanMapper.mapJPA(stockPessimisticLockService.findOne("EXCN0602002"), form);
