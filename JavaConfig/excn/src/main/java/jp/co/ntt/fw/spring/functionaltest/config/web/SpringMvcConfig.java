...
public class SpringMvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        addWebRequestInterceptor(registry, "/jsp/book/interceptSrch/**",
    ...
    /**
     * Common processes used in #addWebRequestInterceptor.
     * @param registry {@link InterceptorRegistry}
     * @param mappingPath mappingPath
     * @param interceptor {@link WebRequestInterceptor}
     */
    private void addWebRequestInterceptor(InterceptorRegistry registry, String mappingPath,
