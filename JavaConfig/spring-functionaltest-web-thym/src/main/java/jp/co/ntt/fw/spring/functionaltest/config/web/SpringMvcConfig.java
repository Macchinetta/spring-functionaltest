...
@ComponentScan(basePackages = {
        "jp.co.ntt.fw.spring.functionaltest.app" }, excludeFilters = {
                ...
                @Filter(type = FilterType.REGEX, pattern = "jp.co.ntt.fw.spring.functionaltest.app.thym.THYM050[1-2].*"),
                @Filter(type = FilterType.REGEX, pattern = "jp.co.ntt.fw.spring.functionaltest.app.thym.THYM06.*"),
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = THYM0701Controller.class),
                @Filter(type = FilterType.REGEX, pattern = "jp.co.ntt.fw.spring.functionaltest.app.thym.THYM0803.*") })
@Configuration
@EnableWebMvc
