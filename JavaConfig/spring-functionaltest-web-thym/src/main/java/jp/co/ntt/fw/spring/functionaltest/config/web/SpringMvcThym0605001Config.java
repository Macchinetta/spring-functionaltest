...
import jp.co.ntt.fw.spring.functionaltest.app.thym.THYM0605001Controller;
...
public class SpringMvcThym0605001Config implements WebMvcConfigurer {
    ...
    public StandardCacheManager cacheManager() {
        ...
        bean.setTemplateCacheMaxSize(2);
        return bean;
    }

    /**
     * Configure {@link THYM0605001Controller} bean.
     * @return Bean of configured {@link THYM0605001Controller}
     */
    @Bean
    public THYM0605001Controller tHYM0605001Controller() {
        return new THYM0605001Controller();
    }
}
