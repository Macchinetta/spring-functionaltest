...
public class SpringMvcThym0402Config implements WebMvcConfigurer {
    ...
    /**
     * Configure {@link THYM0402Controller} bean.
     * @return Bean of configured {@link THYM0402Controller}
     */
    @Bean
    public THYM0402Controller tHYM0402Controller() {
        return new THYM0402Controller();
    }
}
