...
import jp.co.ntt.fw.spring.functionaltest.app.thym.THYM0803005Controller;
...
public class SpringMvcThym0803005Config implements WebMvcConfigurer {
    ...
    /**
     * Configure {@link THYM0803005Controller} bean.
     * @return Bean of configured {@link THYM0803005Controller}
     */
    @Bean
    public THYM0803005Controller tHYM0803005Controller() {
        return new THYM0803005Controller();
    }
}
