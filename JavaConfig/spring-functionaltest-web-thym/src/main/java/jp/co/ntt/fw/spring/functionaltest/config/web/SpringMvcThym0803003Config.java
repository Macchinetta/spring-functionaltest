...
import jp.co.ntt.fw.spring.functionaltest.app.thym.THYM0803003Controller;
...
public class SpringMvcThym0803003Config implements WebMvcConfigurer {
    ...
    public ThymeleafViewResolver thymeleafViewResolver() {
        ...
        bean.setContentType("application/javascript;charset=UTF-8");
        return bean;
    }
    ...
    /**
     * Configure {@link THYM0803003Controller} bean.
     * @return Bean of configured {@link THYM0803003Controller}
     */
    @Bean
    public THYM0803003Controller tHYM0803003Controller() {
        return new THYM0803003Controller();
    }
}
