...
@Import({ SpringFunctionaltestWebThymInfraConfig.class,
        SpringFunctionaltestWebThymCodelistConfig.class })
public class SpringFunctionaltestWebThymDomainConfig {
