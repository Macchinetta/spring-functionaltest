...
@Import({ SpringFunctionaltestWebPrmnInfraConfig.class,
        SpringFunctionaltestWebPrmnCodelistConfig.class })
public class SpringFunctionaltestWebPrmnDomainConfig {
