...
public class SpringSecurityAthn06Config {
     ...
     *        #authEventHandleUserLoginAuthenticationProvider
    ...
    public AuthenticationManager authEventHandleUserLoginManagerForServiceException(
        ...
        ProviderManager bean =
                new ProviderManager(throwAuthenticationServiceExceptionAuthenticationProvider());
        bean.setAuthenticationEventPublisher(authenticationEventPublisher);
        return bean;
    }
    ...
    public SecurityFilterChain filterChainJsp0601001(HttpSecurity http,
            @Qualifier("authEventHandleUserLoginManager") AuthenticationManager authEventHandleUserLoginManager)
            throws Exception {
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/0601/001/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0601/001/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0601/**")).authenticated()
    ...
    public SecurityFilterChain filterChainJsp0602002(HttpSecurity http,
            @Qualifier("authEventHandleUserLoginManagerForServiceException") AuthenticationManager authEventHandleUserLoginManagerForServiceException)
            throws Exception {

        http.securityMatcher(antMatcher("/jsp/0602/002/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/0602/002/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/0602/002/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0602/002/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0602/**")).authenticated()
                        .requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf0601001(HttpSecurity http,
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/0601/001/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0601/001/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0601/**"))
    ...
    public SecurityFilterChain filterChainThymeleaf0602002(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/thymeleaf/0602/002/**"));
        http.authenticationManager(authEventHandleUserLoginManagerForServiceException);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0602/002/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/0602/002/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0602/002/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0602/**"))
                        .authenticated().requestMatchers(antMatcher("/**")).permitAll());
