...
public class SpringSecurityAthn15Config {
    ...
    public SecurityFilterChain filterChainJsp1501(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/jsp/1501/**"));
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/1501/001/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/1501/001/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/1501/**")).authenticated()
    ...
    public SecurityFilterChain filterChainThymeleaf1501(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/thymeleaf/1501/**"));
        http.authenticationManager(userLoginManagerForAthn);
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/1501/001/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/1501/001/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/1501/**"))
