...
public class SpringSecurityAthn05Config {
     ...
     * @param loginWithBCryptPasswordAuthenticationProvider Bean defined by
     *        #loginWithBCryptPasswordAuthenticationProvider
     ...
     *        SpringSecurityAthnConfig#loginWithEncodingPasswordService
    ...
    /**
     * Configure {@link AuthenticationManager} bean.
     * @param loginWithPbkdf2PasswordAuthenticationProvider Bean defined by
     *        #loginWithPbkdf2PasswordAuthenticationProvider
     * @return Bean of configured {@link AuthenticationManager}
     */
    ...
    /**
     * Configure {@link AuthenticationManager} bean.
     * @param loginWithSCryptPasswordAuthenticationProvider Bean defined by
     *        #loginWithSCryptPasswordAuthenticationProvider
     * @return Bean of configured {@link AuthenticationManager}
     */
    ...
    /**
     * Configure {@link AuthenticationManager} bean.
     * @param loginWithArgon2PasswordAuthenticationProvider Bean defined by
     *        #loginWithArgon2PasswordAuthenticationProvider
     * @return Bean of configured {@link AuthenticationManager}
     */
    ...
    public SecurityFilterChain filterChainJsp0501002(HttpSecurity http,
            @Qualifier("loginWithBCryptPassword") AuthenticationManager loginWithBCryptPassword)
            throws Exception {
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/0501/002/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0501/002/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0501/002/**")).authenticated()
    ...
    public SecurityFilterChain filterChainJsp0501004(HttpSecurity http,
            @Qualifier("loginWithPbkdf2Password") AuthenticationManager loginWithPbkdf2Password)
            throws Exception {
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/0501/004/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/0501/004/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0501/004/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0501/004/**")).authenticated()
                        .requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainJsp0501006(HttpSecurity http,
            @Qualifier("loginWithSCryptPassword") AuthenticationManager loginWithSCryptPassword)
            throws Exception {

        http.securityMatcher(antMatcher("/jsp/0501/006/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/0501/006/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/0501/006/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0501/006/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0501/006/**")).authenticated()
                        .requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainJsp0501008(HttpSecurity http,
            @Qualifier("loginWithArgon2Password") AuthenticationManager loginWithArgon2Password)
            throws Exception {

        http.securityMatcher(antMatcher("/jsp/0501/008/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/0501/008/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/0501/008/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0501/008/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0501/008/**")).authenticated()
                        .requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainJsp0502(HttpSecurity http,
            @Qualifier("loginWithDelegatingPassword") AuthenticationManager loginWithDelegatingPassword)
            throws Exception {

        http.securityMatcher(antMatcher("/jsp/0502/002/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/0502/002/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/0502/002/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0502/002/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/0502/002/**")).authenticated()
                        .requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf0501002(HttpSecurity http,
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/0501/002/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0501/002/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0501/002/**"))
    ...
    public SecurityFilterChain filterChainThymeleaf0501004(HttpSecurity http,
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0501/004/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/0501/004/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0501/004/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0501/004/**"))
                        .authenticated().requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf0501006(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/thymeleaf/0501/006/**"));
        http.authenticationManager(loginWithSCryptPassword);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0501/006/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/0501/006/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0501/006/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0501/006/**"))
                        .authenticated().requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf0501008(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/thymeleaf/0501/008/**"));
        http.authenticationManager(loginWithArgon2Password);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0501/008/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/0501/008/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0501/008/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0501/008/**"))
                        .authenticated().requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf0502002(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/thymeleaf/0502/002/**"));
        http.authenticationManager(loginWithDelegatingPassword);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0502/002/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/0502/002/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0502/002/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/0502/002/**"))
                        .authenticated().requestMatchers(antMatcher("/**")).permitAll());
