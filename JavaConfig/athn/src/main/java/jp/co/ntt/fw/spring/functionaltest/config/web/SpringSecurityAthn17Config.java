...
public class SpringSecurityAthn17Config {
     ...
     * @param customerPasswordAuthenticationProvider Bean defined by
     *        #customerPasswordAuthenticationProvider
    ...
    public CompanyIdUsernamePasswordAuthenticationFilter jspCompanyIdUsernamePasswordAuthenticationFilter(
        ...
        CompanyIdUsernamePasswordAuthenticationFilter bean =
                new CompanyIdUsernamePasswordAuthenticationFilter();
        bean.setRequiresAuthenticationRequestMatcher(jspAntPathRequestMatcher());
        ...
        bean.setAuthenticationFailureHandler(jspSimpleUrlAuthenticationFailureHandler());
        bean.setAuthenticationSuccessHandler(jspSimpleUrlAuthenticationSuccessHandler());
        return bean;
    }
    ...
    public AntPathRequestMatcher jspAntPathRequestMatcher() {
        return antMatcher(HttpMethod.POST, "/jsp/1702/customerAuthenticate");
    }
    ...
    public CompanyIdUsernamePasswordAuthenticationFilter thymeleafCompanyIdUsernamePasswordAuthenticationFilter(
        ...
        CompanyIdUsernamePasswordAuthenticationFilter bean =
                new CompanyIdUsernamePasswordAuthenticationFilter();
        bean.setRequiresAuthenticationRequestMatcher(thymeleafAntPathRequestMatcher());
        bean.setAuthenticationManager(authenticationManager);
        bean.setSessionAuthenticationStrategy(sessionAuthenticationStrategy());
        bean.setSecurityContextRepository(securityContextRepository());
        bean.setAuthenticationFailureHandler(thymeleafSimpleUrlAuthenticationFailureHandler());
        bean.setAuthenticationSuccessHandler(thymeleafSimpleUrlAuthenticationSuccessHandler());
        return bean;
    }
    ...
    public AntPathRequestMatcher thymeleafAntPathRequestMatcher() {
        return antMatcher(HttpMethod.POST, "/thymeleaf/1702/customerAuthenticate");
    }
    ...
    /**
     * Configure {@link AuthenticationManager} bean.
     * @param companyIdUsernamePasswordAuthenticationProvider Bean defined by
    ...
    public AuthenticationProvider companyIdUsernamePasswordAuthenticationProvider(
            @Qualifier("passwordEncoder") PasswordEncoder passwordEncoder) {
        CompanyIdUsernamePasswordAuthenticationProvider authProvider =
    ...
    public CompositeSessionAuthenticationStrategy sessionAuthenticationStrategy() {
        ...
        CompositeSessionAuthenticationStrategy bean =
                new CompositeSessionAuthenticationStrategy(list);
        return bean;
    }
    ...
    public SecurityFilterChain filterChainJsp1701(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/jsp/1701/**"));
        http.exceptionHandling(exception -> exception
                .authenticationEntryPoint(jspCustomerLoginUrlAuthenticationEntryPoint()));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/1701/logout").logoutSuccessUrl("/athn")
     ...
     * Configure {@link SecurityFilterChain} bean.
     * @param http Builder class for setting up authentication and authorization
     * @param jspCompanyIdUsernamePasswordAuthenticationFilter Bean defined by
     *        #jspCompanyIdUsernamePasswordAuthenticationFilter
     * @return Bean of configured {@link SecurityFilterChain}
     * @throws Exception Exception that occurs when setting HttpSecurity
     */
    @Bean
    ...
    public SecurityFilterChain filterChainJsp1702(HttpSecurity http,
            @Qualifier("jspCompanyIdUsernamePasswordAuthenticationFilter") CompanyIdUsernamePasswordAuthenticationFilter jspCompanyIdUsernamePasswordAuthenticationFilter)
            throws Exception {

        http.securityMatcher(antMatcher("/jsp/1702/**"));
        http.exceptionHandling(exception -> exception
                .authenticationEntryPoint(jspLoginUrlAuthenticationEntryPoint()));
        http.addFilterAt(jspCompanyIdUsernamePasswordAuthenticationFilter,
                UsernamePasswordAuthenticationFilter.class);
        http.csrf(csrf -> csrf.csrfTokenRepository(csrfTokenRepository()));
        http.logout(logout -> logout.logoutUrl("/jsp/1702/logout").logoutSuccessUrl("/athn")
                .deleteCookies("JSESSIONID"));
        http.authorizeHttpRequests(authz -> authz.requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainJsp1703(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/jsp/1703/**"));
        ...
        http.authorizeHttpRequests(authz -> authz.requestMatchers(antMatcher("/jsp/1703/001/**"))
                .permitAll().requestMatchers(antMatcher("/jsp/1703/001/login/**")).permitAll()
                .requestMatchers(antMatcher("/jsp/1703/001/logout/**")).permitAll()
                .requestMatchers(antMatcher("/jsp/1703/**")).authenticated()
    ...
    public SecurityFilterChain filterChainThymeleaf1701(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/thymeleaf/1701/**"));
        http.exceptionHandling(exception -> exception
                .authenticationEntryPoint(thymeleafCustomerLoginUrlAuthenticationEntryPoint()));
        http.authenticationManager(customerAuthenticationManager);
        ...
        http.sessionManagement(sessionManagement -> sessionManagement
                .sessionAuthenticationStrategy(sessionAuthenticationStrategy()));
        http.logout(logout -> logout.logoutUrl("/thymeleaf/1701/logout").logoutSuccessUrl("/athn")
                .deleteCookies("JSESSIONID"));
        http.authorizeHttpRequests(authz -> authz.requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf1702(HttpSecurity http,
            @Qualifier("thymeleafCompanyIdUsernamePasswordAuthenticationFilter") CompanyIdUsernamePasswordAuthenticationFilter thymeleafCompanyIdUsernamePasswordAuthenticationFilter)
            throws Exception {

        http.securityMatcher(antMatcher("/thymeleaf/1702/**"));
        http.exceptionHandling(exception -> exception
                .authenticationEntryPoint(thymeleafLoginUrlAuthenticationEntryPoint()));
        http.addFilterAt(thymeleafCompanyIdUsernamePasswordAuthenticationFilter,
                UsernamePasswordAuthenticationFilter.class);
        http.csrf(csrf -> csrf.csrfTokenRepository(csrfTokenRepository()));
        http.logout(logout -> logout.logoutUrl("/thymeleaf/1702/logout").logoutSuccessUrl("/athn")
                .deleteCookies("JSESSIONID"));
        http.authorizeHttpRequests(authz -> authz.requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf1703(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/thymeleaf/1703/**"));
        http.authenticationManager(userLoginManagerForAthn);
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/1703/001/**")).permitAll()
                        .requestMatchers(antMatcher("/thymeleaf/1703/001/login/**")).permitAll()
                        .requestMatchers(antMatcher("/thymeleaf/1703/001/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/thymeleaf/1703/**")).authenticated()
                        .requestMatchers(antMatcher("/**")).permitAll());
