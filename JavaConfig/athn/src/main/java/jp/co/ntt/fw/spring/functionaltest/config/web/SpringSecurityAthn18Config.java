...
public class SpringSecurityAthn18Config {
     ...
     * @param athnPasswordEncoderBCrypt PasswordEncoder defined by
     *        SpringSecurityAthnConfig#athnPasswordEncoderBCrypt()
    ...
    public PasswordEncoder athnPasswordEncoderCustomPbkdf2(
        ...
        DelegatingPasswordEncoder bean =
                new DelegatingPasswordEncoder("pbkdf2", idToPasswordEncoder);
    ...
    public SecurityFilterChain filterChainJsp1801002(HttpSecurity http,
            @Qualifier("loginWithCustomPbkdf2Password") AuthenticationManager loginWithCustomPbkdf2Password)
            throws Exception {

        http.securityMatcher(antMatcher("/jsp/1801/002/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/1801/002/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/1801/002/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/1801/002/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/1801/002/**")).authenticated()
    ...
    public SecurityFilterChain filterChainThymeleaf1801002(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/thymeleaf/1801/002/**"));
        http.authenticationManager(loginWithCustomPbkdf2Password);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/1801/002/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/1801/002/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/1801/002/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/1801/002/**"))
