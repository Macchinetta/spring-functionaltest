...
@Controller
public class ATHN_JSP_05Controller {
    ...
    public String handle0501001(Model model, AdministratorForm form) {
        return "jsp/athn/createAdministratorUsingBCryptPassword";
    }
    ...
    public String createAdministratorUsingBCryptPassword(Model model,
        ...
        return "redirect:/jsp/0501/001/createCompleteAdminUsingBCrypt?complete";
    }
    ...
    public String afterLoginUsingBCryptPassword(@AuthenticationPrincipal UserDetails userDetails,
        ...
        return "jsp/athn/showAdministratorInfoUsingBCryptPassword";
    }

    @GetMapping(value = "/0501/003")
    public String handle0501003(Model model, AdministratorForm form) {
        return "jsp/athn/createAdministratorUsingPbkdf2Password";
    }
    ...
    public String createAdministratorUsingPbkdf2Password(Model model,
        ...
        return "redirect:/jsp/0501/003/createCompleteAdminUsingPbkdf2?complete";
    }
    ...
    public String afterLoginUsingPbkdf2Password(@AuthenticationPrincipal UserDetails userDetails,
        ...
        return "jsp/athn/showAdministratorInfoUsingPbkdf2Password";
    }

    @GetMapping(value = "/0501/005")
    public String handle0501005(Model model, AdministratorForm form) {
        return "jsp/athn/createAdministratorUsingSCryptPassword";
    }
    ...
    public String createAdministratorUsingSCryptPassword(Model model,
        ...
        return "redirect:/jsp/0501/005/createCompleteAdminUsingSCrypt?complete";
    }
    ...
    public String afterLoginUsingSCryptPassword(@AuthenticationPrincipal UserDetails userDetails,
        ...
        return "jsp/athn/showAdministratorInfoUsingSCryptPassword";
    }

    @GetMapping(value = "/0501/007")
    public String handle0501007(Model model, AdministratorForm form) {
        return "jsp/athn/createAdministratorUsingArgon2Password";
    }
    ...
    public String createAdministratorUsingArgon2Password(Model model,
        ...
        return "redirect:/jsp/0501/007/createCompleteAdminUsingArgon2?complete";
    }
    ...
    public String afterLoginUsingArgon2Password(@AuthenticationPrincipal UserDetails userDetails,
        ...
        return "jsp/athn/showAdministratorInfoUsingArgon2Password";
    }

    @GetMapping(value = "/0502/001")
    public String handle0502001(Model model, AdministratorForm form) {
        return "jsp/athn/createAdministratorUsingDelegatingPassword";
    }
    ...
    public String createAdministratorUsingDelegatingPassword(Model model,
        ...
        return "redirect:/jsp/0502/001/createCompleteAdminUsingDelegating?complete";
    }
    ...
    public String afterLoginUsingDelegatingPassword(
        ...
        return "jsp/athn/showAdministratorInfoUsingDelegatingPassword";
    }
