...
public class SpringSecurityAthn12Config {
    ...
    public SecurityFilterChain filterChainJsp1201001(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/jsp/1201/001/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/1201/001/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/1201/001/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/1201/001/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/1201/**")).authenticated()
    ...
    public SecurityFilterChain filterChainJsp1202001(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/jsp/1202/001/**"));
        http.authenticationManager(dbUserLoginManager);
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/1202/001/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/1202/001/login/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/1202/001/logout/**")).permitAll()
                        .requestMatchers(antMatcher("/jsp/1202/**")).authenticated()
                        .requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf1201001(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/thymeleaf/1201/001/**"));
        http.authenticationManager(dbUserLoginManager);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/1201/001/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/1201/001/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/1201/001/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/1201/**"))
    ...
    public SecurityFilterChain filterChainThymeleaf1202001(HttpSecurity http,
        ...
        http.securityMatcher(antMatcher("/thymeleaf/1202/001/**"));
        http.authenticationManager(dbUserLoginManager);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/1202/001/logout").logoutSuccessUrl("/"));
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/thymeleaf/1202/001/login/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/1202/001/logout/**"))
                        .permitAll().requestMatchers(antMatcher("/thymeleaf/1202/**"))
                        .authenticated().requestMatchers(antMatcher("/**")).permitAll());
