...
public class SpringMvcAthnThymeleafConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        registry.addViewController("/0102/001/login")
                .setViewName("thymeleaf/athn/loginForDefaultFormAuthentication");
        registry.addViewController("/0201/001/login")
                .setViewName("thymeleaf/athn/loginForDefaultAuthenticationSeccess");
        registry.addViewController("/0301/001/login")
                .setViewName("thymeleaf/athn/loginForDefaultAuthenticationFailure");
        registry.addViewController("/0401/001/login")
                .setViewName("thymeleaf/athn/loginForDbFormAuthentication");
        registry.addViewController("/0402/001/login")
                .setViewName("thymeleaf/athn/loginForDbFormAuthenticationSpecifyEncoder");
        registry.addViewController("/0402/004/login")
                .setViewName("thymeleaf/athn/loginForDbFormAuthenticationSpecifyHash");
        registry.addViewController("/0501/002/login")
                .setViewName("thymeleaf/athn/loginForUsingBCryptPassword");
        registry.addViewController("/0501/004/login")
                .setViewName("thymeleaf/athn/loginForUsingPbkdf2Password");
        registry.addViewController("/0501/006/login")
                .setViewName("thymeleaf/athn/loginForUsingSCryptPassword");
        registry.addViewController("/0501/008/login")
                .setViewName("thymeleaf/athn/loginForUsingArgon2Password");
        registry.addViewController("/0502/002/login")
                .setViewName("thymeleaf/athn/loginForUsingDelegatingPassword");
        registry.addViewController("/0601/001/login")
                .setViewName("thymeleaf/athn/loginForAuthEventHandle");
        registry.addViewController("/0602/002/login")
                .setViewName("thymeleaf/athn/loginForAuthenticationServiceException");
        ...
        registry.addViewController("/0702/001/login")
                .setViewName("thymeleaf/athn/loginForLogoutDeleteCookie");
        registry.addViewController("/0901/001/login")
                .setViewName("thymeleaf/athn/loginForDispAutentication");
        registry.addViewController("/1201/001/login")
                .setViewName("thymeleaf/athn/loginForCustomizedAuthSucessUrl");
        registry.addViewController("/1202/001/login")
                .setViewName("thymeleaf/athn/loginForCustomizedAuthSucessHandler");
        registry.addViewController("/1302/001/login")
                .setViewName("thymeleaf/athn/loginForCustomizedAuthFailure");
        registry.addViewController("/1501/001/login")
                .setViewName("thymeleaf/athn/loginForCustomizedLogout");
        registry.addViewController("/1601/001/login")
                .setViewName("thymeleaf/athn/loginForAutenticationSystemError");
        registry.addViewController("/1602/001/login")
                .setViewName("thymeleaf/athn/loginForAutenticationSystemErrorfailureUrl");
        registry.addViewController("/1801/002/login")
                .setViewName("thymeleaf/athn/loginForUsingCustomPbkdf2Password");
        registry.addViewController("/loginForRememberMe")
                .setViewName("thymeleaf/athn/loginForRememberMe");
        registry.addViewController("/2301/001/login")
                .setViewName("thymeleaf/athn/loginForLogoutSuccessEventHandle");

        registry.addViewController("/thymeleaf/badCredentials")
                .setViewName("thymeleaf/athn/badCredentials");
        registry.addViewController("/thymeleaf/usernameNotFound")
                .setViewName("thymeleaf/athn/usernameNotFound");
        registry.addViewController("/thymeleaf/disabled").setViewName("thymeleaf/athn/disabled");
        registry.addViewController("/thymeleaf/systemError")
                .setViewName("thymeleaf/athn/systemError");
    }
