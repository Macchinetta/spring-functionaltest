...
@Controller
public class ATHN_Thymeleaf_19Controller {
    ...
    public String handle19001(Model model, AdministratorForm form) {
        return "thymeleaf/athn/createAdministratorUsingMessagePassword";
    }
    ...
    public String createAdministratorUsingMessagePassword(Model model,
        ...
        return "redirect:/thymeleaf/1901/001/createCompleteAdminUsingMessage?complete";
    }
    ...
    public String handle19002(Model model, AdministratorForm form) {
        return "thymeleaf/athn/loginAdministratorUsingMessagePassword";
    }
    ...
    public String afterLoginUsingMessagePassword(Principal principal, Model model) {
        ...
        return "thymeleaf/athn/showAdministratorInfoUsingMessagePassword";
    }

    @GetMapping(value = "/1901/003")
    public String handle19003(Model model, AdministratorForm form) {
        return "thymeleaf/athn/createAdministratorUsingMessageDelegatingPassword";
    }
    ...
    public String createAdministratorUsingMessageDelegatingPassword(Model model,
        ...
        return "redirect:/thymeleaf/1901/003/createCompleteAdminUsingDelegating?complete";
    }
    ...
    public String handle19004(Model model, AdministratorForm form) {
        return "thymeleaf/athn/loginAdministratorUsingMessageDelegatingPassword";
    }
    ...
    public String afterLoginUsingMessageDelegatingPassword(Principal principal, Model model) {
        ...
        return "thymeleaf/athn/showAdministratorInfoUsingMessageDelegatingPassword";
    }
