...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.athn.createAdministratorUsingDelegatingPassword" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <br />
                <t:messagesPanel />
                <form:form action="${pageContext.request.contextPath}/jsp/0502/001/createAdminUsingDelegating" cssClass="form-horizontal" method="post" modelAttribute="administratorForm">
                    <legend>管理者登録</legend>
