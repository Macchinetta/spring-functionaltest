...
<c:set var="titleKey" value="title.athn.loginForUsingDelegatingPassword" />
...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/jsp/0502/002/authenticate"
  ...
  <form:form action="${pageContext.request.contextPath}/jsp/0502/002/logout"
    cssClass="form-horizontal" method="post">
    <div class="form-group">
