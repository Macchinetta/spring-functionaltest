    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <br />
                <t:messagesPanel />
                <form:form action="${pageContext.request.contextPath}/jsp/0501/005/createAdminUsingSCrypt" cssClass="form-horizontal" method="post" modelAttribute="administratorForm">
                    <legend>管理者登録</legend>
