...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.athn.createAdministratorUsingMessageDelegatingPassword" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h1 id="screenTitle">管理者登録(DelegatingPasswordEncoder)</h1>
                <br />
                <t:messagesPanel />
                <form:form action="${pageContext.request.contextPath}/jsp/1901/003/createAdminUsingDelegating" cssClass="form-horizontal" method="post" modelAttribute="administratorForm">
                    <legend>管理者登録</legend>
