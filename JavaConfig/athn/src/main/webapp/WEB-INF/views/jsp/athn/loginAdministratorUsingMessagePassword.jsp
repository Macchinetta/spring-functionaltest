...
<c:set var="titleKey" value="title.athn.loginAdministratorUsingMessagePassword" />
...
<div id="wrapper">
  ...
  <c:if test="${param.containsKey('error')}">
    <span id="loginError">
        <t:messagesPanel messagesAttributeName="SPRING_SECURITY_LAST_EXCEPTION" panelClassName="alert alert-danger" />
    </span>
  </c:if>

  <form:form action="${pageContext.request.contextPath}/jsp/1901/002/authenticate"
  ...
  <form:form action="${pageContext.request.contextPath}/jsp/1901/002/logout"
    cssClass="form-horizontal" method="post">
    <div class="form-group">
