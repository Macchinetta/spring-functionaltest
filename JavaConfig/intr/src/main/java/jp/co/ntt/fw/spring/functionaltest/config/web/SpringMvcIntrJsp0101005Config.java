...
import jp.co.ntt.fw.spring.functionaltest.app.intr.INTR_JSP_0101005Controller;
...
public class SpringMvcIntrJsp0101005Config implements WebMvcConfigurer {
    ...
    /**
     * Configure {@link INTR_JSP_0101005Controller} bean.
     * @return Bean of configured {@link INTR_JSP_0101005Controller}
     */
    @Bean
    public INTR_JSP_0101005Controller iNTR_JSP_0101005Controller() {
        return new INTR_JSP_0101005Controller();
    }
}
