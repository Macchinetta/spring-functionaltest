...
(function (window, undefined) {
        ...
        function matcherFromTokens(tokens) {
            var checkContext,
                ...
                matchers = [
                    function (elem, context, xml) {
                        return (
                            (!leadingRelative && (xml || context !== outermostContext)) || ((checkContext = context).nodeType ? matchContext(elem, context, xml) : matchAnyContext(elem, context, xml))
                        );
                    },
                ];
            ...
            (getSetInput && getSetAttribute) || !ruseDefault.test(name)
                ? function (elem, name, isXML) {
                      var fn = jQuery.expr.attrHandle[name],
                          ret = isXML ? undefined : /* jshint eqeqeq: false */ (jQuery.expr.attrHandle[name] = undefined) != getter(elem, name, isXML) ? name.toLowerCase() : null;
        ...
        jQuery.cssHooks[name] = {
            ...
            set: function (elem, value, extra) {
                ...
                return setPositiveNumber(
                    elem,
                    value,
                    extra ? augmentWidthOrHeight(elem, name, extra, jQuery.support.boxSizing && jQuery.css(elem, "boxSizing", false, styles) === "border-box", styles) : 0
                );
            },
        };
    });
    ...
    jQuery.ajaxPrefilter("json jsonp", function (s, originalSettings, jqXHR) {
        var callbackName,
            ...
            responseContainer,
            jsonProp =
                s.jsonp !== false && (rjsonp.test(s.url) ? "url" : typeof s.data === "string" && !(s.contentType || "").indexOf("application/x-www-form-urlencoded") && rjsonp.test(s.data) && "data");
    ...
    jQuery.speed = function (speed, easing, fn) {
        var opt =
            speed && typeof speed === "object"
                ? jQuery.extend({}, speed)
                : {
                      complete: fn || easing || (jQuery.isFunction(speed) && speed),
                      duration: speed,
