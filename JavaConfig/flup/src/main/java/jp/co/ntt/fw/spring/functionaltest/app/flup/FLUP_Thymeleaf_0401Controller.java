 ...
 */
@RequestMapping("thymeleaf/0401")
@Controller
public class FLUP_Thymeleaf_0401Controller {
    ...
    private String form() {
        return "thymeleaf/flup/multiFileUploadForm";
    }
    ...
    private String upload(@Validated MultiUploadForm form, BindingResult result,
        ...
        return "redirect:/thymeleaf/0401?complete";
    }
