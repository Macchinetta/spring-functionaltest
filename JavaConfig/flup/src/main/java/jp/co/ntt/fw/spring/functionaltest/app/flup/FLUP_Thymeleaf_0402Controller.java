 ...
 */
@RequestMapping("thymeleaf/0402")
@Controller
public class FLUP_Thymeleaf_0402Controller {
    ...
    public String handleComplate() {
        return "thymeleaf/flup/multiFileUploadComplete";
    }

    private String form() {
        return "thymeleaf/flup/multipleFileUploadForm";
    }
    ...
    private String upload(@Validated MultipleUploadForm form, BindingResult result,
        ...
        return "redirect:/thymeleaf/0402?complete";
    }
