...
import jp.co.ntt.fw.spring.functionaltest.app.exhn.ArticleSessionInfo;
...
public class SpringMvcExhn0601002Config implements WebMvcConfigurer {
    ...
    public SystemExceptionResolver systemExceptionResolver(
        ...
        bean.setExceptionAttribute("exceptionForExceptionResolver");
        bean.setPreventResponseCaching(true);
        return bean;
    }

    /**
     * Configure {@link EXHN_JSP_0601002Controller} bean.
     * @return Bean of configured {@link EXHN_JSP_0601002Controller}
     */
    @Bean
    public EXHN_JSP_0601002Controller eXHN_JSP_0601002Controller() {
        return new EXHN_JSP_0601002Controller();
    }

    /**
     * Configure {@link EXHN_Thymeleaf_0601002Controller} bean.
     * @return Bean of configured {@link EXHN_Thymeleaf_0601002Controller}
     */
    @Bean
    public EXHN_Thymeleaf_0601002Controller eXHN_Thymeleaf_0601002Controller() {
        return new EXHN_Thymeleaf_0601002Controller();
    }

    /**
     * Configure {@link ArticleFileHelper} bean.
     * @return Bean of configured {@link ArticleFileHelper}
     */
    @Bean
    public ArticleFileHelper articleFileHelper() {
        return new ArticleFileHelper();
    }

    /**
     * Configure {@link ArticleSessionInfo} bean.
     * @return Bean of configured {@link ArticleSessionInfo}
     */
    @Bean
    public ArticleSessionInfo articleSessionInfo() {
        return new ArticleSessionInfo();
    }
}
