...
@Import({ SpringFunctionaltestWebExhnInfraConfig.class,
        SpringFunctionaltestWebExhnCodelistConfig.class })
public class SpringFunctionaltestWebExhnDomainConfig {
