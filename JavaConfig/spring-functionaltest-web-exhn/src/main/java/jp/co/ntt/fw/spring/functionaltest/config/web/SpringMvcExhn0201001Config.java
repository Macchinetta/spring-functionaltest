...
import jp.co.ntt.fw.spring.functionaltest.app.exhn.EXHN_JSP_0601004Controller;
...
import jp.co.ntt.fw.spring.functionaltest.app.exhn.EXHN_Thymeleaf_0601004Controller;
...
@ComponentScan(basePackages = {
        "jp.co.ntt.fw.spring.functionaltest.app.exhn" }, excludeFilters = {
                ...
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = ArticleSessionInfo.class),
                ...
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = EXHN_JSP_0601004Controller.class),
                ...
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = EXHN_Thymeleaf_0601002Controller.class),
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = EXHN_Thymeleaf_0601003Controller.class),
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = EXHN_Thymeleaf_0601004Controller.class),
...
public class SpringMvcExhn0201001Config implements WebMvcConfigurer {
    ...
    public SystemExceptionResolver systemExceptionResolver(
        ...
        statusCodes.setProperty("jsp/exhn/businessError", String
