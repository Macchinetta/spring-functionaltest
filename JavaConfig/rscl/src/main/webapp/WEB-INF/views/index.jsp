    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <ul>
                    <li>REST Clinet (<a id="rscl_jsp" href="${pageContext.request.contextPath}/jsp/rscl">JSP</a> / Thymeleaf)</li>
                    <li>Web Clinet (<a id="wbcl_jsp" href="${pageContext.request.contextPath}/jsp/wbcl">JSP</a> / Thymeleaf)</li>
                </ul>
            </div>
        </div>
