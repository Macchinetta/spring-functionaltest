...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.aply.formObjectForm2" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" cssClass="form-horizontal" modelAttribute="formObjectForm2">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col col-md-3">
                                <span id="value1ValidationErrorMessage"><form:errors path="value1" cssClass="errorMessage" /></span>
                            </div>
                        </div>
                        <div class="form-group">
