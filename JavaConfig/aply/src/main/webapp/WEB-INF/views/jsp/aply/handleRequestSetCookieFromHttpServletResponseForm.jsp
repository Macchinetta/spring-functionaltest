    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <ul>
                    <li><a id="setCookie" href="${pageContext.request.contextPath}/jsp/0102/008/setCookie">Cookie設定(事前準備)</a></li>
                    <li><a id="confirm" href="${pageContext.request.contextPath}/jsp/0102/008/confirm">Cookie値を引数から取得</a></li>
                </ul>
            </div>
        </div>
