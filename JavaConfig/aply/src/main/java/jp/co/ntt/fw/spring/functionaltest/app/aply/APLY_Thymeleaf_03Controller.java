...
@Controller
public class APLY_Thymeleaf_03Controller {
    ...
    public String handle01001(Model model) {
        return "thymeleaf/aply/useCommonJsp";
    }
    ...
    public String handle02001(Model model) {
        ...
        return "thymeleaf/aply/showValueUsingELHtmlEscapeInModel";
    }
    ...
    public String handle02002(Model model) {
        ...
        return "thymeleaf/aply/showValueUsingJSTLHtmlEscapeInModel";
    }
    ...
    public String handle02003(Model model) {
        ...
        return "thymeleaf/aply/showValueUsingNumberFormatInModel";
    }
    ...
    public String handle02004(Model model) {
        ...
        return "thymeleaf/aply/showValueUsingDateFormatInModel";
    }
    ...
    public String handleInputDisplaySwitchingUsingCIf(Model model, JspForm form) {
        return "thymeleaf/aply/showDisplaySwitchingUsingCIf";
    }
    ...
    public String handleInputDisplaySwitchingUsingCChoose(Model model, JspForm form) {
        return "thymeleaf/aply/showDisplaySwitchingUsingCChoose";
    }
