...
import jp.co.ntt.fw.spring.functionaltest.app.aply.LoggingIpAddressFilter;
...
@Import({SpringFunctionaltestWebAplyDomainConfig.class})
public class ApplicationContextConfig {
    ...
    public MessageSource messageSource() {
        ...
        bean.setBasenames("i18n/application-messages", "i18n/application-messages-aply");
        return bean;
    }
    ...
    public ExceptionCodeResolver exceptionCodeResolver() {
        ...
        map.put("InvalidRequestException", "e.sf.fw.8002");
        map.put("IntentionalException", "e.sf.fw.8003");
    ...
    /**
     * Configure {@link LoggingIpAddressFilter} bean.
     * @return Bean of configured {@link LoggingIpAddressFilter}
     */
    @Bean("loggingIpAddressAsBeanFilter")
    public LoggingIpAddressFilter loggingIpAddressAsBeanFilter() {
        return new LoggingIpAddressFilter();
    }
}
