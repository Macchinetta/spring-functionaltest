 ...
 * Configure SpringMVC.
 */
@ComponentScan(basePackages = {"jp.co.ntt.fw.spring.functionaltest.app.aply"}, excludeFilters = {
        @Filter(type = FilterType.REGEX,
                pattern = "jp.co.ntt.fw.spring.functionaltest.app.aply.APLY_JSP_01..*"),
        ...
        @Filter(type = FilterType.REGEX,
                pattern = "jp.co.ntt.fw.spring.functionaltest.app.aply.APLY_Thymeleaf_01..*"),
