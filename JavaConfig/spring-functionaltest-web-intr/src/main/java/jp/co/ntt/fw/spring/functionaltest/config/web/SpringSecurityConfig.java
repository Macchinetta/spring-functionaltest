...
public class SpringSecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return web -> web.ignoring().requestMatchers(
                ...
                new AntPathRequestMatcher("/**/testdata/*"));
    }
    ...
    public SecurityFilterChain filterChain0301001(HttpSecurity http,
        ...
        http.formLogin(login -> login.loginPage("/jsp/0301/001/login")
                .defaultSuccessUrl("/").loginProcessingUrl(
                        "/jsp/0301/001/authentication"));
        http.exceptionHandling(ex -> ex.accessDeniedPage(
                "/WEB-INF/views/jsp/intr/accessDeniedPage.jsp"));
        http.logout(logout -> logout.logoutUrl("/jsp/0301/001/logout")
                .logoutSuccessUrl("/"));
        http.sessionManagement(Customizer.withDefaults());
        http.authorizeHttpRequests(authz -> authz.requestMatchers(
                new AntPathRequestMatcher("/jsp/0301/001/goToError")).hasRole(
                        "STAFF").requestMatchers(
                                new AntPathRequestMatcher("/jsp/0301/001/*"))
    ...
    public SecurityFilterChain filterChain0301002(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/jsp/0301/002/**"));
        http.authenticationManager(userLoginManager);
        http.formLogin(login -> login.loginPage("/jsp/0301/001/login")
                .defaultSuccessUrl("/").loginProcessingUrl(
                        "/jsp/0301/001/authentication"));
        ...
        http.sessionManagement(Customizer.withDefaults());
        http.authorizeHttpRequests(authz -> authz.requestMatchers(
                new AntPathRequestMatcher("/jsp/0301/002/goToError")).hasRole(
                        "STAFF").requestMatchers(
                                new AntPathRequestMatcher("/jsp/0301/002/*"))
                .permitAll().requestMatchers(new AntPathRequestMatcher("/**"))
                .permitAll());
    ...
    public AuthenticationProvider authenticationProvider(
            UserDetailsService intrUserDetailsService,
