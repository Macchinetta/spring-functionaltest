...
@Import({ SpringFunctionaltestWebIntrInfraConfig.class,
        SpringFunctionaltestWebIntrCodelistConfig.class })
public class SpringFunctionaltestWebIntrDomainConfig {
