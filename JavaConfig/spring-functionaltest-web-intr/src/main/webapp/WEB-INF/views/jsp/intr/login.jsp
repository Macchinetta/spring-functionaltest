...
<div id="wrapper">
  ...
  <form:form method="post" action="${pageContext.request.contextPath}/jsp/0301/001/authentication"
  ...
  <form:form method="post" action="${pageContext.request.contextPath}/jsp/0301/001/logout"
    class="form-horizontal">
