...
@Import({ SpringFunctionaltestWebAplyInfraConfig.class,
        SpringFunctionaltestWebAplyCodelistConfig.class })
public class SpringFunctionaltestWebAplyDomainConfig {
