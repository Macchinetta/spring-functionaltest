...
<div id="wrapper">
  ...
  <form action="${pageContext.request.contextPath}/jsp/0101/001_1" method="get"
  ...
  <form:form action="${pageContext.request.contextPath}/jsp/0101/001_2" method="post"
  ...
  <form action="${pageContext.request.contextPath}/jsp/0101/001_3" method="get"
    class="form-horizontal">
    <spring:nestedPath path="handleRequestForm">
  ...
  <form:form action="${pageContext.request.contextPath}/jsp/0101/001_3" method="post"
    cssClass="form-horizontal" modelAttribute="handleRequestForm">
