...
@Import({ SpringFunctionaltestWebHlchInfraConfig.class,
        SpringFunctionaltestWebHlchCodelistConfig.class })
public class SpringFunctionaltestWebHlchDomainConfig {
