...
public class SpringSecurityAthr08Config {
    ...
    public AntPathRequestMatcher jspEntryPointAntPathRequestMatcher() {
        return new AntPathRequestMatcher("/jsp/0802/001/api/**");
    }
    ...
    public SecurityFilterChain filterChainJsp0802(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/jsp/0802/**"));
        http.authenticationManager(loginForStaffManager);
        http.exceptionHandling(exceptionHandling -> exceptionHandling
                .authenticationEntryPoint(jspAjaxAuthenticationEntryPoint()));
        http.formLogin(login -> login
                .loginProcessingUrl("/jsp/0802/customerAuthenticate")
                .defaultSuccessUrl("/jsp/0802/001?loginSuccess", true));
        http.logout(logout -> logout.logoutUrl("/jsp/0802/logout")
                .logoutSuccessUrl("/")
                .invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/jsp/0802/001/api")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0802/001/afterLogin")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0802/**")).permitAll()
    ...
    public DelegatingAuthenticationEntryPoint thymeleafAjaxAuthenticationEntryPoint() {
        ...
        LinkedHashMap<RequestMatcher, AuthenticationEntryPoint> map = new LinkedHashMap<RequestMatcher, AuthenticationEntryPoint>();
        map.put(thymeleafEntryPointAntPathRequestMatcher(),
                thymeleafEntryPoint());
        DelegatingAuthenticationEntryPoint bean = new DelegatingAuthenticationEntryPoint(map);
    ...
    public AntPathRequestMatcher thymeleafEntryPointAntPathRequestMatcher() {
        return new AntPathRequestMatcher("/thymeleaf/0802/001/api/**");
    }
    ...
    public SecurityFilterChain filterChainThymeleaf0802(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/0802/**"));
        http.authenticationManager(loginForStaffManager);
        http.exceptionHandling(exceptionHandling -> exceptionHandling
                .authenticationEntryPoint(
                        thymeleafAjaxAuthenticationEntryPoint()));
        http.formLogin(login -> login
                .loginProcessingUrl("/thymeleaf/0802/customerAuthenticate")
                .defaultSuccessUrl("/thymeleaf/0802/001?loginSuccess", true));
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0802/logout")
                .logoutSuccessUrl("/")
                .invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0802/001/api")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0802/001/afterLogin")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0802/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/**")).permitAll());
