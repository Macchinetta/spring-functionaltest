...
@Import({ SpringFunctionaltestWebAthrInfraConfig.class,
        SpringFunctionaltestWebAthrCodelistConfig.class })
public class SpringFunctionaltestWebAthrDomainConfig {
