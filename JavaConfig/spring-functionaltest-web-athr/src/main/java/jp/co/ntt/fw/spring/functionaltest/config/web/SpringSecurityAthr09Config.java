...
public class SpringSecurityAthr09Config {
     ...
     * @param loginForRoleHierarchyAuthenticationProvider Bean defined by #loginForRoleHierarchyAuthenticationProvider
     ...
     * @param loginForRoleHierarchyDetailsService Bean defined by #loginForRoleHierarchyDetailsService
    ...
    public SecurityFilterChain filterChainJsp0901(HttpSecurity http,
            @Qualifier("loginForRoleHierarchyManager") AuthenticationManager loginForRoleHierarchyManager) throws Exception {

        AuthorityAuthorizationManager<RequestAuthorizationContext> authManager = AuthorityAuthorizationManager
                .hasRole("STAFF");
        authManager.setRoleHierarchy(authorizationRoleHierarchy());

        http.securityMatcher(new AntPathRequestMatcher("/jsp/0901/001/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/0901/001/logout")
        ...
        http.authorizeHttpRequests(authz -> authz.requestMatchers(
                new AntPathRequestMatcher("/jsp/0901/001/*")).access(
                        authManager).requestMatchers(
    ...
    public SecurityFilterChain filterChainJsp0902(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/jsp/0901/002/**"));
        http.authenticationManager(loginForRoleHierarchyManager);
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/0901/002/logout")
                .logoutSuccessUrl("/").invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.exceptionHandling(exceptionHandling -> exceptionHandling
                .accessDeniedPage("/jsp/hierarchyAccessDeniedPage"));
    ...
    public SecurityFilterChain filterChainJsp0903(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/jsp/0901/003/**"));
        http.authenticationManager(loginForRoleHierarchyManager);
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/0901/003/logout")
                .logoutSuccessUrl("/").invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.exceptionHandling(exceptionHandling -> exceptionHandling
                .accessDeniedPage("/jsp/methodHierarchyAccessDeniedPage"));
        http.authorizeHttpRequests(authz -> authz.requestMatchers(
                new AntPathRequestMatcher("/jsp/0901/003/*")).permitAll()
    ...
    public SecurityFilterChain filterChainThymeleaf0901(HttpSecurity http,
        ...
        http.securityMatcher(
                new AntPathRequestMatcher("/thymeleaf/0901/001/**"));
        http.authenticationManager(loginForRoleHierarchyManager);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0901/001/logout")
                .logoutSuccessUrl("/").invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.exceptionHandling(exceptionHandling -> exceptionHandling
                .accessDeniedPage("/thymeleaf/hierarchyAccessDeniedPage"));
        http.authorizeHttpRequests(authz -> authz.requestMatchers(
                new AntPathRequestMatcher("/thymeleaf/0901/001/*")).access(
                        authManager).requestMatchers(
                                new AntPathRequestMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf0902(HttpSecurity http,
        ...
        http.securityMatcher(
                new AntPathRequestMatcher("/thymeleaf/0901/002/**"));
        http.authenticationManager(loginForRoleHierarchyManager);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0901/002/logout")
                .logoutSuccessUrl("/").invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.exceptionHandling(exceptionHandling -> exceptionHandling
                .accessDeniedPage("/thymeleaf/hierarchyAccessDeniedPage"));
    ...
    public SecurityFilterChain filterChainThymeleaf0903(HttpSecurity http,
        ...
        http.securityMatcher(
                new AntPathRequestMatcher("/thymeleaf/0901/003/**"));
        http.authenticationManager(loginForRoleHierarchyManager);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0901/003/logout")
                .logoutSuccessUrl("/").invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.exceptionHandling(exceptionHandling -> exceptionHandling
                .accessDeniedPage(
                        "/thymeleaf/methodHierarchyAccessDeniedPage"));
        http.authorizeHttpRequests(authz -> authz.requestMatchers(
                new AntPathRequestMatcher("/thymeleaf/0901/003/*")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/**")).permitAll());
