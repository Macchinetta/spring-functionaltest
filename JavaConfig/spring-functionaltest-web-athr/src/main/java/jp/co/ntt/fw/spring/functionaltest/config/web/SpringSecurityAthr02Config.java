...
public class SpringSecurityAthr02Config {
    ...
    public SecurityFilterChain filterChainJsp0201(HttpSecurity http,
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/0201/logout")
                .logoutSuccessUrl("/")
                .invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/jsp/0201/001/*")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0201/002/restrict.*")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0201/002/restrict/")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0201/002/restrict")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0201/004/showForAccessSuccessfully")).authenticated()
    ...
    public SecurityFilterChain filterChainThymeleaf0201(HttpSecurity http,
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0201/logout")
                .logoutSuccessUrl("/")
                .invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0201/001/*")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0201/002/restrict.*")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0201/002/restrict/")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0201/002/restrict")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0201/004/showForAccessSuccessfully")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/**")).permitAll());
