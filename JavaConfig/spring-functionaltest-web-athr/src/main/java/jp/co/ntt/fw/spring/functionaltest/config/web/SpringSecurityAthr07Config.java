...
public class SpringSecurityAthr07Config {
    ...
    public JsonDelegatingAccessDeniedHandler jspAccessDeniedHandlerForAjax() {
        return new JsonDelegatingAccessDeniedHandler(jspAccessAntPathRequestMatcher(), jspAccessDeniedHandler());
    }
    ...
    public AntPathRequestMatcher jspAccessAntPathRequestMatcher() {
        return new AntPathRequestMatcher("/jsp/0701/001/denyjson/**");
    }
    ...
    public SecurityFilterChain filterChainJsp0701(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/jsp/0701/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/0701/logout")
                .logoutSuccessUrl("/")
        ...
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/jsp/0701/001/afterLogin")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0701/001/denyjson/**")).denyAll()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0701/001/deny/**")).denyAll()
                .requestMatchers(new AntPathRequestMatcher("jsp/0701/001/**")).permitAll()
    ...
    public JsonDelegatingAccessDeniedHandler thymeleafAccessDeniedHandlerForAjax() {
        return new JsonDelegatingAccessDeniedHandler(thymeleafAccessAntPathRequestMatcher(), thymeleafAccessDeniedHandler());
    }
    ...
    public AntPathRequestMatcher thymeleafAccessAntPathRequestMatcher() {
        return new AntPathRequestMatcher("/thymeleaf/0701/001/denyjson/**");
    }
    ...
    public SecurityFilterChain filterChainThymeleaf0701(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/0701/**"));
        http.authenticationManager(loginForStaffManager);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0701/logout")
                .logoutSuccessUrl("/")
                .invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.exceptionHandling(exceptionHandling -> exceptionHandling
        ...
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0701/001/afterLogin")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0701/001/denyjson/**")).denyAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0701/001/deny/**")).denyAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0701/001/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/**")).permitAll());
