...
<body>
  ...
  <div class="container">
<div id="wrapper">
  <sec:authorize url="/jsp/0401/001/afterLogin/admin/menu" var="hasAdminAuthority" />
    ...
    <table class="table table-bordered table-condensed">
      ...
      <tr>
        ...
        <td><span id="staffRoleLink"> <sec:authorize
              url="/jsp/0401/001/afterLogin/admin/menu">
              <a href="${pageContext.request.contextPath}">Go To ATHR Top Page</a>
            </sec:authorize>
        </span></td>
      </tr>
      <tr>
        ...
        <td><span id="staffRoleVarLink"> <c:if test="${hasAdminAuthority}">
              <a href="${pageContext.request.contextPath}">Go To ATHR Top Page(variable)</a>
            </c:if>
        </span></td>
      </tr>
    </table>
