...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/jsp/0901/001/authenticate" method="post">
  ...
  <br>
  <form:form action="${pageContext.request.contextPath}/jsp/0901/001/logout" method="post">
