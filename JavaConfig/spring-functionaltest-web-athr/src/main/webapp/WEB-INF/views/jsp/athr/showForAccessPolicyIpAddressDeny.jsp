    ...
    <table class="table table-bordered table-condensed">
      ...
      <tr>
        ...
        <td><span> <a id="managerLink"
            href="${pageContext.request.contextPath}/jsp/0601/003/manager">Go To Account Page
              Top Page</a>
        </span></td>
      </tr>
      <tr>
        ...
        <td><span> <a id="configLink"
            href="${pageContext.request.contextPath}/jsp/0601/003/configurations">Go To
      ...
      <tr>
        ...
        <td><span> <a id="adminLink"
            href="${pageContext.request.contextPath}/jsp/0601/003/admin">Go To Manager Page</a>
        </span></td>
      ...
      <tr>
        ...
        <td><span> <a id="allLink"
            href="${pageContext.request.contextPath}/jsp/0601/003/all">Go To Authenticated User
              Page</a>
        </span></td>
      </tr>
    </table>
  </fieldset>
  <form:form action="${pageContext.request.contextPath}/jsp/0601/003/logout" method="post">
