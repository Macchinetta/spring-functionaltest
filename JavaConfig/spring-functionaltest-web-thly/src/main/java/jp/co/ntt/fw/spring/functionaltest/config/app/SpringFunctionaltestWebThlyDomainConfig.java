...
@Import({ SpringFunctionaltestWebThlyInfraConfig.class,
        SpringFunctionaltestWebThlyCodelistConfig.class })
public class SpringFunctionaltestWebThlyDomainConfig {
