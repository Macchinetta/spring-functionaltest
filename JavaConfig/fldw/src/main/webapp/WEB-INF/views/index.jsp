...
<body>
    ...
    <div class="container">
        <div id="wrapper">
            ...
            <ul>
                <li>fldw0101001 <a id="fldw0101001_jsp" href="${pageContext.request.contextPath}/jsp/0101/001">JSP / <a
                            id="fldw0101001_thymeleaf"
                            href="${pageContext.request.contextPath}/thymeleaf/0101/001">Thymeleaf</a></li>
            </ul>
            <div>[FLDW02] Excelダウンロード</div>
            <ul>
                <li>fldw0201001 <a id="fldw0201001_jsp" href="${pageContext.request.contextPath}/jsp/0201/001">JSP / <a
                            id="fldw0201001_thymeleaf"
                            href="${pageContext.request.contextPath}/thymeleaf/0201/001">Thymeleaf</a></li>
            </ul>
        </div>
