            ...
            <div class="row">
                ...
                <div>
                    <table class="table table-striped table-bordered table-condensed">
                        <thead>
                            <form:form modelAttribute="orderForm" action="${pageContext.request.contextPath}/jsp/order" method="get">
                                <tr>
                            ...
                            <form:form modelAttribute="orderForm" action="${pageContext.request.contextPath}/jsp/order/delete" method="delete">
                                <tr>
                                ...
                                <c:choose>
                                    <c:when test="${cmnCodnSrchFlag }">
                                        <td id="orderId_${rowStatus.count}">
                                            <a id="id${f:h(rowStatus.count)}" href="${pageContext.request.contextPath}/jsp/order/cmnCondFetch/${f:h(order.orderId)}/detail">${f:h(order.orderId)}</a>
                                        </td>
                                    </c:when>
                                    <c:otherwise>
                                        <td id="orderId_${rowStatus.count}">
                                            <a id="id${f:h(rowStatus.count)}" href="${pageContext.request.contextPath}/jsp/order/${f:h(order.orderId)}/detail">${f:h(order.orderId)}</a>
                                        </td>
                                    </c:otherwise>
                                </c:choose>
