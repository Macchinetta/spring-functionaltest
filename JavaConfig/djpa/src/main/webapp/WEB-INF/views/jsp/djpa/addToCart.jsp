...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.djpa.addToCart" />
    ...
    <body>
        ...
        <div class="container">
            <form:form modelAttribute="cartForm" action="${pageContext.request.contextPath}/jsp/order/${orderId}/addToOrder" method="post">
                <table class="table table-striped table-bordered table-condensed">
                    ...
                    <c:forEach items="${itemList}" var="item" varStatus="rowStatus">
                        <tr>
                            ...
                            <td id="itemCode_${rowStatus.count}">
                                <form:input path="items[${rowStatus.index}].itemCode" value="${f:h(item.itemCode)}" readonly="true" style="background-color: whitesmoke" />
                            </td>

                            <td id="itName_${status.count}">
                                <form:input path="items[${rowStatus.index}].itemName" value="${f:h(item.itemName)}" readonly="true" style="background-color: whitesmoke" />
                            </td>

                            <td id="itPrice_${status.count}">
                                <form:input path="items[${rowStatus.index}].itemPrice" value="${f:h(item.itemPrice)}" readonly="true" style="background-color: whitesmoke" />
                            </td>
