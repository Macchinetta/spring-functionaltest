...
@Controller
@RequestMapping("jsp/book")
public class DJPA_JSP_CommonController {

    private static final Logger logger = LoggerFactory.getLogger(DJPA_JSP_CommonController.class);
    ...
    public String searchBookUsingCustomRepo(JPABookListForm jpaBookListForm, Model model) {
        ...
        return "jsp/djpa/registerComplete";
    ...
    public String registerFlashAttribute(JPABookListForm bookListForm,
        ...
        return "redirect:/jsp/book/redirectRegisterComplete";
    ...
    public String updateEGComplete(@PathVariable("id") String id, Model model) {
        ...
        return "jsp/djpa/jpaUpdateComplete";
    }
    ...
    public String lockTimeoutAndPessimisticLocking(JPABookListForm jpaBookListForm, Model model)
        ...
        try {
            ...
            model.addAttribute(ResultMessages.warning().add("djpa.result.exclusivelockacquired"));
