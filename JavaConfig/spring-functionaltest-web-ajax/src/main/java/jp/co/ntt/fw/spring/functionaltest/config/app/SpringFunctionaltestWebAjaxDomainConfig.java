...
@Import({ SpringFunctionaltestWebAjaxInfraConfig.class,
        SpringFunctionaltestWebAjaxCodelistConfig.class })
public class SpringFunctionaltestWebAjaxDomainConfig {
