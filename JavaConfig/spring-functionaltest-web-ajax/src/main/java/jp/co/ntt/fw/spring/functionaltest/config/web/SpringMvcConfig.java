...
@ComponentScan(basePackages = {
        "jp.co.ntt.fw.spring.functionaltest.app" }, excludeFilters = {
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = AJAX_JSP_0104001Controller.class),
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = AJAX_Thymeleaf_0104001Controller.class), })
@Configuration
@EnableWebMvc
...
public class SpringMvcConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        registry.addViewController("/ajaxError").setViewName(
                "jsp/common/error/ajaxError");
    }
