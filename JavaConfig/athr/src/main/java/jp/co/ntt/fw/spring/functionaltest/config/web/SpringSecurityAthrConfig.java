...
public class SpringSecurityAthrConfig {
     ...
     * @param loginForStaffAuthenticationProvider Bean defined by
     *        #loginForStaffAuthenticationProvider
     * @return Bean of configured {@link AuthenticationManager}
     */
    @Bean("loginForStaffManager")
    // If multiple AuthenticationManagers are defined, the following error will occur, so set
    // Primary.
    // Found 19 beans for type interface
    // org.springframework.security.authentication.AuthenticationManager, but none marked as primary
    @Primary
     ...
     * @param loginForStaffDetailsService Bean defined by
     *        SpringSecurityAthr02Config#loginForStaffDetailsService
    ...
    /**
     * Configure {@link AuthenticationManager} bean.
     * @param loginForMethodAuthenticationProvider Bean defined by
     *        #loginForMethodAuthenticationProvider
     * @return Bean of configured {@link AuthenticationManager}
     */
    ...
    /**
     * Configure {@link AuthenticationProvider} bean.
     * @param loginForMethodDetailsService Bean defined by
     *        SpringSecurityAthr03Config#loginForMethodDetailsService
     * @param passwordEncoder Bean defined by ApplicationContextConfig#passwordEncoder
     * @return Bean of configured {@link AuthenticationProvider}
     */
    ...
    /**
     * Configure {@link AuthenticationManager} bean.
     * @param loginForRoleUserAuthenticationProvider Bean defined by
     *        #loginForRoleUserAuthenticationProvider
     * @return Bean of configured {@link AuthenticationManager}
     */
    ...
    /**
     * Configure {@link AuthenticationProvider} bean.
     * @param loginForRoleUserDetailsService Bean defined by
     *        SpringSecurityAthr04Config#loginForRoleUserDetailsService
     * @param passwordEncoder Bean defined by ApplicationContextConfig#passwordEncoder
     * @return Bean of configured {@link AuthenticationProvider}
     */
