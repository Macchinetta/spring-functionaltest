...
public class SpringSecurityAthr04Config {
    ...
    public SecurityFilterChain filterChainJsp0401(HttpSecurity http,
            @Qualifier("loginForRoleUserManager") AuthenticationManager loginForRoleUserManager)
            throws Exception {
        ...
        http.authorizeHttpRequests(
                authz -> authz.requestMatchers(antMatcher("/jsp/0401/001/afterLogin/admin/menu"))
                        .hasRole("ADMIN").requestMatchers(antMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf0401(HttpSecurity http,
        ...
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(antMatcher("/thymeleaf/0401/001/afterLogin/admin/menu"))
                .hasRole("ADMIN").requestMatchers(antMatcher("/**")).permitAll());
