...
@Configuration
@EnableWebSecurity
@Import({SpringSecurityAthrConfig.class, SpringSecurityAthr02Config.class,
        SpringSecurityAthr03Config.class, SpringSecurityAthr04Config.class,
        SpringSecurityAthr06Config.class, SpringSecurityAthr07Config.class,
        SpringSecurityAthr08Config.class, SpringSecurityAthr09Config.class})
