...
<c:set var="titleKey" value="title.athr.showForAccessPolicyDenyAll" />
    ...
    <table class="table table-bordered table-condensed">
      ...
      <tr>
        ...
        <td><span> <a id="accountsLink"
            href="${pageContext.request.contextPath}/jsp/0601/004/accounts">Go To Account Page
              Top Page</a>
        </span></td>
      </tr>
      <tr>
        ...
        <td><span> <a id="mangerLink"
            href="${pageContext.request.contextPath}/jsp/0601/004/admin">Go To Manager Page</a>
        </span></td>
      ...
      <tr>
        ...
        <td><span> <a id="denyLink"
            href="${pageContext.request.contextPath}/jsp/0601/004/deny">All Deny</a>
        </span></td>
      </tr>
      <tr>
        <th>Authenticated User link</th>
        <td><span> <a id="allLink"
            href="${pageContext.request.contextPath}/jsp/0601/004/all">Go To Authenticated User
              Page</a>
        </span></td>
      </tr>
    </table>
  </fieldset>
  <form:form action="${pageContext.request.contextPath}/jsp/0601/004/logout" method="post">
