...
@Service
@Transactional
public class TodoNotThroughAnAuthorizedServerServiceImpl implements TodoService {
    ...
    public Collection<Todo> findAll(@Nullable String registrationId) {
        ...
        ResponseEntity<List<Todo>> responseEntity =
                this.restOperations.exchange(requestEntity, new ParameterizedTypeReference<>() {});
