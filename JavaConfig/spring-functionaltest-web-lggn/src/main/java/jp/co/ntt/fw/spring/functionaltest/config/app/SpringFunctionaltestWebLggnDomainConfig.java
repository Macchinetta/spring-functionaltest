...
@Import({ SpringFunctionaltestWebLggnInfraConfig.class,
        SpringFunctionaltestWebLggnCodelistConfig.class })
public class SpringFunctionaltestWebLggnDomainConfig {
