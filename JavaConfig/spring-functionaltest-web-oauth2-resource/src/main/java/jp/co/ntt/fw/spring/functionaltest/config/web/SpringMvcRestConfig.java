...
import jp.co.ntt.fw.spring.functionaltest.api.oth2.interceptor.RequestInterceptor;

/**
 * Configure SpringMVC.
 */
@EnableAspectJAutoProxy
@ComponentScan(basePackages = { "jp.co.ntt.fw.spring.functionaltest.api" })
@EnableWebMvc
@Configuration
public class SpringMvcRestConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        addInterceptor(registry, requestInterceptor());
    }
