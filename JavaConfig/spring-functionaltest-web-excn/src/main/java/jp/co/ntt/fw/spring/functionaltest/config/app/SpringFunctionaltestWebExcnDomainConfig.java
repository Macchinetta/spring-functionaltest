...
@Import({ SpringFunctionaltestWebExcnInfraConfig.class,
        SpringFunctionaltestWebExcnCodelistConfig.class })
public class SpringFunctionaltestWebExcnDomainConfig {
