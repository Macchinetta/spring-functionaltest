    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <a id="spsc0501005" href="https://${connectIp}:${connectHttpsPort}/spsc/0501/005">HTTPS Access</a>
                ...
                <br />
                <img src="http://${connectIp}:${connectHttpPort}/spsc/resources/image/Duke.png" width="128" height="128" title="display image with http" />

                <br />
                <img src="https://${connectIp}:${connectHttpsPort}/spsc/resources/image/Duke.png" width="128" height="128" title="display image with https" />

                <br />
                <img src="http://${connectIp}:${connectHttpsPort}/spsc/resources/image/Duke.png" width="128" height="128" title="display image by CSP Header derective" />
            </div>
        </div>
