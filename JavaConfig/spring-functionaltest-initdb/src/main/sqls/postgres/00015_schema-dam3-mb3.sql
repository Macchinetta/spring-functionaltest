DROP TABLE IF EXISTS t_order_item_mb3;
DROP TABLE IF EXISTS m_item_category_mb3;
DROP TABLE IF EXISTS m_item_mb3;
DROP TABLE IF EXISTS t_order_mb3;
DROP TABLE IF EXISTS m_category_mb3;
DROP TABLE IF EXISTS c_order_status_mb3;
DROP TABLE IF EXISTS t_order_history_mb3;
DROP TABLE IF EXISTS t_motorcycle;
