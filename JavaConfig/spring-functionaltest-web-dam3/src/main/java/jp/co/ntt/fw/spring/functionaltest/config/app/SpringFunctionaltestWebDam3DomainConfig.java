...
@Import({ SpringFunctionaltestWebDam3InfraConfig.class,
        SpringFunctionaltestWebDam3CodelistConfig.class })
public class SpringFunctionaltestWebDam3DomainConfig {
