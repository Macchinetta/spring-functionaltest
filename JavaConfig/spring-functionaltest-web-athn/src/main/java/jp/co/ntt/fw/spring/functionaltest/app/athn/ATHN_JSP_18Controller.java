...
@Controller
public class ATHN_JSP_18Controller {
    ...
    public String handle1801001(Model model, AdministratorForm form) {
        return "jsp/athn/createAdministratorUsingCustomPbkdf2Password";
    }
    ...
    public String createAdministratorUsingCustomPbkdf2Password(Model model,
        ...
        return "redirect:/jsp/1801/001/createCompleteAdminUsingCustomPbkdf2?complete";
    }
    ...
    public String afterLoginUsingCustomPbkdf2Password(
        ...
        return "jsp/athn/showAdministratorInfoUsingCustomPbkdf2Password";
    }
