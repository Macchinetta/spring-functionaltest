...
public class SpringSecurityAthn16Config {
     ...
     * @param authEventSystemFailureHandleUserLoginManager Bean defined by #authEventSystemFailureHandleUserLoginManager
    ...
    public SecurityFilterChain filterChainJsp1601(HttpSecurity http,
            @Qualifier("authEventSystemFailureHandleUserLoginManager") AuthenticationManager authEventSystemFailureHandleUserLoginManager) throws Exception {

        http.securityMatcher(new AntPathRequestMatcher("/jsp/1601/**"));
        http.authenticationManager(
                authEventSystemFailureHandleUserLoginManager);
        http.formLogin(login -> login.loginPage("/jsp/1601/001/login")
                .loginProcessingUrl("/jsp/1601/authenticate").defaultSuccessUrl(
                        "/jsp/1601/001?loginSuccess", true).failureHandler(
                                jspAuthenticationSystemFailureHandler()));
        http.logout(logout -> logout.logoutUrl("/jsp/1601/001/logout")
                .logoutSuccessUrl("/athn"));
        http.authorizeHttpRequests(authz -> authz.requestMatchers(
                new AntPathRequestMatcher("/jsp/1601/001/login/**")).permitAll()
                .requestMatchers(
                        new AntPathRequestMatcher("/jsp/1601/001/logout/**"))
                .permitAll().requestMatchers(
                        new AntPathRequestMatcher("/jsp/1601/**"))
    ...
    public SecurityFilterChain filterChainJsp1602(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/jsp/1602/**"));
        http.authenticationManager(
                authEventSystemFailureHandleUserLoginManager);
        http.formLogin(login -> login.loginPage("/jsp/1602/001/login")
                .loginProcessingUrl("/jsp/1602/authenticate").defaultSuccessUrl(
                        "/jsp/1602/001?loginSuccess", true).failureUrl(
                                "/jsp/1602/001/login?systemError"));
        http.logout(logout -> logout.logoutUrl("/jsp/1602/001/logout")
                .logoutSuccessUrl("/athn"));
        http.authorizeHttpRequests(authz -> authz.requestMatchers(
                new AntPathRequestMatcher("/jsp/1602/001/login/**")).permitAll()
                .requestMatchers(
                        new AntPathRequestMatcher("/jsp/1602/001/logout/**"))
                .permitAll().requestMatchers(
                        new AntPathRequestMatcher("/jsp/1602/**"))
                .authenticated().requestMatchers(
                        new AntPathRequestMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf1601(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/1601/**"));
        http.authenticationManager(
                authEventSystemFailureHandleUserLoginManager);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/1601/001/logout")
                .logoutSuccessUrl("/athn"));
        http.authorizeHttpRequests(authz -> authz.requestMatchers(
                new AntPathRequestMatcher("/thymeleaf/1601/001/login/**"))
                .permitAll().requestMatchers(
                        new AntPathRequestMatcher("/thymeleaf/1601/001/logout/**"))
                .permitAll().requestMatchers(
                        new AntPathRequestMatcher("/thymeleaf/1601/**"))
                .authenticated().requestMatchers(
                        new AntPathRequestMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf1602(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/1602/**"));
        http.authenticationManager(
                authEventSystemFailureHandleUserLoginManager);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/1602/001/logout")
                .logoutSuccessUrl("/athn"));
        http.authorizeHttpRequests(authz -> authz.requestMatchers(
                new AntPathRequestMatcher("/thymeleaf/1602/001/login/**"))
                .permitAll().requestMatchers(
                        new AntPathRequestMatcher("/thymeleaf/1602/001/logout/**"))
                .permitAll().requestMatchers(
                        new AntPathRequestMatcher("/thymeleaf/1602/**"))
                .authenticated().requestMatchers(
                        new AntPathRequestMatcher("/**")).permitAll());
