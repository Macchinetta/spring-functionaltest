...
public class SpringSecurityAthn04Config {
     ...
     * @param dbUserLoginSpecifiedPassAuthenticationProvider Bean defined by #dbUserLoginSpecifiedPassAuthenticationProvider
    ...
    /**
     * Configure {@link AuthenticationManager} bean.
     * @param dbUserLoginSpecifiedHashAuthenticationProvider Bean defined by #dbUserLoginSpecifiedHashAuthenticationProvider
     * @return Bean of configured {@link AuthenticationManager}
     */
    ...
    public SecurityFilterChain filterChainJsp0401(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/jsp/0401/**"));
        ...
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/jsp/0401/001/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0401/001/logout/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0401/**")).authenticated()
    ...
    public SecurityFilterChain filterChainJsp0402001(HttpSecurity http,
            @Qualifier("dbUserLoginManagerForSpecifiedPass") AuthenticationManager dbUserLoginManagerForSpecifiedPass) throws Exception {

        http.securityMatcher(new AntPathRequestMatcher("/jsp/0402/001/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/0402/001/logout")
                .logoutSuccessUrl("/"));
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/jsp/0402/001/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0402/001/logout/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0402/001/**")).authenticated());
    ...
    public SecurityFilterChain filterChainJsp0402004(HttpSecurity http,
            @Qualifier("dbUserLoginManagerForSpecifiedHash") AuthenticationManager dbUserLoginManagerForSpecifiedHash) throws Exception {

        http.securityMatcher(new AntPathRequestMatcher("/jsp/0402/004/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/0402/004/logout")
                .logoutSuccessUrl("/"));
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/jsp/0402/004/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0402/004/logout/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0402/004/**")).authenticated());
    ...
    public SecurityFilterChain filterChainThymeleaf0401(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/0401/**"));
        http.authenticationManager(dbUserLoginManager);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0401/001/logout")
                .logoutSuccessUrl("/"));
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0401/001/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0401/001/logout/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0401/**")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf0402001(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/0402/001/**"));
        http.authenticationManager(dbUserLoginManagerForSpecifiedPass);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0402/001/logout")
                .logoutSuccessUrl("/"));
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0402/001/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0402/001/logout/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0402/001/**")).authenticated());
    ...
    public SecurityFilterChain filterChainThymeleaf0402004(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/0402/004/**"));
        http.authenticationManager(dbUserLoginManagerForSpecifiedHash);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0402/004/logout")
                .logoutSuccessUrl("/"));
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0402/004/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0402/004/logout/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0402/004/**")).authenticated());
