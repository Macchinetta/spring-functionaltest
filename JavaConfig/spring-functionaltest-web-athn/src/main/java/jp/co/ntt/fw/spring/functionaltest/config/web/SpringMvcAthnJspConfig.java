...
public class SpringMvcAthnJspConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        registry.addViewController("/0102/001/login").setViewName("jsp/athn/loginForDefaultFormAuthentication");
        registry.addViewController("/0201/001/login").setViewName("jsp/athn/loginForDefaultAuthenticationSeccess");
        registry.addViewController("/0301/001/login").setViewName("jsp/athn/loginForDefaultAuthenticationFailure");
        registry.addViewController("/0401/001/login").setViewName("jsp/athn/loginForDbFormAuthentication");
        registry.addViewController("/0402/001/login").setViewName("jsp/athn/loginForDbFormAuthenticationSpecifyEncoder");
        registry.addViewController("/0402/004/login").setViewName("jsp/athn/loginForDbFormAuthenticationSpecifyHash");
        registry.addViewController("/0501/002/login").setViewName("jsp/athn/loginForUsingBCryptPassword");
        registry.addViewController("/0501/004/login").setViewName("jsp/athn/loginForUsingPbkdf2Password");
        registry.addViewController("/0501/006/login").setViewName("jsp/athn/loginForUsingSCryptPassword");
        registry.addViewController("/0501/008/login").setViewName("jsp/athn/loginForUsingArgon2Password");
        registry.addViewController("/0502/002/login").setViewName("jsp/athn/loginForUsingDelegatingPassword");
        registry.addViewController("/0601/001/login").setViewName("jsp/athn/loginForAuthEventHandle");
        registry.addViewController("/0602/002/login").setViewName("jsp/athn/loginForAuthenticationServiceException");
        registry.addViewController("/0701/001/login").setViewName("jsp/athn/loginForLogout");
        registry.addViewController("/0702/001/login").setViewName("jsp/athn/loginForLogoutDeleteCookie");
        registry.addViewController("/0901/001/login").setViewName("jsp/athn/loginForDispAutentication");
        registry.addViewController("/1201/001/login").setViewName("jsp/athn/loginForCustomizedAuthSucessUrl");
        registry.addViewController("/1202/001/login").setViewName("jsp/athn/loginForCustomizedAuthSucessHandler");
        registry.addViewController("/1302/001/login").setViewName("jsp/athn/loginForCustomizedAuthFailure");
        registry.addViewController("/1501/001/login").setViewName("jsp/athn/loginForCustomizedLogout");
        registry.addViewController("/1601/001/login").setViewName("jsp/athn/loginForAutenticationSystemError");
        registry.addViewController("/1602/001/login").setViewName("jsp/athn/loginForAutenticationSystemErrorfailureUrl");
        registry.addViewController("/1801/002/login").setViewName("jsp/athn/loginForUsingCustomPbkdf2Password");
        registry.addViewController("/loginForRememberMe").setViewName("jsp/athn/loginForRememberMe");
        registry.addViewController("/2301/001/login").setViewName("jsp/athn/loginForLogoutSuccessEventHandle");

        registry.addViewController("/jsp/badCredentials").setViewName("jsp/athn/badCredentials");
        registry.addViewController("/jsp/usernameNotFound").setViewName("jsp/athn/usernameNotFound");
