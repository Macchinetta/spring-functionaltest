...
public class SpringSecurityAthn13Config {
    ...
    public ExceptionMappingAuthenticationFailureHandler jspAuthenticationFailureHandler() {
        ...
        mappings.put("org.springframework.security.authentication.BadCredentialsException", "/jsp/badCredentials");
        mappings.put("org.springframework.security.core.userdetails.UsernameNotFoundException", "/jsp/usernameNotFound");
        mappings.put("org.springframework.security.authentication.DisabledException", "/jsp/disabled");
    ...
    public ExceptionMappingAuthenticationFailureHandler thymeleafAuthenticationFailureHandler() {
        ...
        Properties mappings = new Properties();
        mappings.put("org.springframework.security.authentication.BadCredentialsException", "/thymeleaf/badCredentials");
        mappings.put("org.springframework.security.core.userdetails.UsernameNotFoundException", "/thymeleaf/usernameNotFound");
        mappings.put("org.springframework.security.authentication.DisabledException", "/thymeleaf/disabled");
        bean.setExceptionMappings(mappings);
        return bean;
    }
     ...
     * @param authFailureEventHandleAuthenticationProvider Bean defined by #authFailureEventHandleAuthenticationProvider
     ...
     * @param authEventHandleUserDetailsService Bean defined by SpringSecurityAthnConfig#authEventHandleUserDetailsService
     ...
     * @param authFailureEventHandleUserLoginManager Bean defined by #authFailureEventHandleUserLoginManager
    ...
    public SecurityFilterChain filterChainJsp1302(HttpSecurity http,
            @Qualifier("authFailureEventHandleUserLoginManager") AuthenticationManager authFailureEventHandleUserLoginManager) throws Exception {

        http.securityMatcher(new AntPathRequestMatcher("/jsp/1302/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/1302/001/logout")
                .logoutSuccessUrl("/athn"));
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/jsp/1302/001/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/jsp/1302/001/logout/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/jsp/1302/**")).authenticated()
    ...
    public SecurityFilterChain filterChainThymeleaf1302(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/1302/**"));
        http.authenticationManager(authFailureEventHandleUserLoginManager);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/1302/001/logout")
                .logoutSuccessUrl("/athn"));
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/1302/001/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/1302/001/logout/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/1302/**")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/**")).permitAll());
