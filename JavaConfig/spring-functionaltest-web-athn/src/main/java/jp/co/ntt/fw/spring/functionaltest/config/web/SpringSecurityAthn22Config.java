...
public class SpringSecurityAthn22Config {
     ...
     * @param loginForRememberMeUserInfoAuthenticationProvider Bean defined by #loginForRememberMeUserInfoAuthenticationProvider
    ...
    public AuthenticationManager loginForRememberMeUserInfoManager(
        ...
        return new ProviderManager(loginForRememberMeUserInfoAuthenticationProvider, rememberMeAuthenticationProvider());
    }

    /**
     * Configure {@link AuthenticationProvider} bean.
     * @param loginForRememberMeUserInfoDetailsService Bean defined by #loginForRememberMeUserInfoDetailsService
    ...
    public TokenBasedRememberMeServices rememberMeServices(
            @Qualifier("loginForRememberMeUserInfoDetailsService") UserDetailsService loginForRememberMeUserInfoDetailsService) {
        return new TokenBasedRememberMeServices("spring-test-km/ylnHv", loginForRememberMeUserInfoDetailsService);
    }
    ...
    public SecurityFilterChain filterChainJsp2201(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/jsp/2201/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/2201/logout")
                .logoutSuccessUrl("/")
    ...
    public SecurityFilterChain filterChainThymeleaf2201(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/2201/**"));
        http.authenticationManager(loginForRememberMeUserInfoManager);
        ...
        http.sessionManagement(sessionManagement -> sessionManagement
                .sessionAuthenticationStrategy(sessionAuthenticationStrategy));
        http.logout(logout -> logout.logoutUrl("/thymeleaf/2201/logout")
                .logoutSuccessUrl("/")
                .invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.authorizeHttpRequests(authz -> authz
