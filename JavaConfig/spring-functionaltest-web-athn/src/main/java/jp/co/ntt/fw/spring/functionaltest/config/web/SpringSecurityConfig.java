...
@Configuration
@EnableWebSecurity
@Import({ SpringSecurityAthnConfig.class, SpringSecurityAthn01Config.class,
        SpringSecurityAthn02Config.class, SpringSecurityAthn03Config.class,
        SpringSecurityAthn04Config.class, SpringSecurityAthn05Config.class,
        SpringSecurityAthn06Config.class, SpringSecurityAthn07Config.class,
        SpringSecurityAthn09Config.class, SpringSecurityAthn12Config.class,
        SpringSecurityAthn13Config.class, SpringSecurityAthn15Config.class,
        SpringSecurityAthn16Config.class, SpringSecurityAthn17Config.class,
        SpringSecurityAthn18Config.class, SpringSecurityAthn19Config.class,
        SpringSecurityAthn22Config.class, SpringSecurityAthn23Config.class })
