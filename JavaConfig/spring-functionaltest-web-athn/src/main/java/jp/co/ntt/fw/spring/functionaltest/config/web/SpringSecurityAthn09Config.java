...
public class SpringSecurityAthn09Config {
    ...
    public SecurityFilterChain filterChainJsp0901(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/jsp/0901/**"));
        ...
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/jsp/0901/001/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0901/001/logout/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0901/**")).authenticated()
    ...
    public SecurityFilterChain filterChainThymeleaf0901(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/0901/**"));
        http.authenticationManager(dbUserLoginManager);
        ...
        http.logout(logout -> logout.logoutUrl("/thymeleaf/0901/001/logout")
                .logoutSuccessUrl("/"));
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0901/001/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0901/001/logout/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0901/**")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/**")).permitAll());
