...
public class SpringSecurityAthn19Config {
    ...
    public MessageDigestPasswordEncoder athnPasswordEncoderMessageDigest() {
        MessageDigestPasswordEncoder bean = new MessageDigestPasswordEncoder(messagedigestAlgorithm);
     ...
     * @param loginWithMessageDigestPasswordService Bean defined by #loginWithMessageDigestPasswordService
    ...
    public AuthenticationProvider loginWithMessageDigestDelegatingPasswordAuthenticationProvider(
        ...
        authProvider.setPasswordEncoder(
                athnPasswordEncoderMessageDigestDelegating());
        return authProvider;
    }
     ...
     * @param sessionAuthenticationStrategy Bean defined by SpringSecurityAthn17Config#sessionAuthenticationStrategy
    ...
    public SecurityFilterChain filterChainJsp1901002(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/jsp/1901/002/**"));
        ...
        http.logout(logout -> logout.logoutUrl("/jsp/1901/002/logout")
                .logoutSuccessUrl("/")
     ...
     * Configure {@link SecurityFilterChain} bean.
     * @param http Builder class for setting up authentication and authorization
     * @param loginWithMessageDigestDelegatingPassword Bean defined by #loginWithMessageDigestDelegatingPassword
     * @param sessionAuthenticationStrategy Bean defined by SpringSecurityAthn17Config#sessionAuthenticationStrategy
     * @return Bean of configured {@link SecurityFilterChain}
     * @throws Exception Exception that occurs when setting HttpSecurity
     */
    ...
    public SecurityFilterChain filterChainJsp1901004(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/jsp/1901/004/**"));
        ...
        http.sessionManagement(sessionManagement -> sessionManagement
                .sessionAuthenticationStrategy(sessionAuthenticationStrategy));
        http.logout(logout -> logout.logoutUrl("/jsp/1901/004/logout")
                .logoutSuccessUrl("/")
                .invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.authorizeHttpRequests(authz -> authz
    ...
    public SecurityFilterChain filterChainThymeleaf1901002(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/1901/002/**"));
        http.authenticationManager(loginWithMessageDigestPassword);
        ...
        http.sessionManagement(sessionManagement -> sessionManagement
                .sessionAuthenticationStrategy(sessionAuthenticationStrategy));
        http.logout(logout -> logout.logoutUrl("/thymeleaf/1901/002/logout")
                .logoutSuccessUrl("/")
                .invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.authorizeHttpRequests(authz -> authz
    ...
    public SecurityFilterChain filterChainThymeleaf1901004(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/1901/004/**"));
        http.authenticationManager(loginWithMessageDigestDelegatingPassword);
        ...
        http.sessionManagement(sessionManagement -> sessionManagement
                .sessionAuthenticationStrategy(sessionAuthenticationStrategy));
        http.logout(logout -> logout.logoutUrl("/thymeleaf/1901/004/logout")
                .logoutSuccessUrl("/")
                .invalidateHttpSession(true)
                .deleteCookies("JSESSIONID"));
        http.authorizeHttpRequests(authz -> authz
