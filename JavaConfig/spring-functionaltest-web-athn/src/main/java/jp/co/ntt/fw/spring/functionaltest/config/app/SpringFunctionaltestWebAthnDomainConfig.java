...
@Import({ SpringFunctionaltestWebAthnInfraConfig.class,
        SpringFunctionaltestWebAthnCodelistConfig.class })
public class SpringFunctionaltestWebAthnDomainConfig {
