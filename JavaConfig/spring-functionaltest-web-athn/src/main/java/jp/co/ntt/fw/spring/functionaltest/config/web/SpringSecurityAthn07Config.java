...
public class SpringSecurityAthn07Config {
    ...
    public SecurityFilterChain filterChainJsp0701001(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/jsp/0701/001/**"));
        ...
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/jsp/0701/001/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0701/**")).authenticated()
    ...
    public SecurityFilterChain filterChainJsp0702001(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/jsp/0702/001/**"));
        http.authenticationManager(userLoginManagerForAthn);
        ...
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/jsp/0702/001/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/jsp/0702/**")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf0701001(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/0701/001/**"));
        http.authenticationManager(userLoginManagerForAthn);
        ...
        http.logout(Customizer.withDefaults());
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0701/001/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0701/**")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/**")).permitAll());
    ...
    public SecurityFilterChain filterChainThymeleaf0702001(HttpSecurity http,
        ...
        http.securityMatcher(new AntPathRequestMatcher("/thymeleaf/0702/001/**"));
        http.authenticationManager(userLoginManagerForAthn);
        ...
        http.logout(logout -> logout.deleteCookies("JSESSIONID"));
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0702/001/login/**")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/thymeleaf/0702/**")).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/**")).permitAll());
