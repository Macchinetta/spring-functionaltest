 ...
 * Configure SpringMVC.
 */
@ComponentScan(basePackages = {"jp.co.ntt.fw.spring.functionaltest.app.dbsp"},
        useDefaultFilters = false,
        includeFilters = {@Filter(type = FilterType.ASSIGNABLE_TYPE,
                classes = DBSP_JSP_0303Controller.class)})
@Configuration
@EnableWebMvc
@EnableAspectJAutoProxy
public class SpringMvcThymeleafDbsp0303Config implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(final ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/uploadedTemporaryFiles/**")
                .addResourceLocations("file://" + uploadTemporaryDirectory).setCachePeriod(60 * 60);
        registry.addResourceHandler("/uploadedFiles/**")
                .addResourceLocations("file://" + uploadDirectory).setCachePeriod(60 * 60);
    }
