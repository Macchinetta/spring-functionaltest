...
public class FileDownloadView extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
        ...
        // 年月日
        PdfPCell applicationYearCell =
                new PdfPCell(new Phrase(Integer.toString(localDate.getYear()), normalFont));
        ...
        PdfPCell applicationMonthCell =
                new PdfPCell(new Phrase(Integer.toString(localDate.getMonthValue()), normalFont));
        ...
        PdfPCell applicationDayCell =
                new PdfPCell(new Phrase(Integer.toString(localDate.getDayOfMonth()), normalFont));
        ...
        int birthdateYear =
                LocalDate.parse((String) model.get("birthdate"), dateTimeFormatter).getYear();
        PdfPCell birthdateYearCell =
                new PdfPCell(new Phrase(String.valueOf(birthdateYear), normalFont));
        ...
        int birthdateMonth =
                LocalDate.parse((String) model.get("birthdate"), dateTimeFormatter).getMonthValue();
        PdfPCell birthdateMonthCell =
                new PdfPCell(new Phrase(String.valueOf(birthdateMonth), normalFont));
        ...
        int birthdateDay =
                LocalDate.parse((String) model.get("birthdate"), dateTimeFormatter).getDayOfMonth();
        PdfPCell birthdateDayCell =
                new PdfPCell(new Phrase(String.valueOf(birthdateDay), normalFont));
