...
@Import({SpringFunctionaltestWebThlyDomainConfig.class})
public class ApplicationContextConfig {
    ...
    public MessageSource messageSource() {
        ...
        bean.setBasenames("i18n/application-messages", "i18n/application-messages-thly");
        return bean;
    }
    ...
    /**
     * Configure {@link ServletContextAttributeExporter} bean.
     * @return Bean of configured {@link ServletContextAttributeExporter}
     */
    @Bean
