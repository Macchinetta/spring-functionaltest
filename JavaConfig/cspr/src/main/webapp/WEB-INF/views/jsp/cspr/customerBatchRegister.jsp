...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.cspr.customerBatchRegister" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form action="${pageContext.request.contextPath}/jsp/register" modelAttribute="customerBatchRegisterForm" method="POST" cssClass="form-horizontal" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col col-md-10">
                            ...
                            <span id="validationErrorMessage"><form:errors cssClass="errorMessage" path="multipartFile" /></span>
                        </div>
                    </div>
                    <div class="form-group">
