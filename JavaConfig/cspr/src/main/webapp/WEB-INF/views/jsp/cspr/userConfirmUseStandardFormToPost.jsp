...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.cspr.userConfirm" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h3 id="screenTitle">ユーザ登録確認画面(html標準のformタグを使用/POST)</h3>

                <form:form action="${pageContext.request.contextPath}/jsp" cssClass="form-horizontal" method="post" modelAttribute="userForm">
                    <fieldset>
                        ...
                        <div class="form-group col col-md-5">
                            <form:button name="returnToRegisterUseStandardFormToPost" class="btn btn-default">戻る</form:button>
