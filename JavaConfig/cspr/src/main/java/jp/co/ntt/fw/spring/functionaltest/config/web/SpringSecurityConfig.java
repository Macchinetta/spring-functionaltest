...
public class SpringSecurityConfig {
     ...
     * @param csrfTokenRequestAttributeHandler Bean defined by
     *        SpringSecurityCsprConfig#csrfTokenRequestAttributeHandler
    ...
    public AccessDeniedHandler accessDeniedHandler() {
        ...
        missingCsrfTokenErrorHandler
                .setErrorPage("/WEB-INF/views/jsp/common/error/missingCsrfTokenError.jsp");
        errorHandlers.put(MissingCsrfTokenException.class, missingCsrfTokenErrorHandler);

        // Default error handler
        AccessDeniedHandlerImpl defaultErrorHandler = new AccessDeniedHandlerImpl();
        defaultErrorHandler.setErrorPage("/WEB-INF/views/jsp/common/error/accessDeniedError.jsp");

        return new DelegatingAccessDeniedHandler(errorHandlers, defaultErrorHandler);
    }

    /**
     * Configure {@link AjaxSupportAccessDeniedHandlerImpl} bean. Since we are injecting a
     * MessageSource, define it as a bean.
    ...
    public AjaxSupportAccessDeniedHandlerImpl invalidCsrfTokenErrorHandler() {
        ...
        AjaxSupportAccessDeniedHandlerImpl invalidCsrfTokenErrorHandler =
                new AjaxSupportAccessDeniedHandlerImpl();
        invalidCsrfTokenErrorHandler
                .setErrorPage("/WEB-INF/views/jsp/common/error/invalidCsrfTokenError.jsp");
