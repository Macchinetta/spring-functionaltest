...
public class JmsAmqReceivingServiceImpl implements JmsAmqReceivingService {
    private static final Logger logger = LoggerFactory.getLogger(JmsAmqReceivingServiceImpl.class);
    ...
    public void receiveMessageByAmq(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0101001] {}", jmsTodo.toString());
    ...
    public void receiveMessageByJndiCon(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0102001] {}", jmsTodo.toString());
    ...
    public void receiveMessageByCacheCon(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0103001] {}", jmsTodo.toString());
    ...
    @Override
    public void receiveMessageByJmsMessage(jakarta.jms.TextMessage message)
            throws IOException, JMSException {

        logger.debug("Received Message![TestQueue0301001] {}", message.toString());

        HashMap<String, String> map = new HashMap<String, String>();
        map.put(JmsProperty.UUID_KEY.name(), message.getText());
        jmsSharedService.writeMapToFile(temporaryDirectory, message.getText(), map);
        // 受信完了を待っているスレッドの待機を解除するためにイベントを通知する
        eventPublisher.publishEvent(new ReceivedEvent<String>(this, message.getText()));
    }

    @Override
    public void receiveMessageAddKey(Message<JmsTodo> jmsTodoMessage) throws IOException {

        logger.debug("Received Message![TestQueue0301003] {}", jmsTodoMessage.toString());

        HashMap<String, String> map = new HashMap<String, String>();
        map.put(JmsProperty.HEADER_KEY1.name(),
                (String) jmsTodoMessage.getHeaders().get(JmsProperty.HEADER_KEY1.name()));
        map.put(JmsProperty.UUID_KEY.name(), jmsTodoMessage.getPayload().getJmsTodoId());

        jmsSharedService.writeMapToFile(temporaryDirectory,
                jmsTodoMessage.getPayload().getJmsTodoId(), map);
        // 受信完了を待っているスレッドの待機を解除するためにイベントを通知する
        eventPublisher.publishEvent(
                new ReceivedEvent<String>(this, jmsTodoMessage.getPayload().getJmsTodoId()));
    ...
    public void receiveMessageForTopic1(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestTopic0301004-1] {}", jmsTodo.toString());

        jmsSharedService.writeObjectToFile(temporaryDirectory, jmsTodo.getJmsTodoId() + "topic1",
                jmsTodo);
    ...
    public void receiveMessageForTopic2(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestTopic0301004-2] {}", jmsTodo.toString());

        jmsSharedService.writeObjectToFile(temporaryDirectory, jmsTodo.getJmsTodoId() + "topic2",
                jmsTodo);
        awaitReceivedForTopic();
        // Topic1, Topic2両方で受信完了してから、待っているスレッドの待機を解除するためにイベントを通知する
        eventPublisher.publishEvent(new ReceivedEvent<JmsTodo>(this, jmsTodo));
    ...
    public void receiveMessageStream(InputStream inputStream) throws IOException, JMSException {
        ...
        List<String> list = jmsSharedService.readFileToList(temporaryDirectory + "output_tmp");
        ...
        jmsSharedService.deleteFile(temporaryDirectory + "input_" + list.get(0));
        // 受信完了を待っているスレッドの待機を解除するためにイベントを通知する
        eventPublisher.publishEvent(new ReceivedEvent<String>(this, list.get(0)));

    }

    @Override
    public void receiveMessageMany(jakarta.jms.TextMessage message)
        ...
        jmsSharedService.writeListToAddFile(temporaryDirectory, message.getText(), list);
        // 受信完了を待っているスレッドの待機を解除するためにイベントを通知する
        eventPublisher.publishEvent(new ReceivedEvent<String>(this, message.getText()));
    ...
    @Override
    public void receiveMessageByCallback(jakarta.jms.TextMessage message)
            throws IOException, JMSException {
        ...
        HashMap<String, String> map = new HashMap<String, String>();
        map.put(JmsProperty.UUID_KEY.name(), message.getText());
        map.put(JmsProperty.PRIORITY.name(), String.valueOf(message.getJMSPriority()));
        map.put(JmsProperty.DELIVERY_MODE.name(), String.valueOf(message.getJMSDeliveryMode()));
    ...
    public void receiveMessageBySelectorFalse(JmsTodo jmsTodo) throws IOException, JMSException {
        ...
        jmsSharedService.writeMapToFile(temporaryDirectory, jmsTodo.getJmsTodoId(), map);
    ...
    @Override
    public void receiveMessageReSendAnotherMessageB(Message<JmsTodo> jmsTodoMessage)
            throws IOException {

        logger.debug("Received Message>![TestQueue0403003] {}", jmsTodoMessage.toString());
    ...
    public void receiveMessageConcurrentListenerSingle(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0404001] {}", jmsTodo.toString());
    ...
    public void receiveMessageConcurrentListenerMultiple(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0404002] {}", jmsTodo.toString());
    ...
    @Override
    public void receiveMessageWithHeaderOK(JmsTodo jmsTodo, Integer priority, Integer deliveryMode,
        ...
        Integer deliveryModeInHeaders = (Integer) headers.get(JmsHeaders.DELIVERY_MODE);
        if (Objects.equals(priorityInHeaders, priority)
                && Objects.equals(deliveryModeInHeaders, deliveryMode)) {
            if (jmsTodo != null) {
                if (Objects.equals(priority, this.priority)
                        && Objects.equals(deliveryMode, this.deliveryMode)) {
                    // 一時ファイルへ出力
                    jmsSharedService.writeObjectToFile(temporaryDirectory, jmsTodo.getJmsTodoId(),
                            jmsTodo);
                } else {
                    logger.debug(
    ...
    public void receiveMessageValidationOK(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0701001] {}", jmsTodo.toString());
    ...
    public void receiveMessageValidationNG(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0701002] {}", jmsTodo.toString());
    ...
    public void receiveMessageInputValidationOK(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0701003] {}", jmsTodo.toString());

        jmsValidationService.writeValidatedObjectToFile(temporaryDirectory, jmsTodo.getJmsTodoId(),
                jmsTodo);
        // 受信完了を待っているスレッドの待機を解除するためにイベントを通知する
        eventPublisher.publishEvent(new ReceivedEvent<JmsTodo>(this, jmsTodo));
    }
    ...
    @Override
    public void receiveMessageInputValidationWithViolationErrMsg(JmsTodo jmsTodo)
            throws IOException {
    ...
    @Override
    public void receiveInputValidationIsolatedTransactionJmsAndDbCommitWriteFile(JmsTodo jmsTodo)
            throws IOException {
    ...
    private void writeObjectToFile(String queueSuffix, JmsTodo jmsTodo) throws IOException {
        logger.debug("Received Message![TestQueue{}] {}", queueSuffix, jmsTodo.toString());
    ...
    public void receiveMessageCatchBusinessErr(JmsTodo jmsTodo) {
        ...
        logger.debug("Received Message![TestQueue0803001] {}", jmsTodo.toString());

        throw new BusinessException(ResultMessages.error().add("e.sf.js.8004"));
    }

    @Override
    public void receiveMessageCatchBusinessErrSetQueueA(JmsTodo jmsTodo) {

        logger.debug("Received Message![TestQueue0803002A]" + jmsTodo.toString());
    ...
    public void receiveMessageCatchBusinessErrSetQueueB(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0803002] {}", jmsTodo.toString());
    ...
    @Override
    public boolean receiveMessage_TxSndOK(String id)
            throws IOException, JMSException, InterruptedException {
        ...
        List<jakarta.jms.Message> msgs = jmsSharedService
                .getMessagesSelected(jndiConCacheJmsTemplate, distinationName, messageSelector);
        ...
        // メッセージ受信
        JmsTodo jmsTodo = jndiConCacheJmsMessagingTemplate.receiveAndConvert("TestQueue0601001",
                JmsTodo.class);
    ...
    public boolean receiveMessage_TxSndNG(String id) throws IOException, JMSException {
        ...
        // メッセージ受信
        JmsTodo jmsTodo = jndiConCacheJmsMessagingTemplate.receiveAndConvert("TestQueue0601002",
                JmsTodo.class);
    ...
    public void receiveMessage_TxAsyncOK(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0603001] {}", jmsTodo.toString());

        if (!jmsSharedService.existsFile(temporaryDirectory + jmsTodo.getJmsTodoId())) {
            jmsSharedService.writeObjectToFile(temporaryDirectory, jmsTodo.getJmsTodoId(), jmsTodo);
            // 受信完了を待っているスレッドの待機を解除するためにイベントを通知する
            eventPublisher.publishEvent(new ReceivedEvent<JmsTodo>(this, jmsTodo));
        } else {
    ...
    public void receiveMessage_TxAsyncNG(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0603002] {}", jmsTodo.toString());

        if (!jmsSharedService.existsFile(temporaryDirectory + jmsTodo.getJmsTodoId())) {
            jmsSharedService.writeObjectToFile(temporaryDirectory, jmsTodo.getJmsTodoId(), jmsTodo);

            throw new BusinessException(ResultMessages.error().add("e.sf.js.8002"));
        } else {
            // ロールバック時に実行される。
            jmsSharedService.deleteFile(temporaryDirectory + jmsTodo.getJmsTodoId());
    ...
    public void receiveMessage_sendTxBestEffort1PhaseOK(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0604001] {}", jmsTodo.toString());
    ...
    public void receiveMessage_sendTxBestEffort1PhaseNG(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0604002] {}", jmsTodo.toString());
    ...
    public void receiveMessage_receTxBestEffort1PhaseOK(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0604005] {}", jmsTodo.toString());
    ...
    public void receiveMessage_receTxBestEffort1PhaseNG(JmsTodo jmsTodo) throws IOException {
        ...
        logger.debug("Received Message![TestQueue0604006] {}", jmsTodo.toString());
    ...
    public int getMessageCount(String destinationName, String messageSelector) throws JMSException {
        return jmsSharedService
                .getMessagesSelected(jndiConCacheJmsTemplate, destinationName, messageSelector)
                .size();
    }
