...
@Import({ SpringFunctionaltestWebFldwInfraConfig.class,
        SpringFunctionaltestWebFldwCodelistConfig.class })
public class SpringFunctionaltestWebFldwDomainConfig {
