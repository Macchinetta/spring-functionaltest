...
public class Authorization_Thymeleaf_Test extends FunctionTestSupport {
    ...
    /**
     * <ul>
     * <li>認可の設定のtaglibが正常に機能することを確認する。(thymeleaf要素)</li>
     * </ul>
     */
    @Test
    ...
    /**
     * <ul>
     * <li>Thymeleafにおいて認可判定の結果を変数に格納し、使用することができることを確認する。</li>
     * </ul>
     */
    @Test
    ...
    public void testATHR0901003() throws IOException {
        ...
        // 入力条件設定
        webDriverOperations.overrideText(id("device"), "eth6T");
        ...
        // 入力条件設定
        webDriverOperations.overrideText(id("device"), "eth7T");
        ...
        // 入力条件設定
        webDriverOperations.overrideText(id("device"), "eth8T");
