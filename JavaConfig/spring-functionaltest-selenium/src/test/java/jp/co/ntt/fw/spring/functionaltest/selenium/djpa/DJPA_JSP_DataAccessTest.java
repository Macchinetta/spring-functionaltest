...
import jp.co.ntt.fw.spring.functionaltest.selenium.djpa.pages.JPA_JSP_IndexPage;
...
public class DJPA_JSP_DataAccessTest extends FunctionTestSupport {

    private static WebDriver driver;

    public DJPA_JSP_DataAccessTest() {
    ...
    public void testDJPA0102002() {
        ...
        jpaIndexPage = new JPA_JSP_IndexPage(driver);
