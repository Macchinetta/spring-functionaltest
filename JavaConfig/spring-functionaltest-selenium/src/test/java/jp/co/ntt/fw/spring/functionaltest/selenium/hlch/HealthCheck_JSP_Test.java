...
public class HealthCheck_JSP_Test extends FunctionTestSupport {
    ...
    public void testHLCH0101001() throws IOException {
        String url = getPackageRootUrl() + "/" + VIEW_TYPE + "/0101/001";
    ...
    public void testHLCH0101002() throws IOException {
        String url = getPackageRootUrl() + "/" + VIEW_TYPE + "/0101/002";
        HttpGet request = new HttpGet(url);
        try (CloseableHttpClient client = HttpClientBuilder.create().build()) {
            HttpResponse response = client.execute(request);
    ...
    public void testHLCH0201001() throws IOException, InterruptedException {
        String url = getPackageRootUrl() + "/" + VIEW_TYPE + "/0201/001";
        HttpGet request = new HttpGet(url);
        String xTrack = null;
        try (CloseableHttpClient client = HttpClientBuilder.create().build()) {
            HttpResponse response = client.execute(request);
