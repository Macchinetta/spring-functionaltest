...
public class OAuth2_03_JSP_Test extends FunctionTestSupport {
    ...
    public void testOTH20301001() {
        // TODOアプリ - 例外処理
        webDriverOperations.click(By.id("errorHandler_" + VIEW_TYPE));

        // 認可コードグラント画面
        webDriverOperations.waitForDisplayed(textToBe(By.id("screenTitle"), "例外処理"));

        // トークンエンドポイント不正
        webDriverOperations.click(By.id("wrongTokenEndpoint_" + VIEW_TYPE));
    ...
    public void testOTH20301002() {
        ...
        // 認可エンドポイント不正
        webDriverOperations.click(By.id("wrongAuthEndpoint_" + VIEW_TYPE));
    ...
    public void testOTH20301003() {
        ...
        // JWTエンドポイント不正
        webDriverOperations.click(By.id("wrongJWTEndpoint_" + VIEW_TYPE));
    ...
    public void testOTH20302001() {
        ...
        // リクエスト送信時に遅延発生
        webDriverOperations.click(By.id("waitRequest_" + VIEW_TYPE));
        ...
        // ログアサート
        dbLogAssertOperations.waitForAssertion(180_000L);
    ...
    public void testOTH20303001() {
        ...
        // リクエスト送信時に遅延発生
        webDriverOperations.click(By.id("notThroughAnAuthorizedServer_" + VIEW_TYPE));
