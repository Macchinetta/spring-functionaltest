...
public class MSMN_Thymeleaf_Test extends FunctionTestSupport {
    ...
    public void testMSMN0102001() {
        ...
        String year = webDriverOperations.getText(By.xpath("//form/label[1]"));
        String month = webDriverOperations.getText(By.xpath("//form/label[2]"));
        String day = webDriverOperations.getText(By.xpath("//form/label[3]"));
     ...
     * </ul>
     */
    @Ignore("Thymeleaf Dialectを提供するようになったら試験を実施すること。")
    @Test
