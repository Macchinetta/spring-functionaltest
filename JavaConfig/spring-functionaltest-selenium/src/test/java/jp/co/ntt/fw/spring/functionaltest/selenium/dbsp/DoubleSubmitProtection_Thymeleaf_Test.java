...
public class DoubleSubmitProtection_Thymeleaf_Test extends FunctionTestSupport {

    private static final Logger logger =
            LoggerFactory.getLogger(DoubleSubmitProtection_Thymeleaf_Test.class);
    ...
    public void testDBSP0301006() throws IOException {
        ...
        /** 生成されたTokenValue */
        String tokenValue = null;
        String[] buttonNames = {"dbsp0301006_" + VIEW_TYPE, "second", "third", "fourth", "fifth"};
        String[] screenTitles = {"firstView", "secondView", "thirdView", "fourthView", "fifthView"};
        for (int i = 0; i < 5; i++) {
            if (i >= 2) {
                // 第二画面から第四画面ではトランザクショントークンを確認する。
