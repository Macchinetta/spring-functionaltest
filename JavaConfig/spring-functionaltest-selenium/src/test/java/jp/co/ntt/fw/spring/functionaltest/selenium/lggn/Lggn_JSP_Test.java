...
public class Lggn_JSP_Test extends FunctionTestSupport {

    private static String VIEW_TYPE = "jsp";

    private static WebDriver driver;

    public Lggn_JSP_Test() {
    ...
    public void testLGGN0401001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("lggn0401001_" + VIEW_TYPE));
        }
        ...
        // ログの確認
        {
            ...
            dbLogAssertOperations.assertContainsByRegexMessage(
                    ...
                    "^jp.co.ntt.fw.spring.functionaltest.app.lggn.LGGN_JSP_0401Controller$",
                    "^debug log$");
            dbLogAssertOperations.assertContainsByRegexMessage(
                    webDriverOperations.getXTrack(),
                    "^jp.co.ntt.fw.spring.functionaltest.app.lggn.LGGN_JSP_0401Controller$",
    ...
    public void testLGGN0401002() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("lggn0401002_" + VIEW_TYPE));
        }
    ...
    public void testLGGN0401003() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("lggn0401003_" + VIEW_TYPE));
        }
    ...
    public void testLGGN0401004() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("lggn0401004_" + VIEW_TYPE));
        }
    ...
    public void testLGGN0401005() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("lggn0401005_" + VIEW_TYPE));
        }
    ...
    /**
     * <ul>
     * <li>「[i.ab.cd.1002] UNDEFINED-MESSAGE"と出力されること」を確認する。</li>
     * </ul>
     */
    @Test
    public void testLGGN0401006() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("lggn0401006_" + VIEW_TYPE));
        }
    ...
    public void testLGGN0401007() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("lggn0401007_" + VIEW_TYPE));
        }
    ...
    public void testLGGN0401008() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("lggn0401008_" + VIEW_TYPE));
        }
    ...
    public void testLGGN0401009() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("lggn0401009_" + VIEW_TYPE));
        }
    ...
    public void testLGGN0402001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("lggn0402001_" + VIEW_TYPE));
        }
        ...
        // ログの確認
        {
            ...
            dbLogAssertOperations.assertContainsByRegexMessage(
                    ...
                    "^\\[e.ab.cd.5001\\], SystemException occurred!$");
        }
    ...
    public void testLGGN0402002() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("lggn0402002_" + VIEW_TYPE));
        }
