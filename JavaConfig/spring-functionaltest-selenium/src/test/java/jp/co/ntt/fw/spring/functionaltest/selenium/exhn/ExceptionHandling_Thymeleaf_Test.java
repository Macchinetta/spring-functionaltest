...
public class ExceptionHandling_Thymeleaf_Test extends FunctionTestSupport {
    ...
    private String functionsUrl = applicationContextUrl;

    @Before
    public void before() {
        functionsUrl = applicationContextUrl + "-exhn";
    }

    @After
    public void deleteTempDirectoryAndFiles() {
        restOperations.getForEntity(functionsUrl + "/delete/all", void.class);
    }
    ...
    public void testEXHN0202001() throws IOException {
        ...
        restOperations.getForEntity(functionsUrl + "/delete?temporaryFileName="
                + temporaryFileName, String.class);
    ...
    public void testEXHN0203001() throws IOException, InterruptedException {
        ...
        restOperations.getForEntity(functionsUrl
                + "/copy/temporaryFile?temporaryFileName=" + temporaryFileName,
                void.class);
    ...
    public void testEXHN0601001() throws IOException {
        ...
        try {
            restOperations.getForEntity(functionsUrl + "/" + VIEW_TYPE
                    + "/0601/register?uploadTemporaryFileId="
                    + temporaryFileName
    ...
    public void testEXHN0601002() throws IOException {
        ...
        try {
            restOperations.getForEntity(functionsUrl + "/" + VIEW_TYPE
                    + "/0601/002/register?uploadTemporaryFileId="
                    + temporaryFileName
                    + "&title=test&fileName=exhn.html&upload", String.class);
        } catch (HttpServerErrorException e) {
            // ヘッダに設定された値の整合性確認
    ...
    public void testEXHN0701001() throws IOException {
        try {
            restOperations.headForHeaders(functionsUrl + "/" + VIEW_TYPE
                    + "/0701/001");
    ...
    public void testEXHN0701016() throws IOException {
        try {
            ResponseEntity<String> res = restOperations.getForEntity(
                    functionsUrl + "/" + VIEW_TYPE + "/0701/016", String.class);
