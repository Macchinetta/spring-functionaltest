...
@Controller
@RequestMapping("jsp")
public class DTAC_JSP_01Controller {
    ...
    public String handle0102002() {
        return "redirect:/jsp/select";
    }

    @GetMapping(value = "0102/select/dataSourceOpen")
    public String selectDataSourceA() {
        return "redirect:/jsp/user/listOpen";
    }

    @GetMapping(value = "0102/select/dataSourceClose")
    public String selectDataSourceB() {
        return "redirect:/jsp/user/listClose";
    }
}
