...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain filterChainJsp(HttpSecurity http,
        ...
        http.formLogin(
                login -> login.loginPage("/jsp/login").defaultSuccessUrl("/jsp/login?loginSuccess")
                        .loginProcessingUrl("/jsp/authenticate"));
        http.sessionManagement(sessionManagement -> sessionManagement
                .sessionAuthenticationStrategy(sessionAuthenticationStrategy()));
        http.logout(logout -> logout.logoutUrl("/jsp/logout").logoutSuccessUrl("/jsp/login")
    ...
    public AuthenticationProvider authenticationProvider(UserDetailsService userDetailsServiceDTAC,
