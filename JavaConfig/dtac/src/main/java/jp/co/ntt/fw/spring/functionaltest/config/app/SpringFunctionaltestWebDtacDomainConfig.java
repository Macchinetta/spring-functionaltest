...
public class SpringFunctionaltestWebDtacDomainConfig {
     ...
     * @param routingDataSource DataSource defined by
     *        SpringFunctionaltestDtacWebInfraConfig#routingDataSource()
     * @param databaseIdProvider Bean defined by
     *        SpringFunctionaltestDtacWebInfraConfig#databaseIdProvider()
    ...
    public UserListRoutingRepository userListRoutingRepository(
        ...
        factory.setTypeAliasesPackage("jp.co.ntt.fw.spring.functionaltest.domain.model");
