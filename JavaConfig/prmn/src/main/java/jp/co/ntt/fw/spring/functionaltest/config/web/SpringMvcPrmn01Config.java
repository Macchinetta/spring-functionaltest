...
import jp.co.ntt.fw.spring.functionaltest.app.prmn.PRMN_JSP_01Controller;
...
@EnableWebMvc
@Configuration
public class SpringMvcPrmn01Config implements WebMvcConfigurer {
     ...
     */
    @Bean
    public static PropertySourcesPlaceholderConfigurer propertySourcesPlaceholderConfigurerOrder5(
     ...
     */
    @Bean
    public static PropertySourcesPlaceholderConfigurer propertySourcesPlaceholderConfigurerOrder4(
            @Value("classpath*:/META-INF/spring/prmn/*.properties") Resource... properties) {
        PropertySourcesPlaceholderConfigurer bean = new PropertySourcesPlaceholderConfigurer();
        bean.setLocations(properties);
        bean.setOrder(4);
        bean.setIgnoreUnresolvablePlaceholders(true);
     ...
     */
    @Bean
    public static PropertySourcesPlaceholderConfigurer propertySourcesPlaceholderConfigurerOrder2(
            @Value("classpath*:/META-INF/property/prmn01multiorder1.properties") Resource... properties) {
        PropertySourcesPlaceholderConfigurer bean = new PropertySourcesPlaceholderConfigurer();
        bean.setLocations(properties);
        bean.setOrder(2);
        bean.setIgnoreUnresolvablePlaceholders(true);
    ...
    public static PropertySourcesPlaceholderConfigurer propertySourcesPlaceholderConfigurerOrder1(
            @Value("classpath*:/META-INF/property/prmn01multiorder2.properties") Resource... properties) {
        PropertySourcesPlaceholderConfigurer bean = new PropertySourcesPlaceholderConfigurer();
        bean.setLocations(properties);
        bean.setOrder(1);
        bean.setIgnoreUnresolvablePlaceholders(true);
     ...
     */
    @Bean
    public static PropertySourcesPlaceholderConfigurer propertySourcesPlaceholderConfigurerOrder3(
            @Value("classpath*:/META-INF/property/prmn01multiorder3.properties") Resource... properties) {
        PropertySourcesPlaceholderConfigurer bean = new PropertySourcesPlaceholderConfigurer();
        bean.setLocations(properties);
        bean.setOrder(3);
        bean.setIgnoreUnresolvablePlaceholders(true);
    ...
    /**
     * Configure {@link PRMN_JSP_01Controller} bean.
     * @return Bean of configured {@link PRMN_JSP_01Controller}
     */
    @Bean
    public PRMN_JSP_01Controller pRMN_JSP_01Controller() {
        return new PRMN_JSP_01Controller();
    }
