...
import jp.co.ntt.fw.spring.functionaltest.app.prmn.EncryptedPropertySourcesPlaceholderConfigurer;
import jp.co.ntt.fw.spring.functionaltest.app.prmn.PRMN_JSP_04Controller;
import jp.co.ntt.fw.spring.functionaltest.app.prmn.Prmn04Defines;
...
@EnableWebMvc
@Configuration
public class SpringMvcPrmn04Config implements WebMvcConfigurer {

    /**
     * Configure {@link EncryptedPropertySourcesPlaceholderConfigurer} bean.
     * @return Bean of configured {@link EncryptedPropertySourcesPlaceholderConfigurer}
     */
    @Bean
    public EncryptedPropertySourcesPlaceholderConfigurer encryptedPropertySourcesPlaceholderConfigurer() {
        EncryptedPropertySourcesPlaceholderConfigurer bean =
                new EncryptedPropertySourcesPlaceholderConfigurer();
        Resource resource = new ClassPathResource("/META-INF/spring/prmn04multi.properties");
    ...
    /**
     * Configure {@link PRMN_JSP_04Controller} bean.
     * @return Bean of configured {@link PRMN_JSP_04Controller}
     */
    @Bean
    public PRMN_JSP_04Controller pRMN_JSP_04Controller() {
        return new PRMN_JSP_04Controller();
    }

    /**
     * Configure {@link Prmn04Defines} bean.
     * @return Bean of configured {@link Prmn04Defines}
     */
    @Bean
    public Prmn04Defines prmn04Defines() {
        return new Prmn04Defines();
    }
}
