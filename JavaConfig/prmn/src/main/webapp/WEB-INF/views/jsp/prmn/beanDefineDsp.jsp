...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.prmn.beanDefineDsp" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h1 id="screenTitle">bean定義ファイルのプロパティの表示</h1>

                <fieldset>
                    <table class="table table-bordered table-condensed col-xs-5 col-sm-5 col-md-5 col-g-5">
                        <tr>
                            <th class="col col-xs-2 col-sm-2 col-md-2 col-g-2">propertyValue0101</th>
                            <td class="col col-xs-3 col-sm-3 col-md-3 col-g-3"><span id="propertyValue0101"> ${f:h(prmn0201BeanDefine.propertyValue0101)} </span></td>
                        </tr>
                    </table>
                </fieldset>
            </div>
