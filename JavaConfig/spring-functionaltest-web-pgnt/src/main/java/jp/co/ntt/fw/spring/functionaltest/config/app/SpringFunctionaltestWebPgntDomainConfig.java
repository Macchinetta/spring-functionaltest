...
@Import({ SpringFunctionaltestWebPgntInfraConfig.class,
        SpringFunctionaltestWebPgntCodelistConfig.class })
public class SpringFunctionaltestWebPgntDomainConfig {
