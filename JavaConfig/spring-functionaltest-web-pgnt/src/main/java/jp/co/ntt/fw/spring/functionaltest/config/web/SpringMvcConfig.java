...
@ComponentScan(basePackages = {
        "jp.co.ntt.fw.spring.functionaltest.app" }, excludeFilters = {
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = PGNT_JSP_0102001Controller.class),
                @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = PGNT_JSP_0102002Controller.class) })
@Configuration
@EnableWebMvc
