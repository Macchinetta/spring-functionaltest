...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.encr.encryptDecryptByTextEncryptor" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h1 id="screenTitle">暗復号(TextEncryptor)</h1>
                <br />
                <t:messagesPanel />
                <form:form action="${pageContext.request.contextPath}/jsp/0101/001/encryptDecryptByTextEncryptor" cssClass="form-horizontal" method="post" modelAttribute="encryptionDataForm">
                    <legend>暗復号</legend>
