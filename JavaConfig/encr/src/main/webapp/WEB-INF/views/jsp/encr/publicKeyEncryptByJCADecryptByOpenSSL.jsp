...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.encr.publicKeyEncryptByJCADecryptByOpenSSL" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h1 id="screenTitle">暗復号(OpenSSLで作成したキーペアを利用し、JCAで暗号化、OpenSSLで復号)</h1>
                <br />
                <t:messagesPanel />
                <form:form action="${pageContext.request.contextPath}/jsp/0302/001/publicKeyEncryptByJCADecryptByOpenSSL" cssClass="form-horizontal" method="post" modelAttribute="encryptionDataForm">
                    <legend>暗復号</legend>
