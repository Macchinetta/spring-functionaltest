...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.encr.encryptDecryptTextByAesWithGcm" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <br />
                <t:messagesPanel />
                <form:form action="${pageContext.request.contextPath}/jsp/0104/001/encryptDecryptTextByAesWithGcm" cssClass="form-horizontal" method="post" modelAttribute="encryptionDataForm">
                    <legend>暗復号</legend>
