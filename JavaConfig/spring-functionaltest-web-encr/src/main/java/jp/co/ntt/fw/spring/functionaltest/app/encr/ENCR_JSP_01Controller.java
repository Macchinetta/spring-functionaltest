...
@Controller
@RequestMapping("jsp")
public class ENCR_JSP_01Controller {
    ...
    public String encryptByTextEncryptor(Model model,
        ...
        model.addAttribute("decryptedText", encryptionDataService.decryptText(
                encryptedText));
        return "jsp/encr/encryptCompleteByTextEncryptor";
    }
    ...
    public String encryptByBytesEncryptor(Model model,
        ...
        return "jsp/encr/encryptCompleteByBytesEncryptor";
    }
    ...
    public String encryptTextByAesWithGcm(Model model,
        ...
        return "jsp/encr/encryptCompleteTextByAesWithGcm";
    }
    ...
    public String encryptBytesByAesWithGcm(Model model,
        ...
        return "jsp/encr/encryptCompleteBytesByAesWithGcm";
    }
