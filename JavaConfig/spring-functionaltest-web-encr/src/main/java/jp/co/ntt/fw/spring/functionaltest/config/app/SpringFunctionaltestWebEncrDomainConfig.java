...
@Import({ SpringFunctionaltestWebEncrInfraConfig.class,
        SpringFunctionaltestWebEncrCodelistConfig.class })
public class SpringFunctionaltestWebEncrDomainConfig {
