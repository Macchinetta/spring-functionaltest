...
@Import({ SpringFunctionaltestWebSydtInfraConfig.class,
        SpringFunctionaltestWebSydtCodelistConfig.class })
public class SpringFunctionaltestWebSydtDomainConfig {
