...
@Import({ SpringFunctionaltestWebSpsmInfraConfig.class,
        SpringFunctionaltestWebSpsmCodelistConfig.class })
public class SpringFunctionaltestWebSpsmDomainConfig {
