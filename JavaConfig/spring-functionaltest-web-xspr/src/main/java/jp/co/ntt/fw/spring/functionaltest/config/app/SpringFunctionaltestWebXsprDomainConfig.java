...
@Import({ SpringFunctionaltestWebXsprInfraConfig.class,
        SpringFunctionaltestWebXsprCodelistConfig.class })
public class SpringFunctionaltestWebXsprDomainConfig {
