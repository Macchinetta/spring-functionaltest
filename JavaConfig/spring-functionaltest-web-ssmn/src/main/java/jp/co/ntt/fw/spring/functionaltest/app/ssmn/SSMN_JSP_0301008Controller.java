...
@RequestMapping(value = "jsp/0301/008")
public class SSMN_JSP_0301008Controller {
    @Inject
    ...
    public String handle01008(Model model, SessionStatus sessionStatus) {
        ...
        return "redirect:/jsp/0301/008?personalForm";
    }
    ...
    public String createMemberConfirm(Model model, @Validated({ Personal.class,
        ...
        return "jsp/ssmn/createMemberConfirmUseSessionObject";
    }
    ...
    public String createMember(Model model,
        ...
        return "redirect:/jsp/0301/008?complete";
    }
