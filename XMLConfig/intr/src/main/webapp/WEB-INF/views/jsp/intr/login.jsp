...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.intr.login" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0301/001/authentication" class="form-horizontal">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0301/001/logout" class="form-horizontal">
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
