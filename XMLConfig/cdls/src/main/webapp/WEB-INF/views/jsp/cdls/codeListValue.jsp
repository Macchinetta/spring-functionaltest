...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.cdls.codeListValue" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h1 id="screenTitle">特定のコード値からコード名を表示する</h1>

                <div>CDLS0106001</div>
                <div>
                    <div id="cdls0106001_jsp">Order Status : ${f:h(CL_ORDERSTATUS[orderStatusForm.id])}</div>
                </div>
            </div>
        </div>
