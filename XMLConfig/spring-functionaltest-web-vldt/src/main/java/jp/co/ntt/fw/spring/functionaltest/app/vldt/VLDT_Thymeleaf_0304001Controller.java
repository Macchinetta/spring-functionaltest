...
@Controller
public class VLDT_Thymeleaf_0304001Controller {
    ...
    public String handle() {
        return "thymeleaf/vldt/defineNotAsciiMessageByValidationMessagesView";
    }

    @PostMapping(value = "001", params = "validate")
    public String handleValidate(
        ...
        return "redirect:/thymeleaf/0304/001";
    }
}
