...
@RequestMapping("jspDisabledcspr")
@Controller
public class CSPR_JSP_01Controller {
    ...
    public String handle0201007() {
        return "jsp/cspr/userRegisterNoCsrf";
    }
    ...
    public String confirm(@Validated UserForm form, BindingResult result) {
        ...
        return "jsp/cspr/userConfirmNoCsrf";
    }
    ...
    public String create(@Validated UserForm form, BindingResult result) {
        ...
        return "redirect:/jspDisabledcspr?complete";
    }
