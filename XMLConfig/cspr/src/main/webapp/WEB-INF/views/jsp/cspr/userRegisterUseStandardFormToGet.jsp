...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.cspr.userRegisterUseStandardFormToGet" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h3 id="screenTitle">ユーザ登録画面(html標準のformタグを使用/GET)</h3>

                <form id="userForm" action="${pageContext.request.contextPath}/jsp" class="form-horizontal" method="get">
                    <spring:nestedPath path="userForm">
                        <fieldset>
                            ...
                            <div class="form-group col col-md-5">
                                <input id="confirm" type="submit" name="confirmUseStandardFormToGet" class="btn btn-default" value="確認" />
                            </div>
                        </fieldset>
                    </spring:nestedPath>
                </form>
