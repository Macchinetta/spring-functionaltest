...
<html class="no-js">
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h3 id="screenTitle">ユーザ登録確認画面(CSRF無効)</h3>

                <form:form action="${pageContext.request.contextPath}/jspDisabledcspr" cssClass="form-horizontal" method="post" modelAttribute="userForm">
                    <fieldset>
                        ...
                        <div class="form-group col col-md-5">
                            <form:button name="returnToRegisterNoCsrf" class="btn btn-default">戻る</form:button>
