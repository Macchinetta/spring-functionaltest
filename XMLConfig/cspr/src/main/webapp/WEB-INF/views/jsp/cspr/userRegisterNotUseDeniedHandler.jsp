...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.cspr.userRegisterNotUseDeniedHandler" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h3 id="screenTitle">ユーザ登録画面(DeniedHandler未設定)</h3>

                <form:form action="${pageContext.request.contextPath}/jsp/notUseDeniedHandler" cssClass="form-horizontal" method="post" modelAttribute="userForm">
                    <fieldset>
                        <legend>ユーザ情報</legend>
                        ...
                        <div class="form-group col col-md-5">
                            <form:button name="confirmNotUseDeniedHandler" class="btn btn-default">確認</form:button>
                        </div>
                    </fieldset>
                </form:form>
            </div>
