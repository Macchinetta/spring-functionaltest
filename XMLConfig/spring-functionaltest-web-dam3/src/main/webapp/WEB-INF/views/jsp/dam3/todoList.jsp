...
<div class="row">
  ...
  <div>
    <form:form modelAttribute="todoForm"
      action="${pageContext.request.contextPath}/jsp/todo/register">
      <form:button name="form" class="btn btn-default">Add Todo</form:button>
    </form:form>
  </div>
  <div>
    <form:form modelAttribute="todoForm"
      action="${pageContext.request.contextPath}/jsp/todo/bulkReg" method="post">
  ...
  <div>
    <form:form modelAttribute="todoForm"
      action="${pageContext.request.contextPath}/jsp/todo/addByReUse" method="post">
    ...
    <c:choose>
        ...
        <c:forEach var="todoItem" items="${todoMapRes}" varStatus="rowStatus">
          <tr>
            ...
            <td class="bookId"><a id="todoLink_${todoItem.key}"
              href="${pageContext.request.contextPath}/jsp/todo/${todoItem.key}/update">
        ...
        <c:forEach var="todo" items="${page.content}" varStatus="rowStatus">
          <tr>
            ...
            <td class="bookId"><a id="todoLink_${todo.todoId}"
              href="${pageContext.request.contextPath}/jsp/todo/${todo.todoId}/update">
            ...
            <td class="categoryName" id="categoryName"><a id="todoLink_${rowStatus.count}"
              href="${pageContext.request.contextPath}/jsp/todo/${todo.todoId}/update"> Refer Details Page</a></td>
      ...
      <c:otherwise>
        <c:forEach var="todo" items="${todos}" varStatus="rowStatus">
          <tr>
            <td class="no" id="no">${rowStatus.count}</td>
            <td class="bookId"><a id="todoLink_${todo.todoId}" href="${pageContext.request.contextPath}/jsp/todo/${todo.todoId}/update">${f:h(todo.todoId)}</a></td>
            <td class="title" id="title">${f:h(todo.todoTitle)}</td>
  ...
  <div>
    <table class="table-striped table-bordered table-condensed">
      <form:form modelAttribute="todoForm"
        action="${pageContext.request.contextPath}/jsp/todo/update" method="post">
        <tr>
  ...
  <div>
    <form:form modelAttribute="todoForm"
      action="${pageContext.request.contextPath}/jsp/todo/search" method="get">
      <fieldset>
