...
public interface JmsAmqReceivingService {
    ...
    void receiveMessageByJmsMessage(jakarta.jms.TextMessage message)
    ...
    void receiveMessageMany(jakarta.jms.TextMessage message)
            throws IOException, JMSException, InterruptedException;

    void receiveMessageByCallback(jakarta.jms.TextMessage message) throws IOException, JMSException;
