...
<html>
    <head>
        <meta charset="utf-8" />
        <title>invalid CSRF Error!</title>
    ...
    <body>
        ...
        <div id="wrapper">
            <h1 id="screenTitle">invalid CSRF Error!</h1>
            <br />
            <a id="springTestTop" href="${pageContext.request.contextPath}">Spring Functional Test</a> <br />
            <br />
            <br />
            <br />
            <br />
