...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.encr.encryptDecryptByBytesEncryptor" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h1 id="screenTitle">暗復号(BytesEncryptor)</h1>
                <br />
                <t:messagesPanel />
                <form:form action="${pageContext.request.contextPath}/jsp/0103/001/encryptDecryptByBytesEncryptor" cssClass="form-horizontal" method="post" modelAttribute="encryptionDataForm">
                    <legend>暗復号</legend>
