...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.encr.generateBytesKey" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <br />
                <t:messagesPanel />
                <form:form action="${pageContext.request.contextPath}/jsp/0201/001/generateBytesKey" cssClass="form-horizontal" method="post" modelAttribute="encryptionDataForm">
