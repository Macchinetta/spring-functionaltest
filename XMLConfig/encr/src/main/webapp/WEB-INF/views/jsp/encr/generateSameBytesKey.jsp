...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.encr.generateSameBytesKey" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <br />
                <t:messagesPanel />
                <form:form action="${pageContext.request.contextPath}/jsp/0202/001/generateSameBytesKey" cssClass="form-horizontal" method="post" modelAttribute="encryptionDataForm">
                    <legend>疑似乱数(鍵)</legend>
                    <div class="form-group">
                        <form:label path="keyLength" class="col col-md-2 control-label">鍵長(バイト)</form:label>
                        <div class="col col-md-3">
                            <form:input path="keyLength" cssClass="form-control input-sm" />
                        </div>
                        <div class="col col-md-3">
