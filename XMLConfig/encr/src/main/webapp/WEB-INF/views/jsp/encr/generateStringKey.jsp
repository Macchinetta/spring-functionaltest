...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.encr.generateStringKey" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <br />
                <t:messagesPanel />
                <form:form action="${pageContext.request.contextPath}/jsp/0203/001/generateStringKey" cssClass="form-horizontal" method="post" modelAttribute="encryptionDataForm">
