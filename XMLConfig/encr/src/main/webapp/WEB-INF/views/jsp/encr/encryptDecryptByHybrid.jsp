...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.encr.encryptDecryptByHybrid" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <br />
                <t:messagesPanel />
                <form:form action="${pageContext.request.contextPath}/jsp/0401/001/encryptDecryptByHybrid" cssClass="form-horizontal" method="post" modelAttribute="encryptionDataForm">
                    <legend>暗復号</legend>
