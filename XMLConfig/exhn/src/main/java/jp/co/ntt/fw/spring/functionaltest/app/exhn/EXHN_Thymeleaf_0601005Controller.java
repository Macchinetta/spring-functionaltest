...
import jp.co.ntt.fw.spring.functionaltest.domain.exception.WrappingException;
import jp.co.ntt.fw.spring.functionaltest.domain.service.exhn.ThrowExceptionService;

@Controller
@RequestMapping("thymeleaf")
public class EXHN_Thymeleaf_0601005Controller {

    @Inject
    ThrowExceptionService throwExceptionService;

    @GetMapping(value = "0601/005")
    public String employeeUpdate(Model model) throws WrappingException {

        throwExceptionService.throwWrappingException();
