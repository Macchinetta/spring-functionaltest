 ...
 */
@Controller
public class FLUP_Thymeleaf_0102Controller {
    ...
    public String handle003Upload(@Validated SingleUploadForm form, BindingResult result,
            RedirectAttributes redirectAttributes) throws IOException {
        return upload(form, result, redirectAttributes);
    }
    ...
    public String handle004Upload(@Validated SingleUploadForm form, BindingResult result,
            RedirectAttributes redirectAttributes) throws IOException {
        return upload(form, result, redirectAttributes);
    }
    ...
    @PostMapping(value = "005")
    public String handle005Upload(@Validated SingleUploadForm form, BindingResult result,
            RedirectAttributes redirectAttributes) throws IOException {
        return upload(form, result, redirectAttributes);
    }
    ...
    public String handleComplate() {
        return "thymeleaf/flup/singleFileUploadComplete";
    }

    private String form() {
        return "thymeleaf/flup/singleFileUploadForm";
    }
    ...
    private String upload(SingleUploadForm form, BindingResult result,
        ...
        return "redirect:/thymeleaf/0102?complete";
    }
