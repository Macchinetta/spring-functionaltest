...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.flup.directFileUploadComplete" />
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <div class="text-center">
                    <a href="${pageContext.request.contextPath}/" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span>ファイルアップロードのトップへ</a>
                </div>
            </div>
        </div>
