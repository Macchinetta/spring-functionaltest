    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div>
                    <form:form modelAttribute="deliveryOrderListForm" action="${pageContext.request.contextPath}/jsp/deliveryorder/register">
                ...
                <table class="table table-striped table-bordered table-condensed">
                    ...
                    <c:forEach var="deliveryOrder" items="${page.content}" varStatus="rowStatus">
                        <tr>
                            ...
                            <td class="deliveryNo">
                                <a id="deliveryNo_${rowStatus.count}" href="${pageContext.request.contextPath}/jsp/deliveryorder/${deliveryOrder.deliveryNo}/update">
                                    ${f:h(deliveryOrder.deliveryNo)}</a
                                >
                            </td>
                            ...
                            <td class="acceptDatetime" id="acceptDatetime"><javatime:format value="${deliveryOrder.acceptDatetime}" pattern="yyyy/MM/dd hh:mm:ss" /></td>
                            <td class="completionDatetime" id="completionDatetime"><javatime:format value="${deliveryOrder.completionDatetime}" pattern="yyyy/MM/dd HH:mm:ss" /></td>
                ...
                <form:form modelAttribute="deliveryOrderListForm" action="${pageContext.request.contextPath}/jsp/deliveryorder/update">
                    <fieldset>
                        <legend>複数件更新</legend>
                        <div class="container">
                            <div class="row">
