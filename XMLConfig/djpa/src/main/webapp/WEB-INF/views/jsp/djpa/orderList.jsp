        ...
        <div class="container">
            <div class="row">
                ...
                <table class="table table-striped table-bordered table-condensed">
                    <form:form modelAttribute="deliveryOrderStatusForm" action="${pageContext.request.contextPath}/jsp/delivery/order" method="get">
                        <thead>
                            <tr>
                        ...
                        <table class="table table-striped table-bordered table-condensed">
                            ...
                            <c:forEach var="delOrder" items="${deliveryOrders}" varStatus="rowStatus">
                                <tr>
                                    ...
                                    <td>
                                        <a id="delOrder_${rowStatus.count}" href="${pageContext.request.contextPath}/jsp/delivery/order/${delOrder.deliverNumber}/update">
                                            ${f:h(delOrder.deliverNumber)}</a
                                        >
                                    </td>
                ...
                <a id="regDelOrder" href="${pageContext.request.contextPath}/jsp/delivery/order/register">Add Delivery Order</a>
                <hr />
