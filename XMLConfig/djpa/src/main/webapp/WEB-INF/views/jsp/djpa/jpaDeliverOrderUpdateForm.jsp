...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.djpa.jpaDeliverOrderUpdateForm" />
    ...
    <body>
        ...
        <div class="container">
            <form:form modelAttribute="deliveryOrderStatusForm" action="${pageContext.request.contextPath}/jsp/delivery/order/${delOrder.deliverNumber}/update">
                <fieldset>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <form:input path="deliverNumber" class="form-control" value="${f:h(delOrder.deliverNumber)}" readonly="true" style="background-color: whitesmoke" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <form:input path="senderAddress" class="form-control" value="${f:h(delOrder.senderAddress)}" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <form:input path="receiverAddress" class="form-control" value="${f:h(delOrder.receiverAddress)}" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <fmt:formatDate value="${delOrder.completionDateTime}" pattern="yyyy/MM/dd" var="releaseDate" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <form:input path="deliveryDriver" class="form-control" value="${f:h(delOrder.deliveryDriver)}" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <form:input path="deliveryStatus" class="form-control" value="${f:h(delOrder.deliveryStatus)}" />
                            </div>
                        </div>
                        <div class="row">
