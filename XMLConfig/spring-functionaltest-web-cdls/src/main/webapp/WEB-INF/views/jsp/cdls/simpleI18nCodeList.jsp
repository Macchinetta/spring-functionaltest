...
<div id="wrapper">
  ...
  <div>
    <form:form modelAttribute="clI18nPriceForm" method="post"
      action="${pageContext.request.contextPath}/jsp/0105/003">
  ...
  <div>
    <form:form modelAttribute="clI18nPriceForm" method="post"
      action="${pageContext.request.contextPath}/jsp/0105/004">
  ...
  <div>
    <form:form modelAttribute="clI18nDBPriceForm" method="post"
      action="${pageContext.request.contextPath}/jsp/0105/007">
  ...
  <div>
    <form:form modelAttribute="clI18nDBPriceForm" method="post"
      action="${pageContext.request.contextPath}/jsp/0105/008">
