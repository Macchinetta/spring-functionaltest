...
public class RestAPITest extends RestTestSupport {
    ...
    public void testREST0202001() throws Exception {
        ...
        given().body(jsonBody)
               ...
               .body(
                     ...
                     "credential.passwordLastChangedAt", equalTo("2013-12-09T13:50:12.1"),
                     "credential.lastModifiedAt", equalTo("2013-12-09T13:50:12.1"),
                     "createdAt", equalTo("2013-12-09T13:50:12.1"),
                     "lastModifiedAt", equalTo("2013-12-09T13:50:12.1")
                    );
        // @formatter:on
    }
    ...
    public void testREST0501001() throws Exception {
        ...
        given().filters(new RequestLoggingFilter(captor),
               ...
               .body(
                     "links.href[0]", equalTo(baseURI(true)
                             + "/members/"
                             + memberIds.get(0)),
                     "memberId", equalTo(memberIds.get(0)),
                     "firstName", equalTo("FirstName" + i),
    ...
    public void testREST0601001() throws Exception {
        ...
        given().body(jsonBody)
               ...
               .post("/members")
               .then().statusCode(201)
               .header("Location", containsString(baseURI(true)
                       + "/members/M0"))
               .body(
                     "memberId", startsWith("M0"),
                     "firstName", equalTo(firstName),
    ...
    public void testREST0801001() throws Exception {
        ...
        given().body(jsonBody)
               ...
               .body(
                     ...
                     "address", equalTo("Address" + i),
                     "credential.signId", equalTo("firstname" + i + "@test.co.jp"),
                     "startDateTime", equalTo("2015-12-16T13:10:04.000000005"),
                     "endDateTime", equalTo("2015-12-16T14:10:04.000000005")
                    );
        // @formatter:on
    }
