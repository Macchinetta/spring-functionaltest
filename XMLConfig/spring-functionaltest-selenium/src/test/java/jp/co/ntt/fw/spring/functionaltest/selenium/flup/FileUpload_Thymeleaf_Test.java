...
public class FileUpload_Thymeleaf_Test extends FunctionTestSupport {
    ...
    public void testFLUP0101001() throws IOException {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0101001_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0102001() throws IOException {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0102001_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0102003() throws IOException {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0102003_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
            webDriverOperations.referUploadFile(id("multipartFile"),
    ...
    public void testFLUP0102004() throws IOException {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0102004_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0102005() throws IOException {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0102005_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0102006() throws IOException {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0102006_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0103001() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0103001_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0103002() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0103002_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0201001() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0201001_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0202001() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0202001_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0301001() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0301001_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0301002() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0301002_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0301003() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0301003_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0401001() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0401001_" + VIEW_TYPE));
        }
        // 複数ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0401002() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0401002_" + VIEW_TYPE));
        }
        // 複数ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0401003() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0401003_" + VIEW_TYPE));
        }
        // 複数ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0401004() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0401004_" + VIEW_TYPE));
        }
        // 複数ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0402001() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0402001_" + VIEW_TYPE));
        }
        // 複数ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0402002() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0402002_" + VIEW_TYPE));
        }
        // 複数ファイルアップロード画面の操作
        {
            // multipleの指定方法が不明。1ファイルのみアップロード
    ...
    public void testFLUP0501001() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0501001_" + VIEW_TYPE));
        }
        // 仮ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0501002() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0501002_" + VIEW_TYPE));
        }
        // 仮ファイルアップロード画面の操作
        {
        ...
        // アップロード確認
        {
            byte[] uploadFileData = restOperations.getForObject(
                    getPackageRootUrl() + "/flup/files?download&fileId=" + fileId,
                    byte[].class);
    ...
    public void testFLUP0601001() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0601001_" + VIEW_TYPE));
        }
        // 仮ファイルアップロード画面の操作
        {
        ...
        String temporaryFileId = null;
        {
            ...
            restOperations.getForEntity(applicationContextUrl
                    + "-flup/" + VIEW_TYPE + "/0601/001?enableScheduler", String.class);
    ...
    public void testFLUP0601002() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0601002_" + VIEW_TYPE));
        }
        // 仮ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0801001() throws IOException, InterruptedException {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0801001_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    public void testFLUP0802001() throws IOException {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("flup0802001_" + VIEW_TYPE));
        }
        // 単一ファイルアップロード画面の操作
        {
    ...
    private boolean existsUploadedTemporaryFile(String fileId) {
        String uri = applicationContextUrl + "-flup/uploadedTemporaryFiles/{fileId}";
    ...
    private boolean existsUploadedFile(String fileId) {
        String uri = applicationContextUrl + "-flup/uploadedFiles/{fileId}";
        return existsWebResource(uri, fileId);
    }
