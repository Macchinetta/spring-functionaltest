...
public class SessionManagement_JSP_Test extends FunctionTestSupport {
    ...
    public void testSSMN0301001() {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0301001_" + VIEW_TYPE));
        }
    ...
    public void testSSMN0301002() {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0301002_" + VIEW_TYPE));
        }
    ...
    public void testSSMN0301003() {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0301003_" + VIEW_TYPE));
        }
    ...
    public void testSSMN0301004() {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0301004_" + VIEW_TYPE));
        }
    ...
    public void testSSMN0301005() {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0301005_" + VIEW_TYPE));
        }
    ...
    public void testSSMN0301006() {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0301006_" + VIEW_TYPE));
        }
    ...
    public void testSSMN0301007() {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0301007_" + VIEW_TYPE));
        }
        ...
        // @ModelAttribute アノテーションが付与されたメソッドが呼ばれること
        {
            dbLogAssertOperations.waitForAssertion();
            dbLogAssertOperations.assertContainsByRegexMessage(webDriverOperations.getXTrack(),
                    ".*SSMN_JSP_0301007Controller", "ModelAttribute Method Called");
            dbLogAssertOperations.assertNotContainsWarnAndError(webDriverOperations.getXTrack());
        }
    ...
    public void testSSMN0301008() {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0301008_" + VIEW_TYPE));
        }
    ...
    public void testSSMN0301009() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0301009_" + VIEW_TYPE));
        }
    ...
    public void testSSMN0302001() {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0302001_" + VIEW_TYPE));
        }
    ...
    public void testSSMN0302002() {
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0302002_" + VIEW_TYPE));
        }
    ...
    public void testSSMN0401001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0401001_" + VIEW_TYPE));
        }
    ...
    public void testSSMN0401002() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0401002_" + VIEW_TYPE));
        }
    ...
    public void testSSMN0402001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn0402001_" + VIEW_TYPE));
        }
    ...
    public void testSSMN0601001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("ssmn060100101_before_" + VIEW_TYPE));
        }
        ...
        // もう一つのタブの入力操作実施
        {
            ...
            webDriverOperations.click(id("ssmn060100101_after_" + VIEW_TYPE));
            webDriverOperations.click(id("confirm"));
        }
