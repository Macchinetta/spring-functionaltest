...
public class Encryption_JSP_Test extends FunctionTestSupport {
    ...
    public void testENCR0101001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("encr0101001_" + VIEW_TYPE));
        }
    ...
    public void testENCR0103001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("encr0103001_" + VIEW_TYPE));
        }
    ...
    public void testENCR0104001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("encr0104001_" + VIEW_TYPE));
        }
    ...
    public void testENCR0105001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("encr0105001_" + VIEW_TYPE));
        }
    ...
    public void testENCR0201001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("encr0201001_" + VIEW_TYPE));
        }
    ...
    public void testENCR0202001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("encr0202001_" + VIEW_TYPE));
        }
    ...
    public void testENCR0203001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("encr0203001_" + VIEW_TYPE));
        }
    ...
    public void testENCR0301001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("encr0301001_" + VIEW_TYPE));
        }
    ...
    public void testENCR0302001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("encr0302001_" + VIEW_TYPE));
        }
    ...
    public void testENCR0303001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("encr0303001_" + VIEW_TYPE));
        }
    ...
    public void testENCR0401001() {
        ...
        // メニュー画面の操作
        {
            webDriverOperations.click(id("encr0401001_" + VIEW_TYPE));
        }
