...
public class Authorization_JSP_Test extends FunctionTestSupport {
    ...
    public void testATHR0301001() throws IOException {
        ...
        // メニュー画面の操作
        webDriverOperations.click(id("athr0301001_" + VIEW_TYPE));
    ...
    public void testATHR0401001() throws IOException {
        // メニュー画面の操作
        webDriverOperations.click(id("athr0401001_" + VIEW_TYPE));
    ...
    public void testATHR0601001() throws IOException {
        // メニュー画面の操作
        webDriverOperations.click(id("athr0601001_" + VIEW_TYPE));
    ...
    public void testATHR0601002() throws IOException {
        // メニュー画面の操作
        webDriverOperations.click(id("athr0601002_" + VIEW_TYPE));
    ...
    public void testATHR0601003() throws IOException {
        // メニュー画面の操作
        webDriverOperations.click(id("athr0601003_" + VIEW_TYPE));
    ...
    public void testATHR0601004() throws IOException {
        // メニュー画面の操作
        webDriverOperations.click(id("athr0601004_" + VIEW_TYPE));
    ...
    public void testATHR0601019() throws IOException {
        // メニュー画面の操作
        webDriverOperations.click(id("athr0601019_" + VIEW_TYPE));
    ...
    public void testATHR0601020() throws IOException {
        // メニュー画面の操作
        webDriverOperations.click(id("athr0601020_" + VIEW_TYPE));
    ...
    public void testATHR0601021() throws IOException {
        // メニュー画面の操作
        webDriverOperations.click(id("athr0601021_" + VIEW_TYPE));
    ...
    public void testATHR0601022() throws IOException {
        // メニュー画面の操作
        webDriverOperations.click(id("athr0601022_" + VIEW_TYPE));
    ...
    public void testATHR0602003() throws IOException {
        ...
        // メニュー画面の操作
        webDriverOperations.click(id("athr0602003_" + VIEW_TYPE));
    ...
    public void testATHR0701001() throws IOException, InterruptedException {
        ...
        // メニュー画面の操作
        webDriverOperations.click(id("athr0701001_" + VIEW_TYPE));
    ...
    public void testATHR0901001() throws IOException {
        ...
        // メニュー画面の操作
        webDriverOperations.click(id("athr0901001_" + VIEW_TYPE));
    ...
    public void testATHR0901002() throws IOException {
        ...
        // メニュー画面の操作
        webDriverOperations.click(id("athr0901002_" + VIEW_TYPE));
    ...
    public void testATHR0901003() throws IOException {
        ...
        // メニュー画面の操作
        webDriverOperations.click(id("athr0901003_" + VIEW_TYPE));
        ...
        // 入力条件設定
        webDriverOperations.overrideText(id("device"), "eth6J");
        ...
        // 登録結果確認
        assertThat(webDriverOperations.getText(id("device")), is("eth6J"));
        assertThat(webDriverOperations.getText(id("broadcast")), is(
                "192.168.16.255"));
        assertThat(webDriverOperations.getText(id("ipaddr")), is(
                "192.168.16.10"));
        ...
        // 入力条件設定
        webDriverOperations.overrideText(id("device"), "eth7J");
        ...
        // 登録結果確認
        assertThat(webDriverOperations.getText(id("device")), is("eth7J"));
        assertThat(webDriverOperations.getText(id("broadcast")), is(
                "192.168.17.255"));
        assertThat(webDriverOperations.getText(id("ipaddr")), is(
                "192.168.17.10"));
        ...
        // 入力条件設定
        webDriverOperations.overrideText(id("device"), "eth8J");
