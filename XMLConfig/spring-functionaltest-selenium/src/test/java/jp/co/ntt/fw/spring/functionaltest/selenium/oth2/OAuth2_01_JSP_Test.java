...
public class OAuth2_01_JSP_Test extends FunctionTestSupport {
    ...
    private void clean() {
        ...
        webDriverOperations.click(By.id("todoappNoAuth_" + VIEW_TYPE));

        webDriverOperations
                .waitForDisplayed(textToBe(By.id("screenTitle"), "Todo List - 認可処理なし（試験用）"));
    ...
    public void testOTH20101001() {
        ...
        webDriverOperations.click(By.id("authorizationCode_" + VIEW_TYPE));
        ...
        dbLogAssertOperations.assertContainsByRegexMessage(webDriverOperations.getXTrack(),
                ".*OAuth2TokenServiceImpl", ".*Scopes = \\[READ, DELETE, CREATE, UPDATE\\].*");
    }
    ...
    public void testOTH20101002() {
        ...
        dbLogAssertOperations.waitForAssertion();
        dbLogAssertOperations.assertContainsByRegexMessage(webDriverOperations.getXTrack(),
                ".*TraceLoggingInterceptor", ".*text=Created successfully!.*");
    ...
    public void testOTH20101003() {
        ...
        dbLogAssertOperations.waitForAssertion();
        dbLogAssertOperations.assertContainsByRegexMessage(webDriverOperations.getXTrack(),
                ".*TraceLoggingInterceptor", ".*text=Finished successfully!.*");
    ...
    public void testOTH20101004() {
        ...
        dbLogAssertOperations.waitForAssertion();
        dbLogAssertOperations.assertContainsByRegexMessage(webDriverOperations.getXTrack(),
                ".*TraceLoggingInterceptor", ".*text=Deleted successfully!.*");
    ...
    public void testOTH20101005() {
        ...
        webDriverOperations
                .click(By.cssSelector("input[name='registrationId'][value='registration_all']"));
        webDriverOperations
                .click(By.cssSelector("input[name='resourceProtect'][value='annotation']"));
        webDriverOperations.click(By.name("list"));
    ...
    public void testOTH20102001() {
        ...
        webDriverOperations
                .click(By.cssSelector("input[name='registrationId'][value='registration_read']"));
        webDriverOperations
                .click(By.cssSelector("input[name='resourceProtect'][value='intercepturl']"));
        webDriverOperations.click(By.name("list"));
        ...
        dbLogAssertOperations.waitForAssertion();
        dbLogAssertOperations.assertContainsByRegexMessage(webDriverOperations.getXTrack(),
                ".*OAuth2TokenServiceImpl", ".*Scopes = \\[READ\\].*");
    }
    ...
    public void testOTH20103001() {
        ...
        webDriverOperations
                .click(By.cssSelector("input[name='registrationId'][value='registration_wrong']"));
        webDriverOperations
                .click(By.cssSelector("input[name='resourceProtect'][value='intercepturl']"));
        webDriverOperations.click(By.name("list"));
    ...
    public void testOTH20104001() {
        ...
        webDriverOperations.click(
                By.cssSelector("input[name='registrationId'][value='registration_partial']"));
        webDriverOperations
                .click(By.cssSelector("input[name='resourceProtect'][value='intercepturl']"));
        webDriverOperations.click(By.name("list"));
        ...
        dbLogAssertOperations.waitForAssertion();
        dbLogAssertOperations.assertContainsByRegexMessage(webDriverOperations.getXTrack(),
                ".*OAuth2TokenServiceImpl", ".*Scopes = \\[READ, DELETE\\].*");
    }
