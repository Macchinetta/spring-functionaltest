...
public class ExceptionHandling_Thymeleaf_Test extends FunctionTestSupport {

    private static final String VIEW_TYPE = "thymeleaf";

    @After
    public void deleteTempDirectoryAndFiles() {
        restOperations.getForEntity(getPackageRootUrl() + "/delete/all", void.class);
    }
    ...
    public void testEXHN0201001() throws IOException {
        ...
        webDriverOperations.click(id("exhn0201001_" + VIEW_TYPE));
        ...
        // ビジネスエラー画面に遷移
        assertThat(webDriverOperations.getText(id("businessError")), is("業務エラー画面"));
        ...
        // 変更されていないことを確認
        assertThat(webDriverOperations.getInputFieldValue(id("employeeName")), is("Josh"));
        assertThat(webDriverOperations.getInputFieldValue(id("email")), is("josh@example.com"));
        assertThat(webDriverOperations.getInputFieldValue(id("address")), is("sandiego"));
    ...
    public void testEXHN0202001() throws IOException {
        webDriverOperations.click(id("initDb"));
        webDriverOperations.click(id("exhn0202001_" + VIEW_TYPE));
        ...
        String temporaryFileName = webDriverOperations.getText(id("uploadTemporaryFileId"));
        // RestTemplate で削除リクエストを投げる
        restOperations.getForEntity(
                getPackageRootUrl() + "/delete?temporaryFileName=" + temporaryFileName,
                String.class);
    ...
    public void testEXHN0203001() throws IOException, InterruptedException {
        ...
        webDriverOperations.click(id("initDb"));
        webDriverOperations.click(id("exhn0203001_" + VIEW_TYPE));
        ...
        restOperations.getForEntity(
                getPackageRootUrl() + "/copy/temporaryFile?temporaryFileName=" + temporaryFileName,
                void.class);

        webDriverOperations.click(id("uploadButton"));

        // 完了画面に遷移すること
        assertThat(webDriverOperations.getText(id("screenTitle")), is("記事登録完了画面"));
        webDriverOperations.saveScreenCapture();
        ...
        dbLogAssertOperations.assertContainsByRegexExceptionMessage(null,
                "org.terasoluna.gfw.common.exception.ExceptionLogger", "[e.sf.fw.9001]..*",
    ...
    public void testEXHN0301001() throws IOException {
        ...
        webDriverOperations.click(id("exhn0301001_" + VIEW_TYPE));
    ...
    /**
     * <ul>
     * <li>@ExceptionHandlerを使用して、Controlloer単位でExceptionがハンドリングされることを確認する。
     * Controller単位であることを確認するために2つのメソッドで実行する。</li>
     * </ul>
     */
    @Test
    public void testEXHN0302001() throws IOException {

        webDriverOperations.click(id("exhn0302001First_" + VIEW_TYPE));
        ...
        webDriverOperations.click(id("exhn0302001Second_" + VIEW_TYPE));
    ...
    public void testEXHN0302002() throws IOException {
        ...
        webDriverOperations.click(id("exhn0302002_" + VIEW_TYPE));
    ...
    public void testEXHN0601001() throws IOException {
        ...
        webDriverOperations.click(id("exhn0601001_" + VIEW_TYPE));
        ...
        assertThat(webDriverOperations.getText(By.xpath("//div[2]/div/ul/li")),
                is("[e.sf.eh.9000] System error occurred!"));
        ...
        try {
            restOperations.getForEntity(
                    getPackageRootUrl() + "/" + VIEW_TYPE + "/0601/register?uploadTemporaryFileId="
                            + temporaryFileName + "&title=test&fileName=exhn.html&upload",
                    String.class);
        } catch (HttpServerErrorException e) {
            // X-Exception-Code が設定されていることを確認
            assertThat(e.getResponseHeaders().getFirst("X-Exception-Code"), is("e.sf.eh.9000"));
            throw e;
        }
    }
    ...
    public void testEXHN0601002() throws IOException {
        ...
        webDriverOperations.click(id("exhn0601002_" + VIEW_TYPE));
        ...
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE
                    + "/0601/002/register?uploadTemporaryFileId=" + temporaryFileName
                    + "&title=test&fileName=exhn.html&upload", String.class);
        } catch (HttpServerErrorException e) {
            // ヘッダに設定された値の整合性確認
            assertThat(e.getResponseHeaders().getFirst("X-Error-Code"), is("e.sf.eh.9000"));

            List<String> cacheControlList = Arrays.asList("no-store");
            assertThat(e.getResponseHeaders().get("Cache-Control"), is(cacheControlList));
    ...
    public void testEXHN0601003() throws IOException {
        ...
        webDriverOperations.click(id("exhn0601003_" + VIEW_TYPE));
        ...
        // ビジネスエラー画面に遷移
        assertThat(webDriverOperations.getText(id("businessError")), is("業務エラー画面"));
        assertThat(webDriverOperations.getText(By.xpath("//div[2]/div/div/div[2]/ul/li")),
    ...
    public void testEXHN0601004() throws IOException {
        ...
        webDriverOperations.click(id("exhn0601004_" + VIEW_TYPE));
    ...
    /**
     * <ul>
     * <li>例外ハンドリング用クラスであるSystemExceptionResolverで除外設定を行い原因例外も除外対象とした場合、web.xmlで定義したエラー画面に遷移することを確認する。</li>
     * </ul>
     */
    @Test
    public void testEXHN0601005() throws IOException {

        webDriverOperations.click(id("exhn0601005_" + VIEW_TYPE));
    ...
    /**
     * <ul>
     * <li>例外ハンドリング用クラスであるSystemExceptionResolverで除外設定を行い除外対象のサブクラスも除外対象とした場合、web.xmlで定義したエラー画面に遷移することを確認する。</li>
     * </ul>
     */
    @Test
    public void testEXHN0601006() throws IOException {

        webDriverOperations.click(id("exhn0601006_" + VIEW_TYPE));
    ...
    public void testEXHN0701001() throws IOException {
        try {
            restOperations.headForHeaders(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/001");
    ...
    public void testEXHN0701002() throws IOException {
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/002",
                    String.class);
        } catch (HttpClientErrorException e) {
            // 415 が返却されていること
    ...
    public void testEXHN0701003() throws IOException {
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/003",
                    String.class);
        } catch (HttpClientErrorException e) {
            // 406 が返却されていること
    ...
    public void testEXHN0701004() throws IOException {
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/004",
                    String.class);
        } catch (HttpServerErrorException e) {
            // 500 が返却されていること
    ...
    public void testEXHN0701005() throws IOException {
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/005",
                    String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
    ...
    public void testEXHN0701006() throws IOException {
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/006",
                    String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.BAD_REQUEST));
    ...
    public void testEXHN0701007() throws IOException {
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/007",
                    String.class);
        } catch (HttpServerErrorException e) {
            // 500 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.INTERNAL_SERVER_ERROR));
    ...
    public void testEXHN0701008() throws IOException {
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/008?id=a",
                    String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.BAD_REQUEST));
    ...
    public void testEXHN0701009() throws IOException {
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/009",
                    String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.BAD_REQUEST));
    ...
    public void testEXHN0701010() throws IOException {
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/010",
                    String.class);
        } catch (HttpServerErrorException e) {
            // 500 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.INTERNAL_SERVER_ERROR));
    ...
    public void testEXHN0701011() throws IOException {
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/011",
                    String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.BAD_REQUEST));
    ...
    public void testEXHN0701012() throws IOException {
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/012",
                    String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.BAD_REQUEST));
    ...
    public void testEXHN0701013() throws IOException {
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/013",
                    String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.BAD_REQUEST));
    ...
    public void testEXHN0701014() throws IOException {
        try {
            // 存在しないパスを指定する。
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/014",
                    String.class);
            ...
            dbLogAssertOperations.assertContainsByRegexExceptionMessage(null,
                    "org.terasoluna.gfw.common.exception.ExceptionLogger", "No endpoint .*",
    ...
    public void testEXHN0701015() throws IOException {
        try {
            restOperations.getForEntity(getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/015",
                    String.class);
        } catch (HttpServerErrorException e) {
            // 503 が返却されていること
    ...
    public void testEXHN0701016() throws IOException {
        try {
            ResponseEntity<String> res = restOperations.getForEntity(
                    getPackageRootUrl() + "/" + VIEW_TYPE + "/0701/016", String.class);
    ...
    public void testEXHN0801001() throws IOException {
        ...
        webDriverOperations.click(id("exhn0801001_" + VIEW_TYPE));

        // ERROR Level Log
        dbLogAssertOperations.waitForAssertion();
        dbLogAssertOperations.assertContainsByRegexMessageAndLevelsAndLogger(
                "\\[e.sf.fw.9001\\] Runtime Exception occurred!!", "ERROR",
