...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.dnta.showUtilAndSqlDateTime" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <p>
                    Date:<span id="getDateResult"> <fmt:formatDate pattern="yyyy-MM-dd'T'HH:mm:ss" value="${resultDate}" /></span><br />
