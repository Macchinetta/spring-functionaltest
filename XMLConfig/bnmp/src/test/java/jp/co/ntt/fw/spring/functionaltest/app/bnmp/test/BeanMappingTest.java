...
@ContextConfiguration(locations = {"classpath:META-INF/spring/spring-mvc-test-bnmp.xml"})
public class BeanMappingTest {
    ...
    public void testBNMP0102001() {
        ...
        DifferentFieldTypeTarget target = this.beanMapper.differentFieldTypeMap(source);
    ...
    public void testBNMP0103001() {
        ...
        DifferentFieldNameTarget target = this.beanMapper.differentFieldNameMap(source);
    ...
    public void testBNMP0108001() {
        ...
        MultipleMappingTarget target = this.beanMapper.multipleMap(source1, source2);
    ...
    public void testBNMP0109002() {
        ...
        MultipleMappingTarget target1 = this.beanMapper.multipleInterfaceMap(source1);
        ...
        MultipleMappingTarget target2 = this.beanMapper.multipleInterfaceMap(source2);
    ...
    public void testBNMP0201003() {
        ...
        CustomMappingTarget target = this.beanMapper.separateClassCustomMap(source);
    ...
    public void testBNMP0204001() {
        ...
        assertThat(target.getDate(), is(LocalDateTime.of(2022, 10, 10, 11, 11, 11)));
    }

    @Test
    public void testBNMP0301001() {

        Logger logger = (Logger) LoggerFactory.getLogger(DefaultConstructorTarget.class);
        ...
        DefaultConstructorTarget target = this.beanMapper.defaultConstructorMap(source);

        assertThat(target.getId(), is(1));
        assertThat(target.getName(), is("SourceName"));

        verify(this.mockAppender, times(1)).doAppend(this.captorLoggingEvent.capture());
    ...
    public void testBNMP0301002() {
        ...
        Logger logger = (Logger) LoggerFactory.getLogger(PublicConstructorTarget.class);
        ...
        PublicConstructorTarget target = this.beanMapper.publicConstructorMap(source);
    ...
    public void testBNMP0301003() {
        ...
        Logger logger = (Logger) LoggerFactory.getLogger(NoArgumentConstructorTarget.class);
        ...
        NoArgumentConstructorTarget target = this.beanMapper.noArgumentConstructorMap(source);
