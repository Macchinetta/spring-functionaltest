...
public interface BeanMapper {
    ...
    MultipleMappingTarget multipleMap(Source source1, MultipleMappingSource source2);
    ...
    @SubclassMapping(source = MultipleSourceInterfaceImpl.class,
            target = MultipleMappingTarget.class)
    ...
    // 0201003
    @Mapping(target = "name", qualifiedByName = {"StringConverter", "UpperConverter"})
    ...
    void conditionalMap(CustomMappingSource source, @MappingTarget CustomMappingTarget target);
