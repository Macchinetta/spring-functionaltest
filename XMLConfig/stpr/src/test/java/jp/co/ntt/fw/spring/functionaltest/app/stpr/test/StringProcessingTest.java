...
public class StringProcessingTest {
    ...
    public void testSTPR0101002() {
        String str = "  Hello World!!";
        assertThat(StringUtils.trimLeadingCharacter(str, ' '), is("Hello World!!"));
    }
    ...
    public void testSTPR0101003() {
        String str = "  Hello World!!";
        assertThat(StringUtils.trimTrailingCharacter(str, '!'), is("  Hello World"));
    }
    ...
    public void testSTPR0502002() {
        ...
        Set<Integer> excludedCodePoints = codePoints.allExcludedCodePoints(("acbd"));
    ...
    public void testSTPR0502003() {
        Set<Integer> set = new HashSet<>(Arrays.asList(0x0061 /* a */, 0x0062 /* b */));
    ...
    public void testSTPR0502004() {
        ...
        Set<Integer> excludedCodePoints1 = codePoints1.allExcludedCodePoints(("acbd"));
        ...
        Set<Integer> excludedCodePoints2 = codePoints1.allExcludedCodePoints(("acbd"));
    ...
    public void testSTPR0503001() {
        ...
        Set<Integer> excludedCodePoints = abcdCp.allExcludedCodePoints(("abecdf"));
        assertThat(excludedCodePoints.size(), is(2));
    ...
    public void testSTPR0503002() {
        CodePoints abcdCp =
                new CodePoints(0x0061 /* a */, 0x0062 /* b */, 0x0063 /* c */, 0x0064 /* d */);
        CodePoints cdCp = new CodePoints(0x0063 /* c */, 0x0064 /* d */);
    ...
    public void testSTPR0505001() {
        ...
        Set<ConstraintViolation<ConsistOfTestBean>> violations1 = validator.validate(form1);

        assertThat(violations1, is(empty()));

        // name1とname2それぞれについて範囲外を指定する
        ConsistOfTestBean form2 = new ConsistOfTestBean("あア", "あア1");
        Set<ConstraintViolation<ConsistOfTestBean>> violations2 = validator.validate(form2);

        List<String> pathArray =
                violations2.stream().map(t -> t.getPropertyPath().toString()).toList();
    ...
    private String hexrangeToAscii(int hexStart, int hexEnd) {
        ...
        for (int i = hexStart; i <= hexEnd; i++) {
            ...
            builder.append(hexToAscii(hexStr.length() % 2 != 0 ? "0" + hexStr : hexStr));
        }
     ...
     * {@link org.terasoluna.gfw.common.codepoints.catalog.ASCIIControlChars}
     */
    @Test
     ...
     * {@link org.terasoluna.gfw.common.codepoints.catalog.ASCIIPrintableChars}
     */
    @Test
    ...
    private List<Integer> readCsv(String path) {
        ...
        try (BufferedReader buffReader =
            ...
            while ((line = buffReader.readLine()) != null) {
                ...
                if (StringUtils.hasLength(arrayStr[4]) && !arrayStr[4].startsWith("-")) {
     ...
     * コードポイント集合チェック(文字種チェック)
     * <p>
     * JIS X 0201 の半角カタカナの集合
     * {@link org.terasoluna.gfw.common.codepoints.catalog.JIS_X_0201_Katakana}
     */
    @Test
     ...
     * {@link org.terasoluna.gfw.common.codepoints.catalog.JIS_X_0201_LatinLetters}
     */
    @Test
    public void testSTPR0507005() {
        CodePoints codePoints = new JIS_X_0201_LatinLetters();

        List<Integer> hexArray = readCsv("codepoint/JIS_X_0201_LatinLetters.csv");
    ...
    public void testSTPR0507006() {
        ...
        List<Integer> hexArray = readCsv("codepoint/JIS_X_0208_1_2_SpecialChars.csv");
    ...
    public void testSTPR0507007() {
        ...
        List<Integer> hexArray = readCsv("codepoint/JIS_X_0208_3_LatinLetters.csv");
    ...
    public void testSTPR0507010() {
        ...
        List<Integer> hexArray = readCsv("codepoint/JIS_X_0208_6_GreekLetters.csv");
     ...
     * <p>
     * JIS X 0208 の7区
     * {@link org.terasoluna.gfw.common.codepoints.catalog.JIS_X_0208_CyrillicLetters}
     */
    @Test
    public void testSTPR0507011() {
        CodePoints codePoints = new JIS_X_0208_CyrillicLetters();

        List<Integer> hexArray = readCsv("codepoint/JIS_X_0208_7_CyrillicLetters.csv");
     ...
     * <p>
     * JIS X 0208 の8区
     * {@link org.terasoluna.gfw.common.codepoints.catalog.JIS_X_0208_BoxDrawingChars}
     */
    @Test
    public void testSTPR0507012() {
        CodePoints codePoints = new JIS_X_0208_BoxDrawingChars();

        List<Integer> hexArray = readCsv("codepoint/JIS_X_0208_8_BoxDrawingChars.csv");
     ...
     * {@link org.terasoluna.gfw.common.codepoints.catalog.JIS_X_0213_Kanji}
     */
    @Test
