...
<div class="row">
  ...
  <div>
    <form:form modelAttribute="deliveryOrderListForm"
      action="${pageContext.request.contextPath}/jsp/deliveryorder/register">
    ...
    <c:forEach var="deliveryOrder" items="${page.content}" varStatus="rowStatus">
      <tr>
        ...
        <td class="deliveryNo"><a id="deliveryNo_${rowStatus.count}"
          href="${pageContext.request.contextPath}/jsp/deliveryorder/${deliveryOrder.deliveryNo}/update">
  ...
  <form:form modelAttribute="deliveryOrderListForm"
    action="${pageContext.request.contextPath}/jsp/deliveryorder/update">
    <fieldset>
      <legend>複数件更新</legend>
      <div class="container">
        <div class="row">
