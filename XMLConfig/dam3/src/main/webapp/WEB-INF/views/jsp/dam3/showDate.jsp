...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.dam3.showDate" />
    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="wrapper">
                <p>
                    Date:<span id="getDateResult">${f:h(resultDate)}</span><br />
                    Class:<span id="getDateClassResult">${f:h(resultDate.getClass().getName())}</span><br />
                    Certification:<span id="getObjectCertification"><%=request.getAttribute("resultDate") instanceof LocalDate%></span>
                </p>
            </div>
        </div>
