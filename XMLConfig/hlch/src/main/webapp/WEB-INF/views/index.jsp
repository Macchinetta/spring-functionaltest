    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <ul>
                    <li>
                        hlch0101001 (<a id="hlch0101001_jsp" href="${pageContext.request.contextPath}/jsp/0101/001">JSP</a> /
                        <a id="hlch0101001_thymeleaf" href="${pageContext.request.contextPath}/thymeleaf/0101/001">Thymeleaf</a>)
                    </li>
                    <li>
                        hlch0101002 (<a id="hlch0101002_jsp" href="${pageContext.request.contextPath}/jsp/0101/002">JSP</a> /
                        <a id="hlch0101002_thymeleaf" href="${pageContext.request.contextPath}/thymeleaf/0101/002">Thymeleaf</a>)
                    </li>
                </ul>
                ...
                <ul>
                    <li>
                        hlch0201001 (<a id="hlch0201001_jsp" href="${pageContext.request.contextPath}/jsp/0201/001">JSP</a> /
                        <a id="hlch0201001_thymeleaf" href="${pageContext.request.contextPath}/thymeleaf/0201/001">Thymeleaf</a>)
                    </li>
                </ul>
            </div>
        </div>
