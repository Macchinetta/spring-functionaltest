    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0103/003/authentication" class="form-horizontal">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0103/003/logout" class="form-horizontal">
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0103/003" modelAttribute="authorizedValidationForm" class="form-horizontal">
                    <div class="form-group">
