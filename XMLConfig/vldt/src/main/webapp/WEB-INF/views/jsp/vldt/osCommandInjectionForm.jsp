...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.osCommandInjectionForm" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0701/001" modelAttribute="osCommandInjectionForm" class="form-horizontal">
