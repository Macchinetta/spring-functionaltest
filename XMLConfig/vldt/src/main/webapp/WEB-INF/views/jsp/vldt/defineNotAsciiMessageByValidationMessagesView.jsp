    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0304/001" modelAttribute="defineNotAsciiMessageByValidationMessagesForm" class="form-horizontal">
