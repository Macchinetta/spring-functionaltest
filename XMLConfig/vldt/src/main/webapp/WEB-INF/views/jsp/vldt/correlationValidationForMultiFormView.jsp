    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0201/002" modelAttribute="userForm" class="form-horizontal">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0201/002" modelAttribute="userDetailsForm" class="form-horizontal">
                    <div class="form-group">
