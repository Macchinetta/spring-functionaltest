...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.displayOutsideMessagesView" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0101/004" modelAttribute="displayOutsideMessagesForm" class="form-horizontal">
                    <div class="form-group">
