...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.simpleValidationByJSR303View" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0101/001" modelAttribute="simpleValidationByJSR303Form" class="form-horizontal">
