...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.simpleValidationByInclusiveView" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0101/007" modelAttribute="simpleValidationByInclusiveForm" class="form-horizontal">
