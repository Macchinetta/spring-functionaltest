...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.vldt.existInCheckForCollectionForm" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h1 id="screenTitle">コレクション内の値に対する入力チェック</h1>

                <form:form action="${pageContext.request.contextPath}/jsp/0502/001" method="post" modelAttribute="roleForCollectionForm">
                    ...
                    <br />
                    <input id="validate" class="mainbtn" style="width: 200px" type="submit" value="Validate" name="Validate" />
                </form:form>
            </div>
        </div>
