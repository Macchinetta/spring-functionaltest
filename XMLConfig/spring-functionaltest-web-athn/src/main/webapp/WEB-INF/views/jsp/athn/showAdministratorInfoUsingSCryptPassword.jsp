...
<c:set var="titleKey" value="title.athn.showAdministratorInfoUsingSCryptPassword" />
...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/jsp/0501/006/logout" method="post">
