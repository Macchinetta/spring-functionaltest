...
@Controller
public class ATHN_Thymeleaf_04Controller {

    @GetMapping(value = "0401/001", params = "loginSuccess")
    ...
    @GetMapping(value = "0402/001", params = "loginSuccess")
    ...
    @GetMapping(value = "0402/004", params = "loginSuccess")
