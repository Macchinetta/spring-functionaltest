...
<c:set var="titleKey" value="title.athr.showCustomizedAuthorizeErrorForAuthenticated" />
...
<div id="wrapper">
    ...
    <table class="table table-bordered table-condensed">
      ...
      <tr>
        ...
        <td><span> <a id="denyLink"
            href="${pageContext.request.contextPath}/jsp/0701/001/deny">Go To Access Denied
              Page</a>
        </span></td>
      </tr>
    </table>
  ...
  <form:form>
    <input id="ajaxBtn" type="button" class="btn btn-default" value="Ajaxによる送信"
      onclick="return athr.search()" />
  </form:form>

  <form:form action="${pageContext.request.contextPath}/jsp/0701/logout" method="post">
