...
<c:set var="titleKey" value="title.athr.showForAccessPolicy" />
    ...
    <table class="table table-bordered table-condensed">
      ...
      <tr>
        ...
        <td><span> <a id="accountsLink"
            href="${pageContext.request.contextPath}/jsp/0601/001/accounts">Go To Account Page
              Top Page</a>
        </span></td>
      </tr>
      <tr>
        ...
        <td><span> <a id="mangerLink"
            href="${pageContext.request.contextPath}/jsp/0601/001/manager">Go To Manager Page</a>
        </span></td>
