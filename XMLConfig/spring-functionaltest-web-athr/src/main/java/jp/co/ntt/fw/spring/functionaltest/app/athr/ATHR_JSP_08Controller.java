...
@Controller
public class ATHR_JSP_08Controller {
    @GetMapping("0802/001")
    public String handle0801001() {
        return "jsp/athr/loginForCustomizedAuthorizeErrorForUnAuthenticated";
    }
    ...
    public String handle0801001afterLogin(Principal principal, Model model) {
        ...
        model.addAttribute("userEmail", userDetails.getUsername()
                + "@example.com");
        return "jsp/athr/showForCustomizedAutnenticateErrorForUnAuthenticated";
    }
