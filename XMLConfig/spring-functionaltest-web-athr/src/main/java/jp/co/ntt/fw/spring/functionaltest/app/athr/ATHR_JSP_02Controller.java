...
@Controller
public class ATHR_JSP_02Controller {

    @GetMapping("0201/001")
    public String handle0201001loginForStaff() {
        return "jsp/athr/loginForStaff";
    }
    ...
    public String handle0201001afterLogin(Principal principal, Model model) {
        ...
        model.addAttribute("userEmail", userDetails.getUsername()
                + "@example.com");
        return "jsp/athr/showForStaffInfoDsp";
    }

    @GetMapping("0201/002")
    public String handle0201002loginForStaff() {
        return "jsp/athr/loginForJspTagRoleAdmin";
    }

    @GetMapping(value = "0201/002/afterLogin")
    public String handle0201002afterLogin() {
        return "jsp/athr/showForJspTagRoleAdminDsp";
    }
