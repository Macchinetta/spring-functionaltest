...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.excn.jpaPessimisticLockViewExcpHandler" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0602/002" modelAttribute="stockForm" cssClass="form-horizontal">
