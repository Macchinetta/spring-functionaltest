...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.excn.RDBMSLockView" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0301/001" modelAttribute="stockForm" cssClass="form-horizontal">
