...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.excn.optimisticLockWithHiddenVersionView" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <form:form method="post" action="${pageContext.request.contextPath}/jsp/0302/002" modelAttribute="stockForm" cssClass="form-horizontal">
