...
public class APLY04CommonControllerAdvice02 {
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(APLY04CommonControllerAdvice02.class);
    ...
    @ModelAttribute
    public CommonParameters setUpCommonParameters02(@RequestParam(value = "commonParam2",
            defaultValue = "defCommonParam2") String commonParam2) {
        logger.info(
