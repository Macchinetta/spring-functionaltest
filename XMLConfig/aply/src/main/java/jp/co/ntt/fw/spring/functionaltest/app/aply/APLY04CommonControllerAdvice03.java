...
public class APLY04CommonControllerAdvice03 {
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(APLY04CommonControllerAdvice03.class);
    ...
    @ModelAttribute
    public CommonParameters setUpCommonParameters03(@RequestParam(value = "commonParam3",
            defaultValue = "defCommonParam3") String commonParam3) {
        logger.info(
