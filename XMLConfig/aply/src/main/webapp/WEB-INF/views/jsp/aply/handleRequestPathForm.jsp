    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                ...
                <ul>
                    <li><a id="aply0101002hello" href="${pageContext.request.contextPath}/jsp/0101/002/hello">リクエストパスに"hello"を付与</a></li>
                    <li><a id="aply0101002nihao" href="${pageContext.request.contextPath}/jsp/0101/002/nihao">リクエストパスに"nihao"を付与</a></li>
                    <li><a id="aply0101002bonjour" href="${pageContext.request.contextPath}/jsp/0101/002/bonjour">リクエストパスに"bonjour"を付与</a></li>
                </ul>
            </div>
        </div>
