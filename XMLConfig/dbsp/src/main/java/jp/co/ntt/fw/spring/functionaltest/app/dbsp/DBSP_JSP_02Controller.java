...
@Controller
@RequestMapping("jsp")
public class DBSP_JSP_02Controller {

    private static final Logger logger = LoggerFactory.getLogger(DBSP_JSP_02Controller.class);
    ...
    public String create(@Validated UserCreateForm userCreateForm, BindingResult bindingResult,
        ...
        return "redirect:/jsp/0201/001/create?complete";
    }

    @GetMapping(value = "0201/001/create", params = "complete")
    public String createComplete() {
        return "jsp/dbsp/createComplete";
    }
}
