...
@Controller
@RequestMapping("jsp")
public class DBSP_JSP_03Controller {
    @ModelAttribute
    ...
    public String thirdDummy() {
        return "jsp/dbsp/thirdViewDummy";
    }
    ...
    public String handle(Model model) {
        return "jsp/dbsp/fileDownloadForm";
    }
