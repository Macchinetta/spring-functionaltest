...
@Controller
public class CSPR_Thymeleaf_04Controller {
    ...
    public String handle0401001() {
        return "thymeleaf/cspr/customerBatchRegister";
    }

    @GetMapping(value = "0401/002")
    public String handle0401002() {
        return "thymeleaf/cspr/customerBatchRegisterUseStandardForm";
    }
    ...
    public String batchRegister(@Validated CustomerBatchRegisterForm form,
        ...
        return "thymeleaf/cspr/customerBatchComplete";
    }
