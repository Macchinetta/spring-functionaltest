...
@RequestMapping(value = "jsp/0301/007")
public class SSMN_JSP_0301007Controller {

    private static final Logger logger = LoggerFactory.getLogger(SSMN_JSP_0301007Controller.class);
    ...
    @GetMapping
    public String handle01007(Model model, SessionStatus sessionStatus) {
        sessionStatus.setComplete();
        return "redirect:/jsp/0301/007?personalForm";
    }
    ...
    public String createMember(
        ...
        return "redirect:/jsp/0301/007?complete";
    }
