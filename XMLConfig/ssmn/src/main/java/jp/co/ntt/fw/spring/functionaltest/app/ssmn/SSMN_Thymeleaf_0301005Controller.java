...
@RequestMapping(value = "thymeleaf/0301/005")
public class SSMN_Thymeleaf_0301005Controller {
    ...
    @GetMapping
    public String handle01005(Model model, SessionStatus sessionStatus) {
        sessionStatus.setComplete();
        return "redirect:/thymeleaf/0301/005?personalForm";
    }
    ...
    public String createMemberAddressForm(Model model,
            @ModelAttribute @Validated(Personal.class) MemberForm form, BindingResult result) {
        if (result.hasErrors()) {
    ...
    public String createMember(
        ...
        return "redirect:/thymeleaf/0301/005?complete";
    }
