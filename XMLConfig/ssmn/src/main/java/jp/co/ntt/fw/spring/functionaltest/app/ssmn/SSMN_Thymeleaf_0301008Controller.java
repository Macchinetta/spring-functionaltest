...
@RequestMapping(value = "thymeleaf/0301/008")
public class SSMN_Thymeleaf_0301008Controller {
    @Inject
    ...
    public String handle01008(Model model, SessionStatus sessionStatus) {
        ...
        return "redirect:/thymeleaf/0301/008?personalForm";
    }
    ...
    public String createMemberConfirm(Model model,
        ...
        return "thymeleaf/ssmn/createMemberConfirmUseSessionObject";
    }
    ...
    public String createMember(Model model, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/thymeleaf/0301/008?complete";
    }
