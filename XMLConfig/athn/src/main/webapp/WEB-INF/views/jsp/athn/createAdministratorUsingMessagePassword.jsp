...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.athn.createAdministratorUsingMessagePassword" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h1 id="screenTitle">管理者登録(MessageDigestPasswordEncoder)</h1>
                <br />
                <t:messagesPanel />
                <form:form action="${pageContext.request.contextPath}/jsp/1901/001/createAdminUsingMessage" cssClass="form-horizontal" method="post" modelAttribute="administratorForm">
                    <legend>管理者登録</legend>
