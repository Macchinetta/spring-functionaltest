...
<c:set var="titleKey" value="title.athn.showCustomerCompanyInfo" />
...
<div id="wrapper">
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tr>
      <th>Company Id</th>
      <td><span id="companyId"> ${f:h(customer.companyId)} </span></td>
    </tr>
  </table>
  <form:form action="${pageContext.request.contextPath}/jsp/1702/logout" method="post">
