...
@Controller
public class ATHN_Thymeleaf_13Controller {

    @GetMapping(value = "1302/001", params = "loginSuccess")
    public String handle1302LoginSuccess(@AuthenticationPrincipal AccountUserDetails userDetails,
            Model model) {
