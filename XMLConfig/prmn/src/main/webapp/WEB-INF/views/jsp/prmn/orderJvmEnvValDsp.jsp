...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.prmn.orderJvmEnvValDsp" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h1 id="screenTitle">プロパティキー重複で無指定の場合、JVMのプロパティ値が優先して表示されること</h1>

                <fieldset>
                    <table class="table table-bordered table-condensed col-xs-5 col-sm-5 col-md-5 col-g-5">
                        <tr>
                            <th class="col col-xs-2 col-sm-2 col-md-2 col-g-2">propertyValue0007</th>
                            <td class="col col-xs-3 col-sm-3 col-md-3 col-g-3"><span id="propertyValue0007"> ${f:h(prmnDefines.propertyValue0007)} </span></td>
                        </tr>
                    </table>
                </fieldset>
            </div>
