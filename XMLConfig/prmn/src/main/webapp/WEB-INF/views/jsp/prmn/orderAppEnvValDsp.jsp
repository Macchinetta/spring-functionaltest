...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.prmn.orderAppEnvValDsp" />
    ...
    <body>
        ...
        <div class="container">
            <div id="wrapper">
                <h1 id="screenTitle">プロパティキー重複で、local-override="true"指定の場合、アプリケーション定義のプロパティ値が優先して表示されること</h1>

                <fieldset>
                    <table class="table table-bordered table-condensed col-xs-5 col-sm-5 col-md-5 col-g-5">
                        <tr>
                            <th class="col col-xs-2 col-sm-2 col-md-2 col-g-2">propertyValue0008</th>
                            <td class="col col-xs-3 col-sm-3 col-md-3 col-g-3"><span id="propertyValue0008"> ${f:h(prmnDefines.propertyValue0008)} </span></td>
                        </tr>
                    </table>
                </fieldset>
            </div>
