...
<div class="row">
    ...
    <table class="table table-striped table-bordered table-condensed">
      ...
      <form:form modelAttribute="jpaBookListForm"
        ...
        <tr>
          ...
          <th><form:input path="sleepTime" class="form-control form-input"
              value="${f:h(bookListForm.sleepTime)}" /></th>
        ...
        <tr>
          ...
          <th align="left"><form:input path="bookTitle" class="form-control form-input"
              value="${f:h(jpaBookListForm.bookTitle)}" /></th>
    ...
    <c:forEach var="book" items="${page.content}" varStatus="rowStatus">
      <tr>
        ...
        <td class="bookId"><a id="bookLink_${rowStatus.count}"
          href="${pageContext.request.contextPath}/jsp/book/${book.bookId}/pgUpdate">
  ...
  <div class="paginationPart" align="center">
    <t:pagination page="${page}" disabledHref="javascript:void(0);" outerElementClass="pagination"
      queryTmpl="page={page}&size={size}&${f:query(bookListForm)}" />
  </div>
