...
<div class="row">
    ...
    <c:forEach items="${orderForm.orderItem}" var="order" varStatus="rowStatus">
      <tr>
        ...
        <td id="itNum_${rowStatus.count}"><a id="item${f:h(rowStatus.count)}"
          href="${pageContext.request.contextPath}/jsp/order/${orderForm.orderId }/item/${f:h(order.itemNumber)}/detail">${f:h(order.itemNumber)}</a></td>
  ...
  <table class="table table-striped table-bordered table-condensed">
    <form:form modelAttribute="orderForm"
      action="${pageContext.request.contextPath}/jsp/order/${orderForm.orderId }/addUpdt"
      method="get">
      <thead>
        <tr>
  ...
  <table class="table table-striped table-bordered table-condensed">
    <form:form modelAttribute="orderForm"
      action="${pageContext.request.contextPath}/jsp/order/${orderForm.orderId }/update"
      method="post">
      <thead>
        <tr>
