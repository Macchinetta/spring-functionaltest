...
<div class="row">
  ...
  <div>
    <form:form modelAttribute="jpaBookListForm"
      action="${pageContext.request.contextPath}/jsp/book/register">
  ...
  <div>
    <table class="table table-striped table-bordered table-condensed">
      <form:form modelAttribute="jpaBookListForm"
        action="${pageContext.request.contextPath}/jsp/book/delete" method="delete">
      ...
      <form:form modelAttribute="jpaBookListForm"
        action="${pageContext.request.contextPath}/jsp/book/existence" method="get">
  ...
  <fieldset>
    ...
    <table>
      <form:form modelAttribute="jpaBookListForm"
        action="${pageContext.request.contextPath}/jsp/book/sort" method="get">
        <tr>
    ...
    <c:forEach var="book" items="${bookList}" varStatus="rowStatus">
      <tr>
        ...
        <td class="bookId"><a id="bookLink_${rowStatus.count}"
          href="${pageContext.request.contextPath}/jsp/book/${book.bookId}/update">
  ...
  <form:form modelAttribute="jpaBookListForm"
    action="${pageContext.request.contextPath}/jsp/book/interceptSrch">
    <fieldset>
  ...
  <br>
  <form:form modelAttribute="jpaBookListForm"
    action="${pageContext.request.contextPath}/jsp/book/filterSrch">
    <fieldset>
  ...
  <br>
  <form:form modelAttribute="jpaBookListForm"
    action="${pageContext.request.contextPath}/jsp/book/noLazySetting">
    <fieldset>
  ...
  <br>
  <form:form modelAttribute="jpaBookListForm"
    action="${pageContext.request.contextPath}/jsp/book/register" method="GET">
    <table>
      <tr>
        <th class="title">書籍ID</th>
