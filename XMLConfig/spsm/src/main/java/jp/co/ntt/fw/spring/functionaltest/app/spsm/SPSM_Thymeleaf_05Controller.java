...
@Controller
public class SPSM_Thymeleaf_05Controller {

    @GetMapping("0501/001/login")
    public String handle0501001Login(Model model) {
        model.addAttribute("testNo", "0501/001");
        return "thymeleaf/spsm/loginForSessionConcurrencyControlAfter";
    }

    @GetMapping(value = "0501/001", params = "loginSuccess")
    public String handle0501001LoginSuccess(@AuthenticationPrincipal User userDetails,
            Model model) {
        model.addAttribute("username", userDetails.getUsername());
        model.addAttribute("testNo", "0501/001");
        return "thymeleaf/spsm/topForDefault";
    }

    @GetMapping("0501/002/login")
    public String handle0501002Login(Model model) {
        model.addAttribute("testNo", "0501/001");
        return "thymeleaf/spsm/loginForSessionConcurrencyControlBefore";
    }
    ...
    public String handle0501002LoginSuccess(@AuthenticationPrincipal User userDetails,
            Model model) {
        model.addAttribute("username", userDetails.getUsername());
        model.addAttribute("testNo", "0501/002");
        return "thymeleaf/spsm/topForDefault";
