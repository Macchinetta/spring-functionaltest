...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.spsm.loginForMigrateSession" />
    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="wrapper">
                ...
                <form action="${pageContext.request.contextPath}/jsp/${testNo}/authenticate" method="post">
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span id="session"> <c:if test="${!empty sessionForm.oeratorName}"> ${f:h(sessionForm.oeratorName)} </c:if> </span>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
