...
@Controller
public class RSCL_JSP_14Controller {
    ...
    public String handle1401001First(Model model) {
        ...
        return "jsp/rscl/callViaProxy";
    }

    @PostMapping(value = "1401/001")
    public String handle1401001(Model model, @RequestParam("path") String path) {
    ...
    public String handle1401002(Model model, @RequestParam("path") String path) {
    ...
    public String handle1402001(Model model, @RequestParam("path") String path) {
