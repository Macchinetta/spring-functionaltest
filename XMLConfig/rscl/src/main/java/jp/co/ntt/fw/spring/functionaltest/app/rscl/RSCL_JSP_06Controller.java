...
public class RSCL_JSP_06Controller {
    ...
    public String handle0601002First(Model model) {
        ...
        model.addAttribute("testDescription", "HTTPS server1 /api/v1/rscl2 サーバ側で6秒待機する");
    ...
    public String handle0601002(Model model) {
        ...
        // SoTimeout : 発生しない
        UserResource rcvUser =
                this.httpsRestClientService.connectHttps(SERVERS.SERVER1, DESTINATION.RSCL2, false);
    ...
    public String handle0601003First(Model model) {
        ...
        model.addAttribute("screenTitle", "HTTPS接続");
        model.addAttribute("testDescription", "HTTPS server1 /api/v1/rscl3 サーバ側で6秒待機する");
    ...
    public String handle0601003(Model model) {
        ...
        // SoTimeout : 発生しない
        UserResource rcvUser =
                this.httpsRestClientService.connectHttps(SERVERS.SERVER1, DESTINATION.RSCL3, false);
    ...
    public String handle0601004First(Model model) {
        ...
        model.addAttribute("screenTitle", "HTTPS接続");
        model.addAttribute("testDescription", "HTTPS server1 /api/v1/rscl4 サーバ側で20秒待機する");
    ...
    public String handle0601004(Model model) {
        ...
        // SoTimeout : 発生しない
        UserResource rcvUser =
                this.httpsRestClientService.connectHttps(SERVERS.SERVER1, DESTINATION.RSCL4, false);
    ...
    public String handle0601005First(Model model) {
        ...
        model.addAttribute("screenTitle", "HTTPS接続");
        model.addAttribute("testDescription", "HTTPS server2 /api/v1/rscl2 サーバ側で6秒待機する");
    ...
    public String handle0601005(Model model) {
        ...
        // SoTimeout : 発生しない
        UserResource rcvUser =
                this.httpsRestClientService.connectHttps(SERVERS.SERVER2, DESTINATION.RSCL2, false);
    ...
    public String handle0601006First(Model model) {
        ...
        model.addAttribute("screenTitle", "HTTPS接続");
        model.addAttribute("testDescription", "HTTPS server3 /api/v1/rscl2 サーバ側で6秒待機する");
    ...
    public String handle0601006(Model model) {
        ...
        // SoTimeout : 発生しない
        UserResource rcvUser =
                this.httpsRestClientService.connectHttps(SERVERS.SERVER3, DESTINATION.RSCL2, false);
    ...
    public String handle0601007First(Model model) {
        ...
        model.addAttribute("screenTitle", "HTTPS接続");
        model.addAttribute("testDescription", "HTTPS serverXX（存在しないサーバ） /api/v1/rscl");
    ...
    public String handle0601007(Model model) {
        ...
        // SoTimeout : 発生しない
        UserResource rcvUser = this.httpsRestClientService.connectHttps(SERVERS.NOTEXISTS,
                DESTINATION.RSCL1, false);
    ...
    public String handle0601008First(Model model) {
        ...
        model.addAttribute("screenTitle", "HTTPS接続");
        model.addAttribute("testDescription", "HTTPS server4 /api/v1/rscl1 SoTimeoutの発生なし");
    ...
    public String handle0601008(Model model) {
        ...
        // SoTimeout : 発生しない
        UserResource rcvUser =
                this.httpsRestClientService.connectHttps(SERVERS.SERVER4, DESTINATION.RSCL1, false);
    ...
    public String handle0601009First(Model model) {
        ...
        model.addAttribute("screenTitle", "HTTPS接続");
        model.addAttribute("testDescription", "HTTPS server4 /api/v1/rscl1 SoTimeoutが発生する");
    ...
    public String handle0601009(Model model) {
        ...
        // SoTimeout : 発生する
        UserResource rcvUser =
                this.httpsRestClientService.connectHttps(SERVERS.SERVER4, DESTINATION.RSCL1, true);
