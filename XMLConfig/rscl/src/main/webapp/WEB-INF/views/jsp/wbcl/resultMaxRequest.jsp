...
<html class="no-js">
    ...
    <c:set var="titleKey" value="title.wbcl.resultMaxRequest" />
    ...
    <body>
        ...
        <div class="container">
            ﻿
            <div id="wrapper">
                <h1 id="screenTitle">スレッド数 + キューサイズ 以上のリクエスト送信時の確認結果</h1>
                <t:messagesPanel />
                <table class="table table-bordered table-condensed pgnttable">
                    <tr>
                        <th>SUCCESS 結果</th>
                        <td><span id="success">${f:h(success)} 件</span></td>
                    </tr>
                    <tr>
                        <th>ERROR 結果</th>
                        <td><span id="error">${f:h(error)}　件</span></td>
                    </tr>
                </table>
            </div>
        </div>
