...
<c:set var="titleKey" value="title.athr.loginForCustomizedAuthorizeErrorForUnAuthenticated" />
...
<div id="wrapper">
  ...
  <h1 id="screenTitle">Login Page(CustomizedAuthorizeErrorForUnAuthenticated)</h1>

  <form:form action="${pageContext.request.contextPath}/jsp/0802/customerAuthenticate"
    method="post">
