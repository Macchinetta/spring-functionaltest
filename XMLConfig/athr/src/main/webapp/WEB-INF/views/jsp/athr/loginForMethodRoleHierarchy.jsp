...
<c:set var="titleKey" value="title.athr.loginForMethodRoleHierarchy" />
...
<div id="wrapper">
  ...
  <h1 id="screenTitle">Staff Login Page(For Method Role Hierarchy Display)</h1>

  <form:form action="${pageContext.request.contextPath}/jsp/0901/003/authenticate" method="post">
  ...
  <br>
  <form:form action="${pageContext.request.contextPath}/jsp/0901/003/logout" method="post">
