...
<c:set var="titleKey" value="title.athr.loginForAccsessPolicyDenyAll" />
...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/jsp/0601/004/authenticate" method="post">
  ...
  <br>
  <form:form action="${pageContext.request.contextPath}/jsp/0601/001/logout" method="post">
