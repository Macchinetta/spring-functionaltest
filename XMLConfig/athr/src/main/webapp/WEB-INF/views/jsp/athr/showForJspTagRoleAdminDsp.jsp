...
<c:set var="titleKey" value="title.athr.showForJspTagRoleAdminDsp" />
...
<div id="wrapper">
    ...
    <table class="table table-bordered table-condensed">
      <tr>
        ...
        <td><span id="staffRole"> <sec:authorize
              url="/jsp/0201/002/afterLogin/admin/menu">
  ...
  <br>
  <form:form action="${pageContext.request.contextPath}/jsp/0201/002/logout" method="post">
