...
@Controller
public class ATHR_Thymeleaf_07Controller {
    @GetMapping("0701/001")
    public String handle0701001() {
        return "thymeleaf/athr/loginForCustomizedAuthorizeErrorForAuthenticated";
    }
    ...
    public String handle0701001afterLogin(Principal principal, Model model) {
        ...
        return "thymeleaf/athr/showCustomizedAuthorizeErrorForAuthenticated";
    }
