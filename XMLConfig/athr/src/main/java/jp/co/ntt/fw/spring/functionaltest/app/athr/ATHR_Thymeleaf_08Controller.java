...
@Controller
public class ATHR_Thymeleaf_08Controller {
    @GetMapping("0802/001")
    public String handle0801001() {
        return "thymeleaf/athr/loginForCustomizedAuthorizeErrorForUnAuthenticated";
    }
    ...
    public String handle0801001afterLogin(Principal principal, Model model) {
        ...
        return "thymeleaf/athr/showForCustomizedAutnenticateErrorForUnAuthenticated";
    }
