...
<div id="wrapper">
  ...
  <br>
  <form action="${pageContext.request.contextPath}/jsp/getdate" class="form-horizontal"
    method="get">
    <fieldset>
  ...
  <br />
  <form:form action="${pageContext.request.contextPath}/jsp/getdate" cssClass="form-horizontal"
