 ...
 */
@RequestMapping("thymeleaf/0801")
@Controller
public class FLUP_Thymeleaf_0801Controller {
    ...
    public String handle001Form() {
        return "thymeleaf/flup/directFileUploadForm";
    }
    ...
    public String handle001Upload(@Validated({
        ...
        return "redirect:/thymeleaf/0801/001?complete";
    }

    @GetMapping(value = "001", params = "complete")
    public String handleComplete() {
        return "thymeleaf/flup/directFileUploadComplete";
    }
