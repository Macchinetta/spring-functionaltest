...
<Context>
    ...
    <Loader className="org.apache.catalina.loader.VirtualWebappLoader"
        virtualClasspath="${VM_TOMCAT_ENV_JAR_DIR!'/opt/tomcat/tomcat/webapps-env-jars/spring-functionaltest-env-tomcat-postgresql'}/*.jar" />
