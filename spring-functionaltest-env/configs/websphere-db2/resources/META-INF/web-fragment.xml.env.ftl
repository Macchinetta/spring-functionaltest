...
<web-fragment xmlns="http://java.sun.com/xml/ns/javaee" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    xmlns:webfragment="http://java.sun.com/xml/ns/javaee/web-fragment_3_0.xsd" xsi:schemaLocation="http://java.sun.com/xml/ns/javaee http://java.sun.com/xml/ns/javaee/web-fragment_3_0.xsd"
    version="3.0">
    ...
    <servlet>
        ...
        <init-param>
            ...
            <!-- bean定義をオーバーライドするため、spring-mvc.xml - spring-mvc-websphere-db2.xml の順にApplicationContextを読み込む -->
            <param-value>classpath*:META-INF/spring/spring-mvc.xml,classpath*:META-INF/spring/spring-mvc-websphere-db2.xml</param-value>
        </init-param>
