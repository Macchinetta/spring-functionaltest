...
<web-fragment xmlns="http://java.sun.com/xml/ns/javaee" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <servlet>
    ...
    <init-param>
      ...
      <!-- bean定義をオーバーライドするため、spring-mvc.xml - spring-mvc-webspheretr-db2.xml の順にApplicationContextを読み込む -->
      <param-value>classpath*:META-INF/spring/spring-mvc.xml,classpath*:META-INF/spring/spring-mvc-webspheretr-db2.xml</param-value>
    </init-param>
