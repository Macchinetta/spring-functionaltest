...
import jp.co.ntt.fw.spring.functionaltest.domain.service.msmn.MsmnUserService;

@Controller
@RequestMapping("msmn/02")
public class MSMN02Controller {

    @Inject
    private MsmnUserService userService;
    ...
    public String msmn0205001(Model model) {
        ...
        return "msmn/resultMessages";
    }

    @GetMapping(value = {"06"})
    public String msmn0206(Model model) {
        return "msmn/exception";
    }
