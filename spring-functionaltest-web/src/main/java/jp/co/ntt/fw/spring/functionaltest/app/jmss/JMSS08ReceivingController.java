...
public class JMSS08ReceivingController {
    ...
    public String receiveMessageCatchBusinessErr(Model model, JmsReceivingForm form,
            RedirectAttributes attrs) throws InterruptedException, IOException, JMSException {
    ...
    public String receiveMessageCatchBusinessErrSetQueue(Model model, JmsReceivingForm form,
            RedirectAttributes attrs) throws InterruptedException, IOException, JMSException {

        JmsTodo jmsTodo = receivemessageHelper.receiveMessagesForJmsTodo(form.getJmsTodoId());
        if (jmsTodo != null) {
            model.addAttribute("uniqueIdentifier", "BusinessException! :" + form.getJmsTodoId());
        }
        return "jmss/jmsReceive";
    }
}
