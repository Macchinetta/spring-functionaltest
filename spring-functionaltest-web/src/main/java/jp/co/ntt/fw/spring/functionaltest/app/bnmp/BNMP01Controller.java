...
public class BNMP01Controller {
    ...
    @RequestMapping(value = "0104/007", method = RequestMethod.GET)
    public String handle04007(Model model,
            CarSameNameFieldOneWayMappingDefinedFieldTagForm form) {
        return "bnmp/unidirectionalSameNameFieldMappingDefinedFieldTagCreate";
    }
    ...
    public String handle06001(Model model, AccountForm form) {
        model.addAttribute("destinationList", beanMappingHelper
    ...
    @RequestMapping(value = "sameNameDifferenceTypeMapping", method = RequestMethod.POST, params = "copySameNameDifferenceTypeBean")
    public String handleSameNameDifferenceTypeMapping(Model model,
            BeanMapperForm form) {

        // コピー元Bean作成後フィールドに値を設定し、Mapperを使用してコピー先Beanを新規作成する
        SameNameDifferenceTypeDto destinationBean = beanMapper.map(form,
                SameNameDifferenceTypeDto.class);
    ...
    @RequestMapping(value = "unidirectionalBidirectionalMapping", method = RequestMethod.POST, params = "copyUnidirectionalBean")
    ...
    @RequestMapping(value = "unidirectionalBidirectionalMapping/unidirectional", method = RequestMethod.GET, params = "complete")
    ...
    @RequestMapping(value = "unidirectionalBidirectionalMapping/car/{carId}", method = RequestMethod.GET, params = "unidirectional")
    ...
    @RequestMapping(value = "unidirectionalBidirectionalMapping", method = RequestMethod.POST, params = "copyBidirectionalBean")
    ...
    @RequestMapping(value = "unidirectionalBidirectionalMapping/bidirectional", method = RequestMethod.GET, params = "complete")
    ...
    @RequestMapping(value = "unidirectionalBidirectionalMapping/car/{carId}", method = RequestMethod.GET, params = "bidirectional")
    ...
    public String handleUnidirectionalClassBaseMappingCarDetail(Model model,
        ...
        CarUnidirectionalDto destinationBean = carService
                .getCarWithUnidirectionalDto(carId);
        // Dozerのバグのため、コピー先Beanからコピー元Beanへ、フィールドの値がコピーされる。
    ...
    @RequestMapping(value = "unidirectionalSameNameFieldMappingDefinedFieldTag", method = RequestMethod.POST, params = "copyUnidirectionalBean")
    public String handleUnidirectionalSameNameFieldMappingDefinedFieldTagCarCreate(
            CarSameNameFieldOneWayMappingDefinedFieldTagForm form,
            RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/bnmp/unidirectionalSameNameFieldMappingDefinedFieldTag/unidirectional?complete";
    }

    @RequestMapping(value = "unidirectionalSameNameFieldMappingDefinedFieldTag/unidirectional", method = RequestMethod.GET, params = "complete")
    public String handleUnidirectionalSameNameFieldMappingDefinedFieldTagCarCreateComplete(
            Model model) {
        ResultMessages messages = ResultMessages.info().add("i.sf.bnmp.0001");
        model.addAttribute(messages);
        return "bnmp/unidirectionalSameNameFieldMappingDefinedFieldTagComplete";
    }

    @RequestMapping(value = "unidirectionalSameNameFieldMappingDefinedFieldTag/car/{carId}", method = RequestMethod.GET, params = "unidirectional")
    public String handleUnidirectionalSameNameFieldMappingDefinedFieldTagCarDetail(
            Model model, @PathVariable("carId") String carId) {
        ...
        CarUnidirectionalDto destinationBean = carService
                .getCarWithUnidirectionalDto(carId);
        // コピー先Beanからコピー元Beanへ、フィールドの値がコピーされないこと。
        CarSameNameFieldOneWayMappingDefinedFieldTagForm carForm = beanMapper
                .map(destinationBean,
                        CarSameNameFieldOneWayMappingDefinedFieldTagForm.class);

        model.addAttribute(carForm);

        return "bnmp/unidirectionalSameNameFieldMappingDefinedFieldTagDetail";
    }
    ...
    public String handleNestedFieldMapping(Model model, BeanMapperForm form) {
        ...
        // コピー元Bean作成後フィールドに値を設定し、Mapperを使用してコピー先Beanを新規作成する
        NestedFieldMapperDto destinationBean = beanMapper.map(form,
                NestedFieldMapperDto.class);
    ...
    @RequestMapping(value = "collectionTypeFieldMapping", method = RequestMethod.POST, params = "copySameFieldCumulativeListToListSameType")
    public String handleCollectionTypeFieldSameFieldCumulativeListToListSameTypeMapping(
        ...
        destinationBean.setEmails(beanMappingHelper
                .getDestinationListWithEmailDto());
    ...
    @RequestMapping(value = "collectionTypeFieldMapping", method = RequestMethod.POST, params = "copySameFieldCumulativeListToListDifferenceType")
    public String handleCollectionTypeFieldSameFieldCumulativeListToListDifferenceTypeMapping(
        ...
        destinationBean.setEmails(beanMappingHelper
                .getDestinationListWithMailAddressDto());
    ...
    @RequestMapping(value = "collectionTypeFieldMapping", method = RequestMethod.POST, params = "copySameFieldCumulativeListToSet")
    public String handleCollectionTypeFieldSameFieldCumulativeListToSetMapping(
            Model model, AccountForm form) {

        // コピー元Bean、コピー先Bean作成後フィールドに重複なしで値を設定し、Mapperを使用してコピー元Beanからコピー先Beanへフィールドをコピーする。
        AccountDifferenceCollectionDto destinationBean = new AccountDifferenceCollectionDto();
        destinationBean.setEmails(beanMappingHelper
                .getDestinationSetWithEmailDto());
    ...
    @RequestMapping(value = "collectionTypeFieldMapping", method = RequestMethod.POST, params = "copyDifferenceFieldCumulativeListToListSameType")
    public String handleCollectionTypeFieldDifferenceFieldCumulativeListToListSameTypeMapping(
        ...
        destinationBean.setEmailAddresses(beanMappingHelper
                .getDestinationListWithEmailDto());
    ...
    @RequestMapping(value = "collectionTypeFieldMapping", method = RequestMethod.POST, params = "copyDifferenceFieldCumulativeListToListDifferenceType")
    ...
    @RequestMapping(value = "collectionTypeFieldMapping", method = RequestMethod.POST, params = "copyDifferenceFieldCumulativeListToSet")
    public String handleCollectionTypeFieldDifferenceFieldCumulativeListToSetMapping(
            Model model, AccountForm form) {
    ...
    @RequestMapping(value = "collectionTypeFieldMapping", method = RequestMethod.POST, params = "copySameFieldNonCumulative")
    public String handleCollectionTypeFieldSameFieldNonCumulativeMapping(
            Model model, AccountForm form) {
    ...
    @RequestMapping(value = "collectionTypeFieldMapping", method = RequestMethod.POST, params = "copySameFieldNonCumulativeDeepCopy")
    public String handleCollectionTypeFieldSameFieldNonCumulativeDeepCopyMapping(
            Model model, AccountForm form) {

        // コピー元Bean、コピー先Bean作成後フィールドに重複ありで値を設定し、Mapperを使用してコピー元Beanからコピー先Beanへフィールドをコピーする。
        // コピー先List
        List<EmailDto> desitinationList = beanMappingHelper
                .getDestinationListWithEmailDto();
        ...
        model.addAttribute("resultBean", destinationBean);
        model.addAttribute("collectionRefferenceFormTo",
                isSameCollectionRefferenceFormTo);
        model.addAttribute("collectionRefferenceDestTo",
                isSameCollectionRefferenceDestTo);
    ...
    @RequestMapping(value = "collectionTypeFieldMapping", method = RequestMethod.POST, params = "copySameFieldNonCumulativeShallowCopy")
    public String handleCollectionTypeFieldSameFieldNonCumulativeShallowCopyMapping(
            Model model, AccountForm form) {
    ...
    @RequestMapping(value = "collectionTypeFieldMapping", method = RequestMethod.POST, params = "copyDifferenceFieldNonCumulative")
    public String handleCollectionTypeFieldDifferenceFieldNonCumulativeMapping(
            Model model, AccountForm form) {
    ...
    @RequestMapping(value = "collectionTypeFieldMapping", method = RequestMethod.POST, params = "copyDifferenceFieldNonCumulativeDeepCopy")
    public String handleCollectionTypeFieldDifferenceFieldNonCumulativeDeepCopyMapping(
            Model model, AccountForm form) {
    ...
    @RequestMapping(value = "collectionTypeFieldMapping", method = RequestMethod.POST, params = "copyDifferenceFieldNonCumulativeShallowCopy")
