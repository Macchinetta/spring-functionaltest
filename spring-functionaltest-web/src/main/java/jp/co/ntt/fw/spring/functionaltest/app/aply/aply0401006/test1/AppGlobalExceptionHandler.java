...
public class AppGlobalExceptionHandler {
    ...
    public void initBinder() {
        logger.info("[APLY0401006]AppGlobalExceptionHandler initBinder Method Called");
    }
    ...
    public CommonParameters setUpCommonParameters01(
        ...
        logger.info("[APLY0401006]AppGlobalExceptionHandler setUpCommonParameters01 Method Called");
