...
public class DJPADeliveryOrderController {
    ...
    public String deliveryOrderDetails(
        ...
        List<JPADeliveryOrder> deliveryOrderList = jpaDeliveryOrderService
                .searchUsingStatCode(orderStatus);
    ...
    public String likeSearch(DeliveryOrderStatusForm deliveryOrderStatusForm,
        ...
        List<JPADeliveryOrder> deliveryOrderList = jpaDeliveryOrderService
                .searchUsingGiveSearchType(searchVal, criteria);
        model.addAttribute("deliveryOrders", deliveryOrderList);
        return "djpa/orderList";
    }
    ...
    public String fetchUsingMethodNamingConvention(
        ...
        Page<JPADeliveryOrder> deliveryOrderPage = jpaDeliveryOrderService
                .findByStatusCode(statusCode, pageable);
        model.addAttribute("page", deliveryOrderPage);
        model.addAttribute("isPageable", true);
        model.addAttribute("deliveryOrderStatusForm", deliveryOrderStatusForm);
        return "djpa/orderList";
    ...
    public String fetchUsingNativeQuery(
            DeliveryOrderStatusForm deliveryOrderStatusForm, Model model) {
        String statusCode = deliveryOrderStatusForm.getDelOrderStatus();
        List<JPADeliveryOrder> deliveryOrderPage = jpaDeliveryOrderService
                .findUsingNativeQuery(statusCode);
    ...
    public String fetchUsingDynamicParam(
        ...
        deliveryOrderCriteria.setDeliveryNumber(deliveryOrderStatusForm
                .getDeliverNumber());
        deliveryOrderCriteria.setDeliveryType(deliveryOrderStatusForm
                .getDeliveryType());

        List<JPADeliveryOrder> deliveryOrderList = jpaDeliveryOrderService
                .searchUsingDynamicCond(deliveryOrderCriteria);
        model.addAttribute("deliveryOrders", deliveryOrderList);
        model.addAttribute("deliveryOrderStatusForm", deliveryOrderStatusForm);
        return "djpa/orderList";
    }
    ...
    public String registerOrder(DeliveryOrderStatusForm form,
        ...
        redirectAttrs.addFlashAttribute("id", jpaDeliveryOrder
                .getDeliverNumber());
