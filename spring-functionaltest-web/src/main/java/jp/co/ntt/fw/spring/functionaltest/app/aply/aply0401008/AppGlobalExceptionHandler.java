...
public class AppGlobalExceptionHandler {
    ...
    public void initBinder() {
        logger.info("[APLY0401008]AppGlobalExceptionHandler initBinder Method Called");
    }
    ...
    public CommonParameters setUpCommonParameters01(@RequestParam(value = "commonParam1",
        ...
        logger.info("[APLY0401008]AppGlobalExceptionHandler setUpCommonParameters01 Method Called");
