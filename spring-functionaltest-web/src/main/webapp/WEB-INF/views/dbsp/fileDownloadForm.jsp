<div id="wrapper">
    ...
    <form:form method="POST" action="${pageContext.request.contextPath}/dbsp/0301/005" modelAttribute="downloadForm" cssClass="form-horizontal">
        <fieldset>
            ...
            <div class="form-group">
                <div class="col col-md-10 col-md-offset-2">
                    <input type="submit" id="downloadButton" name="file" value="ダウンロード" class="btn btn-default" />
                </div>
            </div>
            <div class="form-group">
                <div class="col col-md-10 col-md-offset-2">
                    <input type="submit" id="fourth" name="fourth" value="第四画面へ" class="btn btn-default" />
                </div>
            </div>
        </fieldset>
    </form:form>
