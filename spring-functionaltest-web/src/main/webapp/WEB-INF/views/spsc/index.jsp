<div id="wrapper">
    ...
    <ul>
        <li><a id="spsc0401001NotSecure" href="${pageContext.request.contextPath}/spsc/0401/001/notsecure/001">spsc0401001(Not Secure)</a></li>
        <li><a id="spsc0401001Secure" href="${pageContext.request.contextPath}/spsc/0401/001/secure/001">spsc0401001(Secure)</a></li>
    </ul>
