<div id="wrapper">
    ...
    <ul>
        <li><a id="SOAP0101001-01"
            href="${pageContext.request.contextPath}/soap/todo/todo/list">TODO一覧取得</a></li>
    </ul>

	<div>[SOAP0102002] エンドポイントを指定したクライアントからSOAP通信を行い、SOAPサーバのWebサービスが実行できることの確認</div>
    <ul>
        <li><a id="SOAP0102002-01"
            href="${pageContext.request.contextPath}/soap/todo/wsdl/list">TODO一覧取得</a></li>
    </ul>
    ...
    <ul>
        <li><a id="SOAP0201002-01"
            href="${pageContext.request.contextPath}/soap/todo/todo/create?form">TODO作成</a></li>
        <li><a id="SOAP0201002-02"
            href="${pageContext.request.contextPath}/soap/todo/todo/list">TODO一覧取得</a></li>
        <li><a id="SOAP0201002-03"
            href="${pageContext.request.contextPath}/soap/todo/todo/create?form">TODO作成</a></li>
        <li><a id="SOAP0201002-04"
            href="${pageContext.request.contextPath}/soap/todo/todo/list">TODO一覧取得</a></li>
    </ul>
    ...
    <ul>
        ...
        <li><a id="SOAP0201003-03"
            href="${pageContext.request.contextPath}/soap/todo/todo/list">TODO一覧取得</a></li>
        <li><a id="SOAP0201003-04"
            href="${pageContext.request.contextPath}/soap/todo/todo/update?form">TODO更新</a></li>
        <li><a id="SOAP0201003-05"
            href="${pageContext.request.contextPath}/soap/todo/todo/list">TODO一覧取得</a></li>
    </ul>
    ...
    <ul>
        <li><a id="SOAP0201004-01"
            href="${pageContext.request.contextPath}/soap/todo/todo/create?form">TODO作成</a></li>
        <li><a id="SOAP0201004-02"
            href="${pageContext.request.contextPath}/soap/todo/todo/list">TODO一覧取得</a></li>
        <li><a id="SOAP0201004-03"
            href="${pageContext.request.contextPath}/soap/todo/todo/update?form">TODO更新</a></li>
        <li><a id="SOAP0201004-04"
            href="${pageContext.request.contextPath}/soap/todo/todo/list">TODO一覧取得</a></li>
    </ul>
	...
	<div>[SOAP0701001] クライアントで設定した時間でSOAPサーバへのリクエストタイムアウトになることを確認する</div>
    <ul>
    ...
    <ul>
        <li><a id="deleteTodos"
            href="${pageContext.request.contextPath}/soap/todo/todo/deleteAll">TODO全削除</a></li>
    </ul>
