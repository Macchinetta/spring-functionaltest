...
<div class="text-center">
    <form:form action="${pageContext.request.contextPath}/pgnt/${f:hjs(path)}" method="get" modelAttribute="celebritySearchCriteria">
        <fieldset>
...
<c:if test="${page != null}">
    <div class="text-center">
        <t:pagination page="${page}" outerElementClass="pagination" queryTmpl="page={page}&size={size}&${f:query(celebritySearchCriteria)}" />
    </div>
    ...
    <c:if test="${page.totalElements != 0}">
        <div class="text-center">${f:h(page.number + 1) }&nbsp;/&nbsp;${f:h(page.totalPages)}&nbsp;Pages</div>
    </c:if>
</c:if>
