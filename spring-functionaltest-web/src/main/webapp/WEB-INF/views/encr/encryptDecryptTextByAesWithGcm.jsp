<div id="wrapper">
    ...
    <br />
    <t:messagesPanel />
    <form:form action="${pageContext.request.contextPath}/encr/0104/001/encryptDecryptTextByAesWithGcm" cssClass="form-horizontal" method="post" modelAttribute="encryptionDataForm">
        <legend>暗復号</legend>
