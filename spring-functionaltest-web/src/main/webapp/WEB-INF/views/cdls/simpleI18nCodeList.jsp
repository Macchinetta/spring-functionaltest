<div id="wrapper">
    ...
    <div>CDLS0105003</div>
    <div>
        <form:form modelAttribute="clI18nPriceForm" method="post" action="${pageContext.request.contextPath}/cdls/0105/003">
    ...
    <div>CDLS0105004</div>
    <div>
        <form:form modelAttribute="clI18nPriceForm" method="post" action="${pageContext.request.contextPath}/cdls/0105/004">
    ...
    <div>CDLS0105007</div>
    <div>
        <form:form modelAttribute="clI18nDBPriceForm" method="post" action="${pageContext.request.contextPath}/cdls/0105/007">
    ...
    <div>CDLS0105008</div>
    <div>
        <form:form modelAttribute="clI18nDBPriceForm" method="post" action="${pageContext.request.contextPath}/cdls/0105/008">
