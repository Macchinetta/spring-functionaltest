<div id="wrapper">
    ...
    <div>CDLS0403002</div>
    <div>
        <form:select id="cdls0403002" items="${CL_NUMBER_WITHIN_RANGE_INTERVAL}" path="codeListForm.code" />
    </div>
    <div>CDLS0403003</div>
    <div>
        <form:select id="cdls0403003" items="${CL_NUMBER_WITHOUT_RANGE_INTERVAL}" path="codeListForm.code" />
    </div>
</div>
