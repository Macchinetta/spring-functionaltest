<div id="wrapper">
  ...
  <div>
    <c:if test="${!empty enumOrderStatusCodeList}">
      <form:select id="cdls0104002" items="${enumOrderStatusCodeList.asMap()}"
  ...
  <div>
    <c:if test="${!empty CL_ORDERSTATUS}">
      <form:form action="${pageContext.request.contextPath}/cdls/0107/001?post" method="post"
  ...
  <div>
    <c:if test="${!empty CL_ORDERSTATUS}">
      <form:form action="${pageContext.request.contextPath}/cdls/0107/002?post" method="post"
        modelAttribute="orderStatusForm">
