<div id="wrapper">
    ...
    <form:form method="POST"
        action="${pageContext.request.contextPath}/emal/sendmail"
        modelAttribute="emailSendingForm" enctype="multipart/form-data"
        cssClass="form-horizontal">
        <fieldset>
            <legend>メール送信</legend>
            <div class="form-group">
                <div class="col col-md-2">To</div>
                <c:forEach items="${emailSendingForm.to}" var="v"
                    varStatus="s">
                    <div class="col col-md-3">
                        <form:input path="to[${s.index}]"
                            cssClass="quantity form-control input-sm" />
                    </div>
                </c:forEach>
            </div>
            <div class="form-group">
                <div class="col col-md-2">Cc</div>
                <c:forEach items="${emailSendingForm.cc}" var="v"
                    varStatus="s">
                    <div class="col col-md-3">
                        <form:input path="cc[${s.index}]"
                            cssClass="quantity form-control input-sm" />
                    </div>
                </c:forEach>
            </div>
            <div class="form-group">
                ...
                <c:forEach items="${emailSendingForm.bcc}" var="v"
                    varStatus="s">
                    <div class="col col-md-3">
                        <form:input path="bcc[${s.index}]"
                            cssClass="quantity form-control input-sm" />
                    </div>
                </c:forEach>
            </div>
            <div class="form-group">
                ...
                <c:if
                    test="${emailSendingForm.testcase == 'allProperties'}">
                    <div class="col col-md-3">
            ...
            <div class="form-group">
                ...
                <c:if
                    test="${emailSendingForm.testcase == 'inlineMimeMessage'}">
                    <div class="col col-md-3">
                        <form:input path="cid"
                            cssClass="quantity form-control input-sm" />
                    </div>
            ...
            <div class="form-group">
                <button id="sendMail" name="sendMail"
                    class="btn btn-default">メール送信</button>
            </div>
        </fieldset>
    </form:form>
    <br />
