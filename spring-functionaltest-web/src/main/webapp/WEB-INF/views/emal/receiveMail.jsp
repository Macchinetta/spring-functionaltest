<div id="wrapper">
    ...
    <form:form method="POST"
        action="${pageContext.request.contextPath}/emal/receivemail"
        ...
        <fieldset>
            ...
            <div class="form-group">
                <button id="receiveMail" name="receiveMail"
                    class="btn btn-default">メール受信</button>
            </div>
        </fieldset>
    </form:form>
    <br>
        ...
        <fieldset>
            <table
                ...
                <tr>
                    ...
                    <td class="col col-xs-3 col-sm-3 col-md-3 col-g-3"><span
                        id="attachment"> ${f:h(mail.attachment)}
                    </span></td>
                </tr>
                <tr>
                    <th class="col col-xs-2 col-sm-2 col-md-2 col-g-2">Inline</th>
                    <td class="col col-xs-3 col-sm-3 col-md-3 col-g-3"><span
                        id="inline"> ${f:h(mail.inline)} </span></td>
                </tr>
            </table>
        </fieldset>
    </c:if>
