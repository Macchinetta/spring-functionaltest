    ...
    <body>
        ...
        <form:form action="${pageContext.request.contextPath}/vldt/0501/001" method="post" modelAttribute="existInCheckDefaultForm">
            <table>
                <tr>
                    <td>
                        <span id="errors"><form:errors path="key" style="color: red" /></span>
                    </td>
                </tr>
            </table>
            <table>
                ...
                <tr>
                    <td><input id="btn1" class="mainbtn" style="width: 200px" type="submit" value="Confirm" name="existInCheckString" /></td>
                    <td></td>
                </tr>
            </table>
        </form:form>
