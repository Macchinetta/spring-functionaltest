...
<c:set var="titleKey" value="title.vldt.nestedValidationView" />
...
<div id="wrapper">
  ...
  <form:form method="post" action="${pageContext.request.contextPath}/vldt/0102/001"
    modelAttribute="nestedValidationForm" class="form-horizontal">

    <div class="form-group">
      <form:label path="reciverAddress.userName" class="col-sm-2 control-label">UserName</form:label>
      <div class="col-sm-10">
        <form:input path="reciverAddress.userName" class="form-control" placeholder="UserName" />
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <form:input path="reciverAddress.postCode" class="form-control" placeholder="PostCode" />
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <form:input path="reciverAddress.address" class="form-control" placeholder="Address" />
