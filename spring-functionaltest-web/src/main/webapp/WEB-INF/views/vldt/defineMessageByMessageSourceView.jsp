...
<c:set var="titleKey" value="title.vldt.defineMessageByMessageSourceView" />
...
<div id="wrapper">
  ...
  <form:form method="post" action="${pageContext.request.contextPath}/vldt/0302/001"
    modelAttribute="defineMessageByMessageSourceForm" class="form-horizontal">
