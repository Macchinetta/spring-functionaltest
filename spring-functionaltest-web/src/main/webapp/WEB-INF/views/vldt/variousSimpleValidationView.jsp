<div id="wrapper">
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/vldt/0101/006" modelAttribute="variousSimpleValidationBVForm" class="form-horizontal">
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/vldt/0101/006" modelAttribute="variousSimpleValidationHVForm" class="form-horizontal">
        <div class="form-group">
