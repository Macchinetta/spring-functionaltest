<div id="wrapper">
    ...
    <form:form method="post"
        action="${pageContext.request.contextPath}/vldt/0101/006"
        modelAttribute="variousSimpleValidationForm"
...
<%--                     placeholder="NotNull" /> --%>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="nullvalue" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="decimalmin" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="decimalmax" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="digits" class="form-control"
                    placeholder="Digits" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="future" class="form-control"
                    placeholder="Future" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="notblank" class="form-control"
                    placeholder="NotBlank" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="notempty" class="form-control"
