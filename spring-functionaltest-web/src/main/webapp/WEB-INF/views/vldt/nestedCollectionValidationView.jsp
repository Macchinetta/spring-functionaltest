<div id="wrapper">
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/vldt/0102/002" modelAttribute="nestedCollectionValidationForm" class="form-horizontal">
        ...
        <c:forEach items="${ nestedCollectionValidationForm.addresses }" varStatus="status">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <form:input path="addresses[${ status.index }].userName" class="form-control" placeholder="UserName" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <form:input path="addresses[${ status.index }].postCode" class="form-control" placeholder="PostCode" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <form:input path="addresses[${ status.index }].address" class="form-control" placeholder="Address" />
