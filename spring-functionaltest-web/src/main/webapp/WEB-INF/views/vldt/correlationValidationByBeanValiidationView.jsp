...
<c:set var="titleKey" value="title.vldt.correlationValidationByBeanValiidationView" />
...
<div id="wrapper">
  ...
  <form:form method="post" action="${pageContext.request.contextPath}/vldt/0202/001"
    modelAttribute="confirmForm" class="form-horizontal">
