<div id="wrapper">
    ...
    <form:form method="post"
        action="${pageContext.request.contextPath}/vldt/0201/002"
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <form:button id="validateUser" name="validateUser"
                    class="btn btn-default">validateUser</form:button>
            </div>
        </div>
    ...
    <form:form method="post"
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <form:button id="validateUserDetails" name="validateUserDetails"
                    class="btn btn-default">validateUserDetails</form:button>
            </div>
        </div>
