...
<c:set var="titleKey" value="title.vldt.correlationValidationByUsingCompareView" />
...
<div id="wrapper">
  ...
  <form:form method="post" action="${pageContext.request.contextPath}/vldt/0801/001"
    modelAttribute="confirmFormUsingCompare" class="form-horizontal">
