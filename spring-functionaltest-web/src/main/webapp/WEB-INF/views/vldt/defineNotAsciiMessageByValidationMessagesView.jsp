<div id="wrapper">
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/vldt/0304/001" modelAttribute="defineNotAsciiMessageByValidationMessagesForm" class="form-horizontal">
