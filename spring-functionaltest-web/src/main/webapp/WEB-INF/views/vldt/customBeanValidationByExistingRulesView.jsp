<div id="wrapper">
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/vldt/0401/001" modelAttribute="customBeanValidationByExistingRulesForm" class="form-horizontal">
