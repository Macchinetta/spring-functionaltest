...
<c:set var="titleKey" value="title.vldt.simpleValidationByHibernateValidatorView" />
...
<div id="wrapper">
  ...
  <form:form method="post" action="${pageContext.request.contextPath}/vldt/0101/002"
    modelAttribute="simpleValidationByHibernateValidatorForm" class="form-horizontal">
