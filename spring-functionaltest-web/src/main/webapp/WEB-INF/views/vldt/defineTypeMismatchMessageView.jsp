<div id="wrapper">
    ...
    <form:form method="post"
        action="${pageContext.request.contextPath}/vldt/0303/001"
        modelAttribute="defineTypeMismatchMessageForm"
        class="form-horizontal">

        <div class="form-group">
            <form:label path="shortValue" class="col-sm-2 control-label">ShortValue</form:label>
            <div class="col-sm-10">
                <form:input path="shortValue" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="intValue" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="longValue" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="doubleValue" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="shortObject" class="form-control"
                    placeholder="ShortObject" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="integerObject" class="form-control"
                    placeholder="IntegerObject" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="longObject" class="form-control"
                    placeholder="LongObject" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="floatObject" class="form-control"
                    placeholder="FloatObject" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="doubleObject" class="form-control"
                    placeholder="DoubleObject" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="localdate" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <form:input path="booleanValue" class="form-control"
