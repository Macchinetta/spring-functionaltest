<div id="wrapper">
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/vldt/0402/001" modelAttribute="customBeanValidationByOriginalRulesForm" class="form-horizontal">
