<div id="wrapper">
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/vldt/0103/003/authentication" class="form-horizontal">
        <c:if test="${param.containsKey('error')}">
            <span id="accountLoginError"> <t:messagesPanel messagesAttributeName="SPRING_SECURITY_LAST_EXCEPTION" /> </span>
        </c:if>
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/vldt/0103/003/logout" class="form-horizontal">
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/vldt/0103/003" modelAttribute="authorizedValidationForm" class="form-horizontal">
        <div class="form-group">
