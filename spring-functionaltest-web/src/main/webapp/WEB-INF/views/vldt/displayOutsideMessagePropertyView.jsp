...
<c:set var="titleKey" value="title.vldt.displayOutsideMessagePropertyView" />
...
<div id="wrapper">
  ...
  <div class="form-group">
    <spring:nestedPath path="displayOutsideMessagePropertyForm">
      <form:errors path="age" class="text-danger" />
    </spring:nestedPath>
  </div>

  <form:form method="post" action="${pageContext.request.contextPath}/vldt/0101/005"
    modelAttribute="displayOutsideMessagePropertyForm" class="form-horizontal">
