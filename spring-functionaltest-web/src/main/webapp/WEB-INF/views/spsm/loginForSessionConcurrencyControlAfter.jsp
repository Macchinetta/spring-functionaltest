...
<c:set var="titleKey" value="title.spsm.loginForSessionConcurrencyControlAfter" />
...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/spsm/0501/001/authenticate"
  ...
  <form:form action="${pageContext.request.contextPath}/spsm/0501/001/logout"
    cssClass="form-horizontal" method="post">
    <div class="form-group">
