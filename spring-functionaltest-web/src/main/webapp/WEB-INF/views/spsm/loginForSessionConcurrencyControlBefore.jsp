...
<c:set var="titleKey" value="title.spsm.loginForSessionConcurrencyControlBefore" />
...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/spsm/0501/002/authenticate"
