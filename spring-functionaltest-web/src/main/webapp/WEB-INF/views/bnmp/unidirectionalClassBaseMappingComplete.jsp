<div id="wrapper">
    ...
    <div class="form-group">
        <a id="copyUnidirectionalBean" href="${pageContext.request.contextPath}/bnmp/unidirectionalClassBaseMapping/car/${f:h(car.carId)}?unidirectional" class="btn btn-default">詳細(単方向Bean)</a>
    </div>
</div>
