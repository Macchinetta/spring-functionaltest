<div id="wrapper">
  ...
  <br>
  <form:form action="${pageContext.request.contextPath}/bnmp/unidirectionalSameNameFieldMappingDefinedFieldTag"
    cssClass="form-horizontal" method="post" modelAttribute="carSameNameFieldOneWayMappingDefinedFieldTagForm">
    <legend>車情報登録</legend>
