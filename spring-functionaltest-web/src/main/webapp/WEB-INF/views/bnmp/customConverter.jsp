<div id="wrapper">
    ...
    <br>
    <form:form
        action="${pageContext.request.contextPath}/bnmp/customConverter"
        cssClass="form-horizontal" method="post"
        modelAttribute="customConverterForm">
        ...
        <div class="form-group">
            <form:button name="copyWithCustomConverter"
                class="btn btn-default">カスタムコンバーター使用してコピー</form:button>
        </div>
    </form:form>
</div>