<div id="wrapper">
  <table class="table table-striped table-bordered table-condensed">
    ...
    <tr>
      ...
      <td><span id="getBirthDateLocalDate">${f:h(resultBean.birthDateLocalDate)}</span></td>
    </tr>
    <tr>
      <th class="inputColumn">Birth Date LocalTime</th>
      <td><span id="getBirthDateLocalTime">${f:h(resultBean.birthDateLocalTime)}</span></td>
    </tr>
    <tr>
      <th class="inputColumn">Birth Date LocalDateTime</th>
      <td><span id="getBirthDateLocalDateTime">${f:h(resultBean.birthDateLocalDateTime)}</span></td>
    </tr>
    <tr>
      <th class="inputColumn">Birth Date OffsetTime</th>
      <td><span id="getBirthDateOffsetTime">${f:h(resultBean.birthDateOffsetTime)}</span></td>
    </tr>
    <tr>
      <th class="inputColumn">Birth Date OffsetDateTime</th>
      <td><span id="getBirthDateOffsetDateTime">${f:h(resultBean.birthDateOffsetDateTime)}</span></td>
    </tr>
    <tr>
      <th class="inputColumn">Birth Date ZonedDateTime</th>
      <td><span id="getBirthDateZonedDateTime">${f:h(resultBean.birthDateZonedDateTime)}</span></td>
    </tr>
  </table>
</div>