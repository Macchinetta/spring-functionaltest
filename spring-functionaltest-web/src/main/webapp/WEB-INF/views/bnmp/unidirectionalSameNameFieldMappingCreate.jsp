<div id="wrapper">
    ...
    <br />
    <form:form action="${pageContext.request.contextPath}/bnmp/unidirectionalSameNameFieldMapping" cssClass="form-horizontal" method="post" modelAttribute="carSameNameFieldOneWayMappingForm">
        <legend>車情報登録</legend>
