<div id="wrapper">
    ...
    <br />
    <form:form action="${pageContext.request.contextPath}/bnmp/unidirectionalClassBaseMapping" cssClass="form-horizontal" method="post" modelAttribute="carClassBaseOneWayMappingForm">
        <legend>車情報登録</legend>
