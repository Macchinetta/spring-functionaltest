<div id="wrapper">
  ...
  <br>
  <form:form action="${pageContext.request.contextPath}/bnmp/beanMappingExtention"
    cssClass="form-horizontal" method="post" modelAttribute="excludeSpecifiedFieldForm">
