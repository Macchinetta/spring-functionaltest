<div id="wrapper">
    ...
    <br />
    <form:form action="${pageContext.request.contextPath}/bnmp/beanMappingExtention" cssClass="form-horizontal" method="post" modelAttribute="excludeSpecifiedFieldForm">
        ...
        <div class="form-group">
            <div class="col col-md-2">Birth Date(yyyyMMdd)(除外対象)</div>
            <div class="col col-md-3">
