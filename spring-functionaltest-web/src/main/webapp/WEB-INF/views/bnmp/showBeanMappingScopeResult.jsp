<div id="wrapper">
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tr>
            ...
            <td>
                <span id="getBirthDate"><joda:format pattern="yyyyMMdd" value="${resultBean.birthDate}" /></span>
            </td>
        </tr>
    </table>
    <br />
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tr>
            <th class="inputColumn">Birth Date</th>
            <td>
                <span id="getScopedBirthDate"><joda:format pattern="yyyyMMdd" value="${resultScopedBean.birthDate}" /></span>
            </td>
        </tr>
    </table>
</div>
