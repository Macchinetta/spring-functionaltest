<div id="wrapper">
    ...
    <br />
    <form:form action="${pageContext.request.contextPath}/bnmp/nestedFieldMapping" cssClass="form-horizontal" method="post" modelAttribute="beanMapperForm">
        ...
        <div class="form-group">
            <form:button name="copyNestedFieldBean" class="btn btn-default">Nestされたフィールドのコピー</form:button>
        </div>
    </form:form>
</div>
