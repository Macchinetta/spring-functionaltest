<div id="wrapper">
    ...
    <br />
    <form:form action="${pageContext.request.contextPath}/bnmp/excludeNullEmptyMapping" cssClass="form-horizontal" method="post" modelAttribute="excludeNullEmptyForm">
