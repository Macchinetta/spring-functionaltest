<div id="wrapper">
    ...
    <ul>
        ...
        <li><a id="tllyLink" href="${pageContext.request.contextPath}/tlly/">[TLLY] Tilesによる画面レイアウト 機能テスト</a></li>
        ...
        <li><a id="bnmpLink" href="${pageContext.request.contextPath}/bnmp/">[BNMP] Beanマッピング(Dozer)機能テスト</a></li>
        ...
        <li><a id="oth2Link" href="${pageContext.request.contextPath}/oth2/">[OTH2] OAuth2テスト（Spring Security）</a></li>
        ...
        <li><a id="msmnLink" href="${pageContext.request.contextPath}/msmn/">[MSMN] メッセージ管理</a></li>
        <li><a id="sydtLink" href="${pageContext.request.contextPath}/sydt/">[SYDT] システム時刻</a></li>
    </ul>
</div>
