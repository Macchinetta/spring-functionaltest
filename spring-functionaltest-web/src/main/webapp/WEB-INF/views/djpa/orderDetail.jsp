<div class="row">
	...
	<table class="table table-striped table-bordered table-condensed">
	 <thead>
			...
			<tr>
				...
				<c:choose>
                		<c:when test="${orderForm.logicalDelete}"><c:set var="canDelete" value="Yes"></c:set></c:when>
        ...
        <c:forEach items="${orderForm.orderItem}" var="order" varStatus="rowStatus">
        	<tr>
            	...
            	<td id="itNum_${rowStatus.count}"><a id="item${f:h(rowStatus.count)}" href="${pageContext.request.contextPath}/djpa/order/${orderForm.orderId }/item/${f:h(order.itemNumber)}/detail">${f:h(order.itemNumber)}</a></td>
   ...
   <table class="table table-striped table-bordered table-condensed">
            ...
            action="${pageContext.request.contextPath}/djpa/order/${orderForm.orderId }/addUpdt" method="get">
				<thead>
					<tr>
                	<th>
                		<form:button name="add" class="btn btn-default btn-right">Add/Update Item</form:button>
                	</th>
                	</tr>
				</thead>
			</form:form>
		 ...
		 <table class="table table-striped table-bordered table-condensed">
			<form:form modelAttribute="orderForm"
            action="${pageContext.request.contextPath}/djpa/order/${orderForm.orderId }/update" method="post">
				<thead>
                	<tr>
                	<th><form:input path="orderStatus.statusName" value="" />
                	<form:button name="updateStatus" class="btn btn-default btn-right">Update Order Status</form:button></th>
					</tr>
					<tr></tr>
					<tr>
