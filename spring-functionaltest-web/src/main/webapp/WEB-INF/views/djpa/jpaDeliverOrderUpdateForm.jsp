<form:form modelAttribute="deliveryOrderStatusForm" 
    action="${pageContext.request.contextPath}/djpa/delivery/order/${delOrder.deliverNumber}/update">
    <fieldset>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form:input path="deliveryType" class="form-control"
                        value="${f:h(delOrder.deliveryType)}" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form:input path="receiverName" class="form-control"
                        value="${f:h(delOrder.receiverName)}" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <fmt:formatDate value="${delOrder.acceptDateTime}"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <fmt:formatDate value="${delOrder.completionDateTime}"
                        pattern="yyyy/MM/dd" var="releaseDate" />
