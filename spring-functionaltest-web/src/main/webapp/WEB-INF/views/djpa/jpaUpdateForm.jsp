<form:form modelAttribute="bookForm" action="${pageContext.request.contextPath}/djpa/book/${book.bookId}/update">
    <fieldset>
        <legend>書籍更新</legend>
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form:input path="categoryName" class="form-control" value="${f:h(book.category.categoryName)}" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
