<div class="row">
     ...
     <div>
      <table class="table table-striped table-bordered table-condensed">
        <form:form modelAttribute="jpaBookListForm"
           ...
           <th>  <form:input path="bookIdDelOpnInput"
            ...
            action="${pageContext.request.contextPath}/djpa/book/existence" method="get">
            	...
            	<tr>
            		...
            		<th><form:button name="check" class="btn btn-default btn-right">Is Book Present</form:button></th>
                		<c:choose>
                			<c:when test="${isBookPresent }"><th id="existResult" style="background-color: green;">Book Available!!</th></c:when>
                			<c:when test="${!empty isBookPresent && !isBookPresent }"><th id="existResult" style="background-color: red;">Book Not Available!!</th></c:when>
                		</c:choose>
                	</tr>
                	<tr>
                	<th><form:button name="count" class="btn btn-default btn-right">Get Book Count</form:button></th>
                	<c:choose>
					<c:when test="${!empty bookCount && null ne bookCount }"><th>No.of Books :</th><th id="bookQty" style="background-color: grey;">${bookCount }</th></c:when>
					</c:choose>
                	<tr>
               </form:form>
             </table>
    ...
    <legend>Sorting</legend>
        ...
        <tr>
        	<th>List Books in Sorted Order By : <form:select 
                path="searchOrderBy">
             ...
             <form:button name="sort" class="btn btn-default">Sort Books</form:button>
        	</th>
        </tr>
        </form:form>
        </table>
            ...
            <tr>
               ...
               <td class="bookId"><a
                ...
                <td class="price" id="price"><fmt:formatNumber
                        value="${book.price}" pattern="###,###" /></td>
                <td class="releaseDate" id="releaseDate"><fmt:formatDate
                        value="${book.releaseDate}" pattern="yyyy/MM/dd" /></td>
            </tr>
        </c:forEach>
    ...
    <form:form modelAttribute="jpaBookListForm"
        ...
        <fieldset>
            ...
            <table>
            	<tr>
            		<th class="title">書籍ID</th>
           <th>  <form:input path="searchInQueryBookIdIntercept"
                class="form-control form-input"
                value="${f:h(bookListForm.searchInQueryBookIdIntercept)}" /></th>
            <th><form:button name="lazyLoadIntercept"
                class="btn btn-default btn-right">Fetch</form:button></th>
                </table>
        </fieldset>
    </form:form>
    <br>
    <form:form modelAttribute="jpaBookListForm"
        ...
        <fieldset>
            ...
            <table>
            	<tr>
            		<th class="title">書籍ID</th>
           <th>  <form:input path="searchInQueryBookIdFilter"
                class="form-control form-input"
                value="${f:h(bookListForm.searchInQueryBookIdFilter)}" /></th>
            <th><form:button name="lazyLoadFilter"
                class="btn btn-default btn-right">Fetch</form:button></th>
                </table>
        </fieldset>
    </form:form>
    ...
    <form:form modelAttribute="jpaBookListForm"
        ...
        <fieldset>
            ...
            <table>
            	<tr>
            		<th class="title">書籍ID</th>
           <th>  <form:input path="searchInQueryBookIdNoLazy"
                class="form-control form-input"
                value="${f:h(bookListForm.searchInQueryBookIdNoLazy)}" /></th>
            <th><form:button name="noLazy"
                class="btn btn-default btn-right">Fetch</form:button></th>
                </table>
        </fieldset>
    </form:form>
    ...
    <form:form modelAttribute="jpaBookListForm"
        action="${pageContext.request.contextPath}/djpa/book/register" method="GET">
            <table>
            	<tr>
            		<th class="title">書籍ID</th>
           <th>  <form:input path="bookId"
                class="form-control form-input"
                value="${f:h(bookListForm.bookId)}" /></th>
            <th><form:button name="egComplete"
                class="btn btn-default btn-right">CrudRepository Interface Default Fetch</form:button></th>
             <th><form:button name="find"
                class="btn btn-default btn-right">Find One Using JPARepository</form:button></th>
                </table>
    </form:form>
    <hr>
   <a id="djpaLink"
