<div class="row">
    ...
    <div>
        <table class="table table-striped table-bordered table-condensed">
            <form:form modelAttribute="jpaBookListForm" action="${pageContext.request.contextPath}/djpa/book/delete" method="delete">
                <tr>
                    <th class="title">書籍ID</th>
                    <th><form:input path="bookIdDelOpnInput" class="form-control form-input" value="${f:h(bookListForm.bookIdDiffOpInput)}" /></th>
    ...
    <fieldset>
        ...
        <table>
            <form:form modelAttribute="jpaBookListForm" action="${pageContext.request.contextPath}/djpa/book/sort" method="get">
                <tr>
                    <th>
                        List Books in Sorted Order By :
                        <form:select path="searchOrderBy">
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <c:forEach var="book" items="${bookList}" varStatus="rowStatus">
            <tr>
                ...
                <td class="bookId"><a id="bookLink_${rowStatus.count}" href="${pageContext.request.contextPath}/djpa/book/${book.bookId}/update"> ${f:h(book.bookId)}</a></td>
    ...
    <form:form modelAttribute="jpaBookListForm" action="${pageContext.request.contextPath}/djpa/book/interceptSrch">
        <fieldset>
            <legend>Lazy Fetching Using Interceptor</legend>
            <table>
                <tr>
                    <th class="title">書籍ID</th>
                    <th><form:input path="searchInQueryBookIdIntercept" class="form-control form-input" value="${f:h(bookListForm.searchInQueryBookIdIntercept)}" /></th>
    ...
    <br />
    <form:form modelAttribute="jpaBookListForm" action="${pageContext.request.contextPath}/djpa/book/filterSrch">
        <fieldset>
            <legend>Lazy Fetching Using Filter</legend>
            <table>
                <tr>
                    <th class="title">書籍ID</th>
                    <th><form:input path="searchInQueryBookIdFilter" class="form-control form-input" value="${f:h(bookListForm.searchInQueryBookIdFilter)}" /></th>
    ...
    <br />
    <form:form modelAttribute="jpaBookListForm" action="${pageContext.request.contextPath}/djpa/book/noLazySetting">
        <fieldset>
            <legend>Lazy Initialization Exception</legend>
            <table>
                <tr>
                    <th class="title">書籍ID</th>
                    <th><form:input path="searchInQueryBookIdNoLazy" class="form-control form-input" value="${f:h(bookListForm.searchInQueryBookIdNoLazy)}" /></th>
    ...
    <form:form modelAttribute="jpaBookListForm" action="${pageContext.request.contextPath}/djpa/book/interceptSrch">
        <fieldset>
            ...
            <table>
                <tr>
                    <th class="title">書籍ID</th>
                    <th><form:input path="searchInQueryBookIdAndRegisterSession" class="form-control form-input" value="${f:h(bookListForm.searchInQueryBookIdIntercept)}" /></th>
    ...
    <form:form modelAttribute="jpaBookListForm" action="${pageContext.request.contextPath}/djpa/book/interceptSrch">
        <fieldset>
            ...
            <table>
                <tr>
                    <th class="title">書籍ID</th>
                    <th><form:input path="searchInQueryBookIdAndRegisterFlashAttribute" class="form-control form-input" value="${f:h(bookListForm.searchInQueryBookIdIntercept)}" /></th>
    ...
    <form:form modelAttribute="jpaBookListForm" action="${pageContext.request.contextPath}/djpa/book/noLazySetting">
        <fieldset>
            ...
            <table>
                <tr>
                    <th class="title">書籍ID</th>
                    <th><form:input path="searchInQueryBookIdAcquiringNotForeignKey" class="form-control form-input" value="${f:h(bookListForm.searchInQueryBookIdIntercept)}" /></th>
    ...
    <form:form modelAttribute="jpaBookListForm" action="${pageContext.request.contextPath}/djpa/book/noLazySetting">
        <fieldset>
            ...
            <table>
                <tr>
                    <th class="title">書籍ID</th>
                    <th><form:input path="searchInQueryBookIdAcquiringForeignKey" class="form-control form-input" value="${f:h(bookListForm.searchInQueryBookIdIntercept)}" /></th>
    ...
    <br />
    <form:form modelAttribute="jpaBookListForm" action="${pageContext.request.contextPath}/djpa/book/register" method="GET">
        <table>
            <tr>
                <th class="title">書籍ID</th>
                <th><form:input path="bookId" class="form-control form-input" value="${f:h(bookListForm.bookId)}" /></th>
