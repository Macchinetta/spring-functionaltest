<div class="row">
    ...
    <form:form modelAttribute="deliveryOrderProcessForm" action="${pageContext.request.contextPath}/dmly/deliveryorder/process">
        <fieldset>
            <legend>伝播モード</legend>
            <div class="container">
                <div class="row">
                    <div class="col-md-12"><label class="form-label">Database ID : </label> <a id="databaseId" class="form-label">${f:h(databaseId)}</a></div>
                </div>
                <br />
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <label class="form-label">REQUIRED -&gt; NESTED (rollback) success after rollback</label>
                    </div>
                    <div class="col-md-1">
