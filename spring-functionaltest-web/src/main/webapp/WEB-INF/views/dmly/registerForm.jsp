    ...
    <fieldset>
        ...
        <div class="container">
                ...
                <div class="col-md-4">
                    <form:select class="form-control"
                        ...
                        <c:forEach var="deliveryType"
                            ...
                            varStatus="rowStatus">
                            <option
                                value="${f:h(deliveryType.deliveryTypeName)}"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form:input path="recieverAddress"
                        class="form-control"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <fmt:formatDate
                        value="${deliveryOrder.acceptDatetime}"
                        pattern="yyyy/MM/dd HH:mm:ss"
                        var="acceptDatetime" />
                    <form:input path="acceptDatetime"
                        class="form-control" value="${acceptDatetime}" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-4">
                    <fmt:formatDate
                        value="${deliveryOrder.completionDatetime}"
                        pattern="yyyy/MM/dd HH:mm:ss"
                        var="completionDatetime" />
                    <form:input path="completionDatetime"
                        class="form-control"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form:input path="deliveryDriver"
                        class="form-control"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form:select class="form-control"
                        path="deliveryStatus">
                        <c:forEach var="deliveryStatus"
                            items="${deliveryStatusList}"
                            varStatus="rowStatus">
                            <option
                                value="${f:h(deliveryStatus.deliveryStatus)}"
