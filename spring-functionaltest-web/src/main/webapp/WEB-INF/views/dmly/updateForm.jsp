    ...
    <fieldset>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form:input path="senderName" class="form-control" value="${f:h(deliveryOrder.senderName)}" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-4">
                    <form:input path="senderAddress" class="form-control" value="${f:h(deliveryOrder.senderAddress)}" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-4">
                    <form:input path="recieverName" class="form-control" value="${f:h(deliveryOrder.recieverName)}" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-4">
                    <form:input path="recieverAddress" class="form-control" value="${f:h(deliveryOrder.recieverAddress)}" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form:input path="deliveryDriver" class="form-control" value="${f:h(deliveryOrder.deliveryDriver)}" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
