<div class="row">
    ...
    <div>
        <form:form modelAttribute="deliveryOrderListForm" action="${pageContext.request.contextPath}/dmly/deliveryorder/register">
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <c:forEach var="deliveryOrder" items="${page.content}" varStatus="rowStatus">
            <tr>
                ...
                <td class="deliveryNo">
                    <a id="deliveryNo_${rowStatus.count}" href="${pageContext.request.contextPath}/dmly/deliveryorder/${deliveryOrder.deliveryNo}/update"> ${f:h(deliveryOrder.deliveryNo)}</a>
                </td>
                ...
                <td class="acceptDatetime" id="acceptDatetime"><fmt:formatDate value="${deliveryOrder.acceptDatetime}" pattern="yyyy/MM/dd hh:mm:ss" /></td>
                <td class="completionDatetime" id="completionDatetime"><fmt:formatDate value="${deliveryOrder.completionDatetime}" pattern="yyyy/MM/dd HH:mm:ss" /></td>
    ...
    <div class="paginationPart" align="center">
        <t:pagination page="${page}" disabledHref="javascript:void(0);" outerElementClass="pagination" queryTmpl="page={page}&size={size}" />
    </div>

    <form:form modelAttribute="deliveryOrderListForm" action="${pageContext.request.contextPath}/dmly/deliveryorder/update">
        <fieldset>
            <legend>複数件更新</legend>
            <div class="container">
                <div class="row">
                    <div class="col-md-11">
                        ...
                        <form:input path="fromAcceptDatetime" class="form-control form-input" value="${f:h(deliveryOrderListForm.fromAcceptDatetime)}" />
                        <label class="form-label form-label"> ～ </label>
                        <form:input path="toAcceptDatetime" class="form-control form-input" value="${f:h(deliveryOrderListForm.toAcceptDatetime)}" />
                        <label class="form-label form-label">完了日時 : </label>
                        <form:input path="updateCompletionDatetime" class="form-control form-input" value="${f:h(deliveryOrderListForm.updateCompletionDatetime)}" />
                    </div>
                    <div class="col-md-1">
