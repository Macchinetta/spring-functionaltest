<div class="row">
	...
	<div>
		...
		<form:form modelAttribute="orderMB3Form"
			action="${pageContext.request.contextPath}/dam3mb3/ordermb3/showCatDetl" method="get">
			<tr>
	...
	<c:if test="${catListFlag == true}">
		...
		<table class ="table-striped table-bordered table-condensed">
			<tr>
				<th>Category Code</th><th>Category Name</th>
				</tr>
				<c:forEach items="${catList }" var="category" varStatus="num">
				<tr>
					<td id="code_${num.count}">${category.code }</td><td id="name_${num.count}">${category.name }</td>
				<tr>
				</c:forEach>
		</table>
	</div>
