<div id="wrapper">
    ...
    <h3 id="screenTitle"><spring:message code="title.intr.userDetails" /></h3>
    <hr>
    ...
    <div><label id="name"><spring:message code="label.sf.intr.name" /></label> : Tom Hollander </div>
    <div><label id="gender"><spring:message code="label.sf.intr.gender" /></label> : Man </div>
    <div><label id="age"><spring:message code="label.sf.intr.age" /></label> : <span id="ageValue"><spring:message code="label.sf.intr.age.value" /></span> </div>
