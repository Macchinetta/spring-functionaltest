<div id="wrapper">
    ...
    <br />
    <form action="${pageContext.request.contextPath}/dnta/getdate" class="form-horizontal" method="get">
        <fieldset>
    ...
    <br />
    <form:form action="${pageContext.request.contextPath}/dnta/getdate" cssClass="form-horizontal" method="get" modelAttribute="dateForm">
