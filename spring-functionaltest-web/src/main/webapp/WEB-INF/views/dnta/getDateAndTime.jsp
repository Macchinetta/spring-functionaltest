<div id="wrapper">
	...
	<br>
	<form action="${pageContext.request.contextPath}/dnta/getdate"
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<button id="getNowLocalDateTime" name="getNowLocalDateTime"
					class="btn btn-default">LocalDateTime取得</button>
			</div>
		</fieldset>
	</form>
	<br />
	<form:form action="${pageContext.request.contextPath}/dnta/getdate"
	...
	<form:form action="${pageContext.request.contextPath}/dnta/getdate"
		...
		<div class="form-group">
			...
			<form:button name="getDateTimeSpecifiedTimezoneByArea"
				class="btn btn-default">TimeZoneを指定して取得(地域名)</form:button>
			<form:button name="getDateTimeSpecifiedTimezoneByTimeDifference"
				class="btn btn-default">TimeZoneを指定して取得(時差)</form:button>
		</div>
	</form:form>
</div>