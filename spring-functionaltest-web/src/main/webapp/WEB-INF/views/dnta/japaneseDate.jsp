<div id="wrapper">
    ...
    <br />
    <form:form action="${pageContext.request.contextPath}/dnta/japaneseDate" cssClass="form-horizontal" method="get" modelAttribute="dateForm">
        <legend>和暦取得</legend>
    ...
    <br />
    <form:form action="${pageContext.request.contextPath}/dnta/japaneseDate" cssClass="form-horizontal" method="get" modelAttribute="changeTypeForm">
