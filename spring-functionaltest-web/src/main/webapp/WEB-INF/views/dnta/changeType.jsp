<div id="wrapper">
    ...
    <form:form action="${pageContext.request.contextPath}/dnta/changeType" cssClass="form-horizontal" method="get" modelAttribute="dateForm">
        <fieldset>
    ...
    <br />
    <form action="${pageContext.request.contextPath}/dnta/changeType" class="form-horizontal" method="get">
        <fieldset>
    ...
    <br />
    <form:form action="${pageContext.request.contextPath}/dnta/changeType" cssClass="form-horizontal" method="get" modelAttribute="changeTypeForm">
