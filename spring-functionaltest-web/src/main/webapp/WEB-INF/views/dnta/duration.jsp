<div id="wrapper">
	...
	<br>
	<form:form action="${pageContext.request.contextPath}/dnta/duration"
		class="form-horizontal" method="get" modelAttribute="compareDateForm">
		<fieldset>
			<legend>日付比較</legend>
			...
			<table>
				...
				<button id="compareDate" name="compareDate"
					class="btn btn-default">日付比較</button>
			</div>
		</fieldset>
	</form:form>
	<br />
	<form:form action="${pageContext.request.contextPath}/dnta/duration"
		cssClass="form-horizontal" method="get" modelAttribute="compareTimeForm">
		<fieldset>
			<legend>時間比較</legend>
			<div class="form-group">
			<table>
				...
				<button id="compareTime" name="compareTime"
					class="btn btn-default">時間比較</button>
			</div>
		</fieldset>
	</form:form>
	<form:form action="${pageContext.request.contextPath}/dnta/duration"
		cssClass="form-horizontal" method="get" modelAttribute="compareZonedDateTimeForm">
		<fieldset>
