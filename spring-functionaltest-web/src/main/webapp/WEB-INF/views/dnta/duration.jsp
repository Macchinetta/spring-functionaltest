<div id="wrapper">
    ...
    <br />
    <form:form action="${pageContext.request.contextPath}/dnta/duration" class="form-horizontal" method="get" modelAttribute="compareDateForm">
        <fieldset>
            <legend>日付比較</legend>
    ...
    <br />
    <form:form action="${pageContext.request.contextPath}/dnta/duration" cssClass="form-horizontal" method="get" modelAttribute="compareTimeForm">
        <fieldset>
            <legend>時間比較</legend>
            <div class="form-group">
                <table>
    ...
    <form:form action="${pageContext.request.contextPath}/dnta/duration" cssClass="form-horizontal" method="get" modelAttribute="compareZonedDateTimeForm">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <button id="compareTimeWithSummerTime" name="compareTimeWithSummerTime" class="btn btn-default">時間比較(サマータイム)</button>
            </div>
        </fieldset>
    </form:form>
</div>
