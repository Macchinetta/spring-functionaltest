  ...
  <fieldset>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          <form:input path="todoId" class="form-control" value="${f:h(todo.todoId)}" readonly="true"
        ...
        <div class="col-md-4">
          <c:choose>
            <c:when test="${todo.finished == true}">
              <form:input path="finished" class="form-control" value="Complete" readonly="true"
                style="background-color: whitesmoke;" />
            </c:when>
            <c:otherwise>
              <form:input path="finished" class="form-control" value="In-Complete" readonly="true"
                style="background-color: whitesmoke;" />
            </c:otherwise>
          </c:choose>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <form:input path="createdAt" class="form-control" value="${createdAt}" readonly="true"
            style="background-color: whitesmoke;" />
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-md-4">
          <form:input path="version" class="form-control" value="${f:h(todo.version)}"
            readonly="true" style="background-color: whitesmoke;" />
        </div>
      </div>
    </div>
