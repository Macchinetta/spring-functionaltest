<div class="row">
    ...
    <div>
        <form:form modelAttribute="todoForm" action="${pageContext.request.contextPath}/dam3/todo/bulkReg" method="post">
            ...
            <c:if test="${batchReg == true || batchDL == true || batchUp == true || batchRepoUp == true}">
                <div id="regCnt" style="color: green">Total Todos Registered/Updated in Batch :&nbsp;${regCount }</div>
            </c:if>
        </form:form>
    </div>
    <div>
        <form:form modelAttribute="todoForm" action="${pageContext.request.contextPath}/dam3/todo/addByReUse" method="post">
            ...
            <c:when test="${mapRes == true}">
                <c:forEach var="todoItem" items="${todoMapRes}" varStatus="rowStatus">
                    <tr>
                        ...
                        <td class="bookId"><a id="todoLink_${todoItem.key}" href="${pageContext.request.contextPath}/dam3/todo/${todoItem.key}/update"> ${f:h(todoItem.key)}</a></td>
                        <td class="title" id="title">${f:h(todoItem.value.todoTitle)}</td>
                        <td class="releaseDate" id="createdDate"><fmt:formatDate pattern="yyyy/MM/dd" value="${todoItem.value.createdAt}" /></td>
                        <c:choose>
                        ...
                        <td class="releaseDate" id="completeAt"><joda:format pattern="yyyy/MM/dd" value="${todoItem.value.completeAt}" /></td>
                    </tr>
                </c:forEach>
            </c:when>
            <c:when test="${isPaginated == true}">
                <c:forEach var="todo" items="${page.content}" varStatus="rowStatus">
                    <tr>
                        ...
                        <td class="releaseDate" id="createdDate"><fmt:formatDate value="${todo.createdAt}" pattern="yyyy/MM/dd" /></td>
                        <c:choose>
                        ...
                        <td class="categoryName" id="categoryName">
                            <a id="todoLink_${rowStatus.count}" href="${pageContext.request.contextPath}/dam3/todo/${todo.todoId}/update"> Refer Details Page</a>
                        </td>
                        <td class="releaseDate" id="completeAt"><joda:format pattern="yyyy/MM/dd" value="${todo.completeAt}" /></td>
                    </tr>
                </c:forEach>
            </c:when>
                ...
                <c:forEach var="todo" items="${todos}" varStatus="rowStatus">
                    <tr>
                        ...
                        <td class="releaseDate" id="createdDate">
                            <%-- <joda:format pattern="yyyy/MM/dd" value="${todo.createdAt}" /> --%> <fmt:formatDate value="${todo.createdAt}" pattern="yyyy/MM/dd" />
                        </td>
                        <c:choose>
                            <c:when test="${todo.finished == true}">
                                <c:set var="complete" value="${complete + 1}" />
    ...
    <div>
        <table class="table-striped table-bordered table-condensed">
            <form:form modelAttribute="todoForm" action="${pageContext.request.contextPath}/dam3/todo/update" method="post">
                <tr>
    ...
    <br />
    <div>
        <form:form modelAttribute="todoForm" action="${pageContext.request.contextPath}/dam3/todo/search" method="get">
            <fieldset>
                ...
                <table class="table-striped table-bordered table-condensed">
                    <tr>
                        ...
                        <td>
                            Enter Todo creation date : <fmt:formatDate value="${todoForm.createdAt}" pattern="yyyy/MM/dd" var="createdAt" />
            ...
            <fieldset>
                ...
                <table class="table-striped table-bordered table-condensed">
                    ...
                    <tr>
                        <td><form:button name="pkSrch" class="btn btn-default">Search By PK</form:button>&nbsp;<form:button name="pkSrchNG" class="btn btn-default">Search By PK:NA</form:button></td>
                    ...
                    <tr>
                        <td>
                            <form:button name="criteriaSrch" class="btn btn-default">Search By Criteria</form:button> &nbsp;<form:button name="criteriaSrchMapRes" class="btn btn-default"
                                >Search By Criteria: Return Result in Map</form:button
                            >
                        </td>
                        <td>
                            <form:button name="downloadTodo" class="btn btn-default">CSV Download : ResultHandler Demo</form:button>
                            <c:if test="${showCSVPath == true}">
                                <br />File path
                                <div style="color: green; font: bold" id="csvPath">${csvFilePath }</div>
                            </c:if>
                        </td>
                        <td style="color: blue; font: bolder">Enter values in Todo title and Created At(yyyy/mm/dd)</td>
                    </tr>
                    <tr>
                        <td>
                            Get Todo Count for Given Status-->::&nbsp;Incomplete&nbsp;<form:radiobutton id="incomplete" path="finished" value="0" />&nbsp;&nbsp;Finished&nbsp;<form:radiobutton
                                id="complete"
                                path="finished"
                                value="1"
                            />
                        ...
                        <td colspan="1">
                            <form:button name="countByStatus" class="btn btn-default">Get Count</form:button>&nbsp;<form:button name="ifSrch" class="btn btn-default"
                                >IF element demo search</form:button
                            >
                        </td>
                    ...
                    <tr>
                        <td>
                            <form:button name="stdPageSearch" class="btn btn-default">Page Search : Standard Method</form:button>&nbsp;
                            <form:button name="sqlRefPageSearch" class="btn btn-default">Page Search : SQL Refine Method</form:button>
                        </td>
                        <td>
                            <form:button name="clTypeAliasSrch" class="btn btn-default">Type Alias : Per Class</form:button>&nbsp;
                            <form:button name="typeAlOverWrDefName" class="btn btn-default">Type Alias : Overwrite Def Name</form:button>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="color: blue; font: bolder">Enter values in Create Date and optional Todo title</td>
                    </tr>
                    <tr></tr>
                </table>
            </fieldset>
