<form:form modelAttribute="todoForm"
    action="${pageContext.request.contextPath}/dam3/todo/${todo.todoId}/update">
    <fieldset>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <form:input path="todoId" class="form-control"
                        value="${f:h(todo.todoId)}" readonly="true"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form:input path="todoCategory" class="form-control"
                        value="${f:h(todo.todoCategory)}" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form:input path="finished" class="form-control"
                        value="${f:h(todo.finished)}" />
                </div>
            </div>
             <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                	 <fmt:formatDate value="${todo.createdAt}"
                            pattern="yyyy/MM/dd" var="createdAt" />
                	<%-- <joda:format
                        pattern="yyyy/MM/dd"
                        value="${todo.createdAt}"  var="createdAt"/> --%>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                	<joda:format
                        pattern="yyyy/MM/dd"
                        value="${todo.completeAt}"  var="completeAt"/>
                    <form:input path="completeAt" class="form-control"
                        value="${completeAt}" />
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form:input path="version" class="form-control"
                        value="${f:h(todo.version)}" readonly="true"
                        style="background-color: whitesmoke;" />
                </div>
            </div>
           <div class="row">
                ...
                <div class="col-md-4">
                    <form:input path="description1" class="form-control"
                        value="${f:h(todo.description1)}"/>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <form:input path="description2" class="form-control"
                        value="${f:h(todo.description2)}"  />
                </div>
            </div>
            <div class="row">
