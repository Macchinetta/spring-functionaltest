...
<div id="wrapper">
    ...
    <c:choose>
                    ...
                    <c:forEach var="cartItem" items="${cart.cartItems}" varStatus="rowStatus">
                        <spring:nestedPath path="cartItemForms[${rowStatus.index}]">
                            <tr>
                                ...
                                <td class="quantity"><form:input path="quantity" cssClass="quantity form-control" /> <form:errors cssClass="errorMessage" path="quantity"></form:errors></td>
        ...
        <c:otherwise>
            <spring:message code="label.sf.sm.0002" />
        </c:otherwise>
    </c:choose>
</div>
