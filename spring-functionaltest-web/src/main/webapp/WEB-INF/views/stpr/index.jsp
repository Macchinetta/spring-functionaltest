<div id="wrapper">
    ...
    <ul>
        ...
        <li><a id="stpr0201003" href="${pageContext.request.contextPath}/stpr/0201/002">stpr0201003</a> - 入力値が異なるだけのため、リンク先は[stpr0201002]と同様</li>
    </ul>
    ...
    <ul>
        ...
        <li><a id="stpr0303002" href="${pageContext.request.contextPath}/stpr/0303/001">stpr0303002</a> - 入力値が異なるだけのため、リンク先は[stpr0303001]と同様</li>
        <li><a id="stpr0304001" href="${pageContext.request.contextPath}/stpr/0303/001">stpr0304001</a> - 入力値が異なるだけのため、リンク先は[stpr0303001]と同様</li>
    </ul>

    <div>[STPR04] 全角半角文字列変換</div>
    <ul>
        <li><a id="stpr0401001" href="${pageContext.request.contextPath}/stpr/04">stpr0401001</a></li>
        <li><a id="stpr0402001" href="${pageContext.request.contextPath}/stpr/04">stpr0402001</a> - 入力値が異なるだけのため、リンク先は[stpr0401001]と同様</li>
        <li><a id="stpr0403001" href="${pageContext.request.contextPath}/stpr/04">stpr0403001</a> - 入力値が異なるだけのため、リンク先は[stpr0401001]と同様</li>
        <li><a id="stpr0404001" href="${pageContext.request.contextPath}/stpr/04">stpr0404001</a> - 入力値が異なるだけのため、リンク先は[stpr0401001]と同様</li>
    </ul>
</div>
