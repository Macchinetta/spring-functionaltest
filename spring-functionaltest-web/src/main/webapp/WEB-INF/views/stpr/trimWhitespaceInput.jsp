<div id="wrapper">
    ...
    <br />
    <t:messagesPanel />
    <form:form action="${pageContext.request.contextPath}/stpr/0101/001/trimWhitespace" cssClass="form-horizontal" method="post" modelAttribute="stringProcessing01Form">
