        ...
        <c:if test="${not empty uploadedContent}">
            ...
            <div class="form-group">
                ...
                <div class="col col-md-10">
                    <span id="descriptionText"
                        class="display-item form-control">${f:br(f:h(uploadedContent.description))}</span>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col col-md-10 col-md-offset-2">
                    <form
                        action="${pageContext.request.contextPath}/flup/files"
                        method="get">
                        <input type="hidden" name="fileId"
                            value="${f:h(uploadedContent.fileId)}" />
