...
<c:set var="titleKey" value="title.flup.multipleFileUploadForm" />
...
<div id="wrapper">
  ...
  <form:form modelAttribute="multipleUploadForm" method="post" cssClass="form-horizontal"
    ...
    <div class="form-group">
      ...
      <div class="col col-md-10">
        ...
        <button id="browseFiles" type="button" class="btn btn-default">
