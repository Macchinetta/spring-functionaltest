<div id="wrapper">
    ...
    <form:form modelAttribute="screenFlowUploadForm" method="post" cssClass="form-horizontal" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <div class="col col-md-10">
                ...
                <button id="browseFile" type="button" class="btn btn-default"><span class="glyphicon glyphicon-folder-open"></span>参照</button>
        ...
        <div class="form-group">
            <div class="col col-md-10 col-md-offset-2">
                <form:button id="confirmButton" name="confirm" class="btn btn-default"> <span class="glyphicon glyphicon-play"></span>確認</form:button>
