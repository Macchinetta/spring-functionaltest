<div id="wrapper">
  ...
  <form:form modelAttribute="screenFlowUploadForm" method="post" cssClass="form-horizontal">
    ...
    <div class="form-group">
      <div class="col col-md-10 col-md-offset-2">
        ...
        <form:button id="confirmButton" name="redo" class="btn btn-default">
  ...
  <c:if test="${!(empty displayConfirmTemporaryDirectoryButton)}">
    <form action="${pageContext.request.contextPath}/flup/temporaryFiles?list" method="get"
      class="form-horizontal">
      <div class="form-group">
        <div class="col col-md-10 col-md-offset-2">
          <button id="confirmTemporaryDirectory" name="list" class="btn btn-default">
