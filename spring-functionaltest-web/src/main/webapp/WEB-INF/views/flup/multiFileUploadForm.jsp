<div id="wrapper">
    ...
    <form:form modelAttribute="multiUploadForm" method="post" cssClass="form-horizontal" enctype="multipart/form-data">
        <c:forEach var="i" begin="0" end="1" step="1">
            <div class="form-group">
                ...
                <div class="col col-md-10">
                    ...
                    <input type="text" readonly="readonly" id="selectedFiles${i}" class="selectedFile form-control" />
                    <button id="browseFiles${i}" type="button" class="btn btn-default"><span class="glyphicon glyphicon-folder-open"></span>参照</button>
