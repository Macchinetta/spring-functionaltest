<div id="wrapper">
    ...
    <c:if test="${not empty temporaryFiles}">
        ...
        <div>
            <table
                ...
                <tbody>
                    <c:forEach items="${temporaryFiles}"
                        var="temporaryFile" varStatus="rowStatus">
                        <tr>
                            ...
                            <td class="text-right"><fmt:formatNumber
                                    value="${temporaryFile.size/1024}"
                                    pattern="###,##0.00 KB" /></td>
                            <td class="text-center"><fmt:formatDate
                                    value="${temporaryFile.uploadedAt}"
    ...
    <form:form method="post" class="form-horizontal">
        <a
            href="${pageContext.request.contextPath}/flup/temporaryFiles?list"
            id="refreshButton" class="btn btn-default"><span
            class="glyphicon glyphicon-refresh"></span>最新状態 </a>
        <button id="deleteAllButton" name="delete"
