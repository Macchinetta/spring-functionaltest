...
<div id="wrapper">
  ...
  <form action="${pageContext.request.contextPath}/aply/0101/001_1" method="get"
    class="form-horizontal">
    <spring:nestedPath path="handleRequestForm">
      <input type="submit" id="aply0101001_1" class="btn btn-default"
        value="HTTPメソッドをGETのみ指定（GET送信）" />
    </spring:nestedPath>
  </form>
  <form:form action="${pageContext.request.contextPath}/aply/0101/001_2" method="post"
  ...
  <form action="${pageContext.request.contextPath}/aply/0101/001_3" method="get"
    class="form-horizontal">
    <spring:nestedPath path="handleRequestForm">
      <input type="submit" id="aply0101001_3get" class="btn btn-default"
        value="HTTPメソッドをPOSTとGETのみ指定（GET送信）" />
    </spring:nestedPath>
  </form>
  <form:form action="${pageContext.request.contextPath}/aply/0101/001_3" method="post"
    cssClass="form-horizontal" modelAttribute="handleRequestForm">
