...
<div id="wrapper">
  ...
  <ul>
    <li><a id="aply0101001" href="${pageContext.request.contextPath}/aply/0101/001">リクエスト処理メソッドに実行条件のHTTPメソッドを設定できること。</a></li>
    <li><a id="aply0101002" href="${pageContext.request.contextPath}/aply/0101/002">リクエスト処理メソッドに実行条件のリクエストパスを設定できること。</a></li>
