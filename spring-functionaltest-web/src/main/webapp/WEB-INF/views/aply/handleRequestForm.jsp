<div id="wrapper">
    ...
    <ul>
        ...
        <li><a id="aply0102003" href="${pageContext.request.contextPath}/aply/0102/003?id=12&name=taro">リクエスト処理メソッドの引数にリクエストパラメータを個別に設定できること。</a></li>
        ...
        <li>
            <a id="aply0102006" href="${pageContext.request.contextPath}/aply/0102/006"
                >リクエスト処理メソッドの引数にリダイレクト属性オブジェクトを設定し、リダイレクト先URLに使用する値を設定できること。</a
            >
        </li>
        ...
        <li>
            <a id="aply0102009" href="${pageContext.request.contextPath}/aply/0102/009?commonParam1=111&commonParam2=222"
                >共通情報Bean格納メソッドを作成し、リクエスト処理メソッドの引数に共通情報Beanを設定できること。</a
            >
        </li>
        <li>
            <a id="aply0102010" href="${pageContext.request.contextPath}/aply/0102/010?commonParam1=123&commonParam2=456"
                >共通情報Bean格納メソッドを作成し、リクエスト処理メソッドの引数に共通情報Beanを設定できること。(別Controller確認)</a
            >
        </li>
    </ul>
</div>
