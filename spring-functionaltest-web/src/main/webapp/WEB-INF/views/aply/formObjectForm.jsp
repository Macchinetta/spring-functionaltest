        ...
        <fieldset>
            <div class="form-group">
                ...
                <div class="col col-md-3">
                    <span id="value1ValidationErrorMessage"><form:errors
                            path="value1" cssClass="errorMessage" /></span>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <form:button id="submit" name="submit"
                    class="btn btn-default">submit</form:button>
            </div>
        </fieldset>
    </form:form>
</div>
