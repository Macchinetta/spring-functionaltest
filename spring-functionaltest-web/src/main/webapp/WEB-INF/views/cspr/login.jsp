<div id="wrapper">
    ...
    <form:form action="${pageContext.request.contextPath}/cspr/authenticate" method="post">
        <fieldset>
            <legend>ログイン</legend>
            <br />
            ...
            <br /> <br /> <input type="submit" class="btn btn-default" id="committerLogin" value="ログイン" />
        </fieldset>
    </form:form>
</div>
