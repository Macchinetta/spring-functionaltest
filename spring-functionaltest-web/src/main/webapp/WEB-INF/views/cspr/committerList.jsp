<div id="wrapper">
    ...
    <div class="text-center">
        <form:form modelAttribute="committerCriteria">
            ...
            <input id="searchBtn" type="button" class="btn btn-default" value="検索" onclick="return cspr.search()" />
        </form:form>
    </div>
    <br />
    <div id="result" class="text-center">
        <table id="committerResultTable" class="hidden table table-striped table-bordered table-condensed csprtable">
            <thead>
                <tr>
            ...
            <tbody id="committerResult"></tbody>
        </table>
    </div>
</div>
