<div id="wrapper">
    ...
    <br>
    <form:form
        action="${pageContext.request.contextPath}/dtop/checkterm"
        method="get" modelAttribute="checkTermForm">
        <legend>特定の期間(日付)に関する判定</legend>
        <div class="table-responsive">
            <table
                class="table table-striped table-bordered table-condensed table-size">
                <thead>
                    <tr>
                ...
                <tr>
                    ...
                    <td class="dateColumn"><form:input
                            path="targetTermFrom"
                ...
                <tr>
                    ...
                    <td class="dateColumn"><form:input
                            path="targetCheckTermFrom"
                            cssClass="form-control input-sm" /></td>
                    <td class="tildaColumn">～</td>
                    <td class="dateColumn"><form:input
                            path="targetCheckTermTo"
                            cssClass="form-control input-sm" /></td>
                </tr>
                <tr>
                    <td class="getColumn">チェック対象日付</td>
                    <td class="dateColumn" colspan="3"><form:input
                            path="targetCheckDate"
                            cssClass="form-control input-sm" /></td>
                </tr>
            </table>
        </div>
        <form:button name="checkContainTermToDate"
            class="btn btn-default">期間内包括(対日付)判定</form:button>
        <form:button name="checkContainTermToTerm"
            class="btn btn-default">期間内包括(対期間)判定</form:button>
    ...
    <form:form
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col col-md-2">
                    <form:input path="targetIncDecDate"
            ...
            <div class="row">
                ...
                <div class="col col-md-2">
                    <form:input path="targetIncreaseMonthNum"
                        cssClass="form-control input-sm" />
                </div>
            </div>
            <div class="row">
                ...
                <div class="col col-md-2">
                    <form:input path="targetDecreaseMonthNum"
                        cssClass="form-control input-sm" />
                </div>
            </div>
            <div class="row">
                ...
                <div class="col col-md-2">
                    <form:input path="targetIncreaseDayNum"
                        cssClass="form-control input-sm" />
                </div>
            </div>
            <div class="row">
                ...
                <div class="col col-md-2">
                    <form:input path="targetDecreaseDayNum"
                        cssClass="form-control input-sm" />
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <form:button name="calcMonthAndDayDate"
                class="btn btn-default">増減月日取得</form:button>
        </div>
    </form:form>
</div>