<div id="wrapper">
    ...
    <form:form action="${pageContext.request.contextPath}/exhn/${f:h(testNumber)}/register"
        modelAttribute="articleBatchRegisterForm" method="POST"
        cssClass="form-horizontal" enctype="multipart/form-data">
        <fieldset>
            <legend>記事ファイル</legend>
            <div class="form-group">
                <form:label path="title"
                    cssClass="col col-md-2 control-label">タイトル</form:label>
            ...
            <div class="form-group">
                <form:label path="multipartFile"
                    cssClass="col col-md-2 control-label">ファイル名</form:label>
                <div class="col col-md-5">
        ...
        <div class="form-group">
            <div class="col col-md-10 col-md-offset-2">
                ...
                <form:button id="uploadButton" name="upload"
                    class="btn btn-default">アップロードを確定</form:button>
            </div>
        </div>
    </form:form>
</div>
