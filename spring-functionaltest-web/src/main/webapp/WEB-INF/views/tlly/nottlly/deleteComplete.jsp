    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a id="springTestTop" class="navbar-brand"
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown"><a href="#"
                        class="dropdown-toggle" data-toggle="dropdown"><span
                            ...
                            id="loginUserName"> <sec:authorize
                                    access="isAuthenticated()">
                        ${f:h(principal.username)}
                    </sec:authorize> <sec:authorize access="!isAuthenticated()">
                                    <spring:message
                                        code="label.sf.cmmn.defaultUserName" />
                                </sec:authorize>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <form:select class="form-control"
                                path="authority" disabled="true"
                                style="background-color: whitesmoke;">
                                <option value="STAFF_MNG"
                                    ${staff.authority.equals("STAFF_MNG") ? 'selected' : ''}>Staff
                                    Management</option>
                                <option value="MASTER_MNG"
                                    ${staff.authority.equals("MASTER_MNG") ? 'selected' : ''}>Master
                                    Management</option>
                                <option value="STOCK_MNG"
                                    ${staff.authority.equals("STOCK_MNG") ? 'selected' : ''}>Stock
                                    Management</option>
                                <option value="ORDER_MNG"
                                    ${staff.authority.equals("ORDER_MNG") ? 'selected' : ''}>Order
                                    Management</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <form:button name="back"
                                class="btn btn-default">Back</form:button>
                        </div>
                    </div>
                </div>
            </fieldset>
