                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <form:select class="form-control"
                                path="authority">
                                <option value="STAFF_MNG" selected>Staff
                                    Management</option>
                                <option value="MASTER_MNG">Master
                                    Management</option>
                                <option value="STOCK_MNG">Stock
                                    Management</option>
                                <option value="ORDER_MNG">Order
                                    Management</option>
                                <option value="SHOW_SHOPPING_MNG">Show
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <form:button name="delete"
                                class="btn btn-default">Delete</form:button>
