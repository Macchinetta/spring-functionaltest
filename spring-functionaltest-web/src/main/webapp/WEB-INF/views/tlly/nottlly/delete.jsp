...
<html class="no-js">
    ...
    <body>
        ...
        <div class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a id="springTestTop" class="navbar-brand" href="${pageContext.request.contextPath}"><spring:message code="label.sf.cmmn.systemName" /></a>
                </div>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                                ...
                                <span id="loginUserName">
                                    <sec:authorize access="isAuthenticated()"> ${f:h(principal.username)} </sec:authorize>
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="#users/update"><span class="glyphicon glyphicon-edit"></span> ユーザー情報変更</a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/logout"><span class="glyphicon glyphicon-off"></span> ログアウト</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="container">
            <h2 id="bodyTitle">Delete Staff Information</h2>
            <form:form modelAttribute="staffForm" action="${pageContext.request.contextPath}/tlly/staff/delete">
                <fieldset>
