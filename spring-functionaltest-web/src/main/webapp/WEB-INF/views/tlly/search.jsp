<h2 id="bodyTitle">Search Staff Information</h2>
<form:form modelAttribute="staffForm" action="${pageContext.request.contextPath}/tlly/staff/search">
  <fieldset>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <form:button name="search" class="btn btn-default">search</form:button>
