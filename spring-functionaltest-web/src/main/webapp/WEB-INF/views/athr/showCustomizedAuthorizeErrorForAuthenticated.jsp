<div id="wrapper">
    ...
    <table class="table table-bordered table-condensed">
      ...
      <tr>
        ...
        <td><span> <a id="denyLink"
            href="${pageContext.request.contextPath}/athr/0701/001/deny/">Go To Access Denied
              Page</a>
        </span></td>
      </tr>
    </table>
  ...
  <form:form action="${pageContext.request.contextPath}/athr/0701/001/logout" method="post">
