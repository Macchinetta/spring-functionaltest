<div id="wrapper">
  ...
  <h1 id="screenTitle">Staff Login Page</h1>

  <form:form action="${pageContext.request.contextPath}/athr/0201/001/authenticate" method="post">
  ...
  <br>
  <form:form action="${pageContext.request.contextPath}/athr/0101/001/logout" method="post">
