...
<c:set var="titleKey" value="title.athr.loginForRoleHierarchy" />
...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/athr/0901/001/authenticate" method="post">
  ...
  <br>
  <form:form action="${pageContext.request.contextPath}/athr/0901/001/logout" method="post">
