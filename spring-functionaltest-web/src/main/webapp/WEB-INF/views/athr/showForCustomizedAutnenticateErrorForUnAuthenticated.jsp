...
<c:set var="titleKey" value="title.athr.showForCustomizedAutnenticateErrorForUnAuthenticated" />
...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/athr/0802/logout" method="post">
