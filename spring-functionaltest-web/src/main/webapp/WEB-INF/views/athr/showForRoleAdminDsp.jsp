    ...
    <fieldset>
        <table class="table table-bordered table-condensed">
            <tr>
                <th>Message</th>
                <td>
                    <span id="staffRole"> <sec:authorize access="hasRole('ADMIN')"> This screen is for ROLE_ADMIN </sec:authorize> </span>
                </td>
            </tr>
            <tr>
                <th>Only Role_Admin User link</th>
                <td>
                    <span id="staffRoleLink">
                        <sec:authorize url="/athr/0401/001/afterLogin/admin/menu">
            ...
            <tr>
                ...
                <td>
                    <span id="staffRoleVarLink">
                        <c:if test="${hasAdminAuthority}">
