<div id="wrapper">
  ...
  <h1 id="screenTitle">Login Page(AccsessPolicyIpAddressAllow)</h1>

  <form:form action="${pageContext.request.contextPath}/athr/0601/002/authenticate" method="post">
  ...
  <br>
  <form:form action="${pageContext.request.contextPath}/athr/0601/002/logout" method="post">
