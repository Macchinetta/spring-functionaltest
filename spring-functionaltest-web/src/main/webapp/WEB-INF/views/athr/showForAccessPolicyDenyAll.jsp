<div id="wrapper">
		...
		<table class="table table-bordered table-condensed">
			...
			<tr>
				...
				<td><span> <a id="accountsLink"
						href="${pageContext.request.contextPath}/athr/0601/004/accounts">Go
			...
			<tr>
				...
				<td><span> <a id="mangerLink"
						href="${pageContext.request.contextPath}/athr/0601/004/admin/">Go
							To Manager Page</a>
				</span></td>
			...
			<tr>
				...
				<td><span> <a  id="allLink"
						href="${pageContext.request.contextPath}/athr/0601/004/all">Go
	...
	<form:form
		action="${pageContext.request.contextPath}/athr/0601/004/logout"
		method="post">
