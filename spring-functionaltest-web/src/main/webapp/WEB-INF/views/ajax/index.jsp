<div id="wrapper">
    ...
    <ul>
        <li><a id="ajax0301001001" href="${pageContext.request.contextPath}/ajax/0301/001/001">ajax0301001 first</a></li>
        <li><a id="ajax0301001002" href="${pageContext.request.contextPath}/ajax/0301/001/002">ajax0301001 second</a></li>
