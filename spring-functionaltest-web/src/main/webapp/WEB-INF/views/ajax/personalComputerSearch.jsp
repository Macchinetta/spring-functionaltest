        ...
        <form id="personalComputerCriteria">
            <spring:nestedPath path="personalComputerCriteria">
                <fieldset>
                    ...
                    <form:input path="personalComputerName" cssClass="space pc-search-field form-control inline" />

                    <form:button id="searchBtn" name="search" class="btn btn-default" onclick="return ajax.search()">検索</form:button>
                </fieldset>
            </spring:nestedPath>
        </form>
    </div>
