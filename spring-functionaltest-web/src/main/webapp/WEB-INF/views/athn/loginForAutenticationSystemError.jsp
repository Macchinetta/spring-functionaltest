<div id="wrapper">
  ...
  <c:choose>
    <c:when test="${param.containsKey('error')}">
      <span id="loginError" style="color: red;"> <t:messagesPanel
  ...
  <form:form action="${pageContext.request.contextPath}/athn/1601/authenticate"
  ...
  <form:form action="${pageContext.request.contextPath}/athn/1601/logout" cssClass="form-horizontal"
    method="post">
    <div class="form-group">
