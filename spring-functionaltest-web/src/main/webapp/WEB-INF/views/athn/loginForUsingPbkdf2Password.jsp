...
<c:set var="titleKey" value="title.athn.loginForUsingPbkdf2Password" />
...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/athn/0501/004/authenticate"
  ...
  <form:form action="${pageContext.request.contextPath}/athn/0501/004/logout"
    cssClass="form-horizontal" method="post">
    <div class="form-group">
