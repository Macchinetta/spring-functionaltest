...
<c:set var="titleKey" value="title.athn.loginForDbFormAuthenticationSpecifyHash" />
...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/athn/0402/004/authenticate"
