...
<c:set var="titleKey" value="title.athn.loginForUsingArgon2Password" />
...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/athn/0501/008/authenticate"
  ...
  <form:form action="${pageContext.request.contextPath}/athn/0501/008/logout"
    cssClass="form-horizontal" method="post">
    <div class="form-group">
