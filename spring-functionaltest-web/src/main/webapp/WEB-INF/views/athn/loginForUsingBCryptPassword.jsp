<div id="wrapper">
    ...
    <form:form action="${pageContext.request.contextPath}/athn/0501/002/authenticate" cssClass="form-horizontal" method="post">
        <legend>ログイン</legend>
    ...
    <form:form action="${pageContext.request.contextPath}/athn/0501/002/logout" cssClass="form-horizontal" method="post">
        <div class="form-group">
