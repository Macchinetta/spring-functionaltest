...
<c:set var="titleKey" value="title.athn.loginForUsingSCryptPassword" />
...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/athn/0501/006/authenticate"
  ...
  <form:form action="${pageContext.request.contextPath}/athn/0501/006/logout"
    cssClass="form-horizontal" method="post">
    <div class="form-group">
