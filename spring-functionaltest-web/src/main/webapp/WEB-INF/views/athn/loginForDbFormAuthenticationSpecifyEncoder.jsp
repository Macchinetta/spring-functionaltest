...
<c:set var="titleKey" value="title.athn.loginForDbFormAuthenticationSpecifyEncoder" />
...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/athn/0402/001/authenticate"
