<div id="wrapper">
    ...
    <form:form action="${pageContext.request.contextPath}/athn/2201/authenticate" method="post">
        <c:if test="${param.containsKey('error')}">
            <span id="accountLoginError"> <t:messagesPanel messagesAttributeName="SPRING_SECURITY_LAST_EXCEPTION" panelClassName="alert alert-danger" /> </span>
        </c:if>
        <fieldset>
            <legend>Login</legend>
            <br />
            ...
            <div class="form-group">
                ...
                <div class="col col-md-3">
                    <input type="checkbox" class="checkbox" id="remember-me" name="remember-me" checked="checked" value="true" />
                </div>
            </div>
