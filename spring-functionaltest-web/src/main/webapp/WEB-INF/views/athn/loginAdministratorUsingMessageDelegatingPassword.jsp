...
<c:set var="titleKey" value="title.athn.loginAdministratorUsingMessageDelegatingPassword" />
...
<div id="wrapper">
  ...
  <form:form action="${pageContext.request.contextPath}/athn/1901/004/authenticate"
  ...
  <form:form action="${pageContext.request.contextPath}/athn/1901/004/logout"
    cssClass="form-horizontal" method="post">
    <div class="form-group">
