<div id="wrapper">
  ...
  <ul>
    <li><a id="athn0301001" href="${pageContext.request.contextPath}/athn/0301/001/login">athn0301001</a>
    </li>
  </ul>
  <div>[ATHN04] DB認証</div>
  <ul>
  ...
  <ul>
    <li><a id="athn0501001" href="${pageContext.request.contextPath}/athn/0501/001">athn0501001</a>
    </li>

    <li><a id="athn0502001" href="${pageContext.request.contextPath}/athn/0502/001/login">athn0502001</a></li>
  </ul>

  <div>[ATHN06] 認証イベントのハンドリング</div>
  <ul>
    <li><a id="athn0601001" href="${pageContext.request.contextPath}/athn/0601/001/login">athn0601001</a>
    </li>
    <li><a id="athn0602001" href="${pageContext.request.contextPath}/athn/0601/001/login">athn0602001</a>
    </li>
  ...
  <ul>
    <li><a id="athn0701001" href="${pageContext.request.contextPath}/athn/0701/001/login">athn0701001</a>
    </li>
  ...
  <ul>
    <li><a id="athn0901001" href="${pageContext.request.contextPath}/athn/0901/login">athn0901001</a>
    </li>
  </ul>
  ...
  <ul>
    <li><a id="athn1601001" href="${pageContext.request.contextPath}/athn/1601/001/login">athn1601001</a>
    </li>
  </ul>
  ...
  <ul>
    ...
    <li><a id="athn1801002" href="${pageContext.request.contextPath}/athn/1801/002">athn1801002</a></li>
  </ul>
  ...
  <ul>
    <li><a id="athn2101001" href="${pageContext.request.contextPath}/athn/2101/001">athn2101001</a></li>
