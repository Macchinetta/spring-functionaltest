...
public class RestAPITest extends RestTestSupport {
    ...
    public void testREST0201001() throws Exception {
        ...
        given().filters(new RequestLoggingFilter(captor),
                ...
                .then().statusCode(200).header("content-Type", containsString(
                        MediaType.APPLICATION_JSON_VALUE))//
                .body("[0].memberId", startsWith("M0"))//
                .body("[0].firstName", equalTo("FirstName1"))//
                .body("[0].lastName", equalTo("LastName1"))//
                .body("[0].genderCode", equalTo("1"))//
                .body("[0].dateOfBirth", equalTo("2015-01-01"))//
                .body("[0].emailAddress", equalTo("FirstName1@test.co.jp"))//
                .body("[0].telephoneNumber", equalTo("111111"))//
                .body("[0].zipCode", equalTo("1000001"))//
                .body("[0].address", equalTo("Address1"))//
                .body("[0].credential.signId", equalTo("firstname1@test.co.jp"))//
                .body("[1].memberId", startsWith("M0"))//
                .body("[1].firstName", equalTo("FirstName2"))//
                .body("[1].lastName", equalTo("LastName2"))//
                .body("[1].genderCode", equalTo("2"))//
                .body("[1].dateOfBirth", equalTo("2015-01-02"))//
                .body("[1].emailAddress", equalTo("FirstName2@test.co.jp"))//
                .body("[1].telephoneNumber", equalTo("111112"))//
                .body("[1].zipCode", equalTo("2000002"))//
                .body("[1].address", equalTo("Address2"))//
                .body("[1].credential.signId", equalTo("firstname2@test.co.jp"))//
                .body("[2].memberId", startsWith("M0"))//
                .body("[2].firstName", equalTo("FirstName3"))//
                .body("[2].lastName", equalTo("LastName3"))//
                .body("[2].genderCode", equalTo("1"))//
                .body("[2].dateOfBirth", equalTo("2015-01-03"))//
                .body("[2].emailAddress", equalTo("FirstName3@test.co.jp"))//
                .body("[2].telephoneNumber", equalTo("111113"))//
                .body("[2].zipCode", equalTo("3000003"))//
                .body("[2].address", equalTo("Address3"))//
                .body("[2].credential.signId", equalTo(
    ...
    public void testREST0201002() throws Exception {
        ...
        given().filters(new RequestLoggingFilter(captor),
                new ResponseLoggingFilter(captor)).when().get(
                        "/members?name=FirstName&page=0&size=2")//
                .then().statusCode(200).header("content-Type", containsString(
                        MediaType.APPLICATION_JSON_VALUE))//
                .body("content[0].memberId", startsWith("M0"))//
                .body("content[0].firstName", equalTo("FirstName1"))//
                .body("content[0].lastName", equalTo("LastName1"))//
                .body("content[0].genderCode", equalTo("1"))//
                .body("content[0].dateOfBirth", equalTo("2015-01-01"))//
                .body("content[0].emailAddress", equalTo(
                        "FirstName1@test.co.jp"))//
                .body("content[0].telephoneNumber", equalTo("111111"))//
                .body("content[0].zipCode", equalTo("1000001"))//
                .body("content[0].address", equalTo("Address1"))//
                .body("content[0].credential.signId", equalTo(
                        "firstname1@test.co.jp"))//
                .body("content[1].memberId", startsWith("M0"))//
                .body("content[1].firstName", equalTo("FirstName2"))//
                .body("content[1].lastName", equalTo("LastName2"))//
                .body("content[1].genderCode", equalTo("2"))//
                .body("content[1].dateOfBirth", equalTo("2015-01-02"))//
                .body("content[1].emailAddress", equalTo(
                        "FirstName2@test.co.jp"))//
                .body("content[1].telephoneNumber", equalTo("111112"))//
                .body("content[1].zipCode", equalTo("2000002"))//
                .body("content[1].address", equalTo("Address2"))//
                .body("content[1].credential.signId", equalTo(
                        "firstname2@test.co.jp"))//
    ...
    public void testREST0202001() throws Exception {
        ...
        given().body(jsonBody).contentType(ContentType.JSON).filters(
                ...
                .then().statusCode(201).header("content-Type", containsString(
                        MediaType.APPLICATION_JSON_VALUE))//
                .body("memberId", startsWith("M0"))//
                .body("firstName", equalTo(firstName))//
                .body("lastName", equalTo(lastName))//
                .body("genderCode", equalTo(genderCode))//
                .body("dateOfBirth", equalTo(dateOfBirth))//
                .body("emailAddress", equalTo(emailAddress))//
                .body("telephoneNumber", equalTo(telephoneNumber))//
                .body("zipCode", equalTo(zipCode))//
                .body("address", equalTo(address))//
                .body("credential.signId", equalTo("firstname@test.co.jp"))//
                .body("credential.passwordLastChangedAt", equalTo(
                        "2013-12-09T04:50:12.100Z"))//
                .body("credential.lastModifiedAt", equalTo(
                        "2013-12-09T04:50:12.100Z"))//
                .body("createdAt", equalTo("2013-12-09T04:50:12.100Z"))//
                .body("lastModifiedAt", equalTo("2013-12-09T04:50:12.100Z"));//
    }
    ...
    public void testREST0203001() throws Exception {
        ...
        given().filters(new RequestLoggingFilter(captor),
                new ResponseLoggingFilter(captor)).when().get(
                        "/members/{memberId}", memberIds.get(0))//
                .then().statusCode(200)//
                .body("memberId", equalTo(memberIds.get(0)))//
                .body("firstName", equalTo("FirstName" + i))//
                .body("lastName", equalTo("LastName" + i))//
                .body("genderCode", equalTo("1"))//
                .body("dateOfBirth", equalTo("2015-01-0" + i))//
                .body("emailAddress", equalTo("FirstName" + i + "@test.co.jp"))//
                .body("telephoneNumber", equalTo("11111" + i))//
                .body("zipCode", equalTo(i + "00000" + i))//
                .body("address", equalTo("Address" + i))//
    ...
    public void testREST0301001() throws Exception {
        ...
        given().filters(new RequestLoggingFilter(captor),
                ...
                .then().statusCode(405)//
                .body("code", is("e.sf.cmmn.6001"))//
                .body("message", is("Request method not supported."));//
    }
    ...
    public void testREST0302001() throws Exception {
        ...
        given().body(jsonBody).contentType(ContentType.JSON).filters(
                ...
                new ResponseLoggingFilter(captor)).when().post("/members")//
                .then().statusCode(400)//
                .body("code", is("e.sf.cmmn.7007"))//
                .body("message", is(
                        "Validation error occurred on item in the request body."))//
                .body("details.code", hasItems("NotEmpty"))//
                .body("details.message", hasItems("must not be empty"))//
                .body("details.target", hasItems("firstName"));//
    }
    ...
    public void testREST0302002() throws Exception {
        ...
        given().filters(new RequestLoggingFilter(captor),
                ...
                .then().statusCode(400)//
                .body("code", is("e.sf.cmmn.7002"))//
                .body("message", is(
                        "Validation error occurred on item in the request parameters."))//
                .body("details.code", hasItems("NotEmpty"))//
                .body("details.message", hasItems("must not be empty"))//
                .body("details.target", hasItems("name"));//
    ...
    public void testREST0302003() throws Exception {
        ...
        given().body(jsonBody).contentType(ContentType.JSON).filters(
                ...
                new ResponseLoggingFilter(captor)).when().post("/members")//
                .then().statusCode(400)//
                .body("code", is("e.sf.cmmn.7004"))//
                .body("message", is("Unknown field exists in JSON."));//
    }
    ...
    public void testREST0304001() throws Exception {
        ...
        given().filters(new RequestLoggingFilter(captor),
                new ResponseLoggingFilter(captor)).when().put(
                        "/members/businessExp/{memberId}/", memberId)//
                .then().statusCode(409)//
    ...
    public void testREST0305001() throws Exception {
        ...
        given().filters(new RequestLoggingFilter(captor),
                new ResponseLoggingFilter(captor)).when().put(
                        "/members/optimisticExp/")//
                .then().statusCode(409)//
                .body("code", is("e.sf.cmmn.8006"))//
                .body("message", is(
    ...
    public void testREST0401001() throws Exception {
        ...
        given().filters(new RequestLoggingFilter(captor),
                new ResponseLoggingFilter(captor)).when().get(
                        "/members/httpVersionNotSupport")//
                .then().statusCode(505)//
                .body("code", is("e.sf.cmmn.9505"))//
                .body("message", is("HTTP Version not supported."));//
    }
    ...
    public void testREST0401002() throws Exception {
        ...
        given().filters(new RequestLoggingFilter(captor),
                new ResponseLoggingFilter(captor)).when().get(
                        "/members/gatewayTimeout")//
                .then().statusCode(504)//
                .body("code", nullValue())//
                .body("message", is(HttpStatus.GATEWAY_TIMEOUT
                        .getReasonPhrase()));//
    }
    ...
    public void testREST0402001() throws Exception {
        ...
        given().filters(new RequestLoggingFilter(captor),
                new ResponseLoggingFilter(captor)).when().get(
                        "/members/unknownError")//
                .then().statusCode(508).header("content-Type", containsString(
                        MediaType.APPLICATION_JSON_VALUE))//
                .body("code", is("e.sf.cmmn.0508"))//
    ...
    public void testREST0501001() throws Exception {
        ...
        given().filters(new RequestLoggingFilter(captor),
                ...
                .body("links.href[0]", equalTo(applicationContextUrl
    ...
    public void testREST0801001() throws Exception {
        ...
        given().body(jsonBody).contentType(ContentType.JSON).filters(
                ...
                .body("credential.signId", equalTo("firstname" + i
                        + "@test.co.jp"))//
                .body("startDateTime", equalTo("2015-12-16T13:10:04.005"))//
