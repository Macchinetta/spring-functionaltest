 ...
 * </p>
 */
public class DefineValidationMessagesTest extends ValidationTestSupport {
    ...
    public void testVLDT0303001() {
        ...
        String[] targets = {"shortValue", "intValue", "longValue", "floatValue", "doubleValue",
                ...
                "datetime", "localdate", "booleanValue"};
        ...
        // 実施条件1
        {
            // テスト実行
            {
                ...
                webDriverOperations.overrideText(id(targets[10]),
                        dt.toString(super.getLocalDateFormat(currentLocale)));
                webDriverOperations.overrideText(id(targets[11]),
                        dt.toString(super.getLocalDateFormat(currentLocale) + " HH:mm"));
                webDriverOperations.overrideText(id(targets[12]),
                        dt.toString(super.getLocalDateFormat(currentLocale)));
