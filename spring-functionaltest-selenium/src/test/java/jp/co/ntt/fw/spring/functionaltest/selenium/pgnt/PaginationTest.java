...
public class PaginationTest extends FunctionTestSupport {
    ...
    public void testPGNT0101001() throws IOException {
        ...
        assertThat(webDriverOperations.getText(By.xpath("//tr[2]/td")),
                is("20"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[3]/td")),
                is("19"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[4]/td")),
                is("18"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[5]/td")),
                is("17"));
        ...
        assertThat(webDriverOperations.getText(By.xpath("//tr[2]/td[2]")),
                is("Star"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[3]/td[2]")),
                is("Penny"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[4]/td[2]")),
                is("Dick"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[5]/td[2]")),
                is("Angeline"));
    ...
    public void testPGNT0101002() throws IOException {
        ...
        assertThat(webDriverOperations.getText(By.xpath("//tr[10]/td")),
                is("10"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[11]/td")),
                is("11"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[12]/td")),
                is("12"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[13]/td")),
                is("13"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[14]/td")),
                is("14"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[15]/td")),
                is("15"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[16]/td")),
                is("16"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[17]/td")),
                is("17"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[18]/td")),
                is("18"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[19]/td")),
                is("19"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[20]/td")),
                is("20"));
        ...
        assertThat(webDriverOperations.getText(By.xpath("//tr[5]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[6]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[7]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[8]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[9]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[10]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[11]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[12]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[13]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[14]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[15]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[16]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[17]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[18]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[19]/td[2]")),
                is("internal"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[20]/td[2]")),
                is("internal"));

        assertThat(webDriverOperations.getText(By.xpath("//td[3]")),
                is("internal title 001"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[2]/td[3]")),
        ...
        assertThat(webDriverOperations.getText(By.xpath("//td[4]")),
                is("overview0001"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[2]/td[4]")),
                is("overview0002"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[3]/td[4]")),
                is("overview0003"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[4]/td[4]")),
                is("overview0004"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[5]/td[4]")),
                is("overview0005"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[6]/td[4]")),
                is("overview0006"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[7]/td[4]")),
                is("overview0007"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[8]/td[4]")),
                is("overview0008"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[9]/td[4]")),
                is("overview0009"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[10]/td[4]")),
                is("overview0010"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[11]/td[4]")),
                is("overview0011"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[12]/td[4]")),
                is("overview0012"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[13]/td[4]")),
                is("overview0013"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[14]/td[4]")),
                is("overview0014"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[15]/td[4]")),
                is("overview0015"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[16]/td[4]")),
                is("overview0016"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[17]/td[4]")),
                is("overview0017"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[18]/td[4]")),
                is("overview0018"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[19]/td[4]")),
                is("overview0019"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[20]/td[4]")),
                is("overview0020"));

        assertThat(webDriverOperations.getText(By.xpath("//td[5]")),
    ...
    public void testPGNT0101003() throws IOException {
        ...
        assertThat(webDriverOperations.getText(By.xpath("//td")), is("1"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[2000]/td")),
                is("2000"));
    ...
    public void testPGNT0102002() throws IOException {
        ...
        assertThat(webDriverOperations.getText(By.xpath("//tr[5]/td")),
                is("2006"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[6]/td")),
                is("2005"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[7]/td")),
                is("2004"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[8]/td")),
                is("2003"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[9]/td")),
                is("2002"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[10]/td")),
                is("2001"));
    ...
    public void testPGNT0502001() throws IOException {
        ...
        assertThat(webDriverOperations.getText(By
                .xpath("//div[2]/div[2]/ul/li/a")), is("<<"));
        assertThat(webDriverOperations.getText(By
                .xpath("//div[2]/div[2]/ul/li[2]/a")), is("<"));
    ...
    public void testPGNT0502002() throws IOException {
        ...
        assertThat(webDriverOperations.getText(By.xpath("//tr[20]/td")),
                is("20"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[21]/td")),
                is("21"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[22]/td")),
                is("22"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[23]/td")),
                is("23"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[24]/td")),
                is("24"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[25]/td")),
                is("25"));
        assertThat(webDriverOperations.getText(By.xpath("//tr[26]/td")),
                is("26"));
        ...
        // 取得結果の確認
        assertThat(webDriverOperations.getText(By.xpath("//div[4]")),
                is("26 results"));
        assertThat(webDriverOperations.getText(By.xpath("//div[5]")),
                is("1 / 1 Pages"));
    }
