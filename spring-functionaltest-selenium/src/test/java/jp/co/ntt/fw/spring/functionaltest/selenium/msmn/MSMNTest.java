...
public class MSMNTest extends FunctionTestSupport {
    ...
    public void testMSMN0102001() {
        webDriverOperations.click(id("msmn0102001"));
        ...
        if (templateEngineName == TemplateEngineName.Thymeleaf) {
            year = webDriverOperations.getText(By.xpath("//div[2]/form/label[1]"));
            month = webDriverOperations.getText(By.xpath("//div[2]/form/label[2]"));
            day = webDriverOperations.getText(By.xpath("//div[2]/form/label[3]"));
        } else {
            year = webDriverOperations.getText(By.xpath("//*[@id=\"sampleForm\"]/label[1]"));
            month = webDriverOperations.getText(By.xpath("//*[@id=\"sampleForm\"]/label[2]"));
            day = webDriverOperations.getText(By.xpath("//*[@id=\"sampleForm\"]/label[3]"));
        }
    ...
    public void testMSMN0102002() {
        webDriverOperations.click(id("msmn0102002"));
    ...
    public void testMSMN0201001() {
        webDriverOperations.click(id("msmn0201001"));
        webDriverOperations.waitForDisplayed(textToBe(By.id("screenTitle"), "ResultMessageの表示"));

        WebElement div;
        TemplateEngineName templateEngineName = webDriverOperations.getTemplateEngineName();
        if (templateEngineName == TemplateEngineName.Thymeleaf) {
            div = webDriverOperations.getWebDriver().findElement(By.xpath("//div[2]/div"));
        } else {
            div = webDriverOperations.getWebDriver().findElement(By.xpath("//div[2]/div/div/div"));
        }
    ...
    public void testMSMN0202001() {
        webDriverOperations.click(id("msmn0202001"));
        webDriverOperations.waitForDisplayed(textToBe(By.id("screenTitle"), "ResultMessageの表示"));
    ...
    public void testMSMN0203003() {
        webDriverOperations.click(id("msmn0203003"));
        webDriverOperations.waitForDisplayed(textToBe(By.id("screenTitle"), "ResultMessageの表示"));
    ...
    public void testMSMN0205001() {
        webDriverOperations.click(id("msmn0205001"));
        webDriverOperations
        ...
        TemplateEngineName templateEngineName = webDriverOperations.getTemplateEngineName();
        if (templateEngineName == TemplateEngineName.Thymeleaf) {
            divs = webDriverOperations.getWebDriver().findElements(By.xpath("//div[2]/div"));
        } else {
            divs = webDriverOperations.getWebDriver()
                    .findElements(By.xpath("//div[2]/div/div/div"));
        }
    ...
    public void testMSMN0206001() {
        webDriverOperations.click(id("msmn0206"));
        ...
        webDriverOperations.click(id("msmn0206001"));
    ...
    public void testMSMN0206002() {
        ...
        webDriverOperations.click(id("msmn0206002"));
        webDriverOperations.waitForDisplayed(By.className("alert-error"));
    ...
    public void testMSMN0301001() {
        webDriverOperations.click(id("msmn0301001"));
        webDriverOperations.waitForDisplayed(textToBe(By.id("screenTitle"), "ResultMessageの表示"));
    ...
    public void testMSMN0401001() {
        webDriverOperations.click(id("msmn04"));
        webDriverOperations
    ...
    public void testMSMN0501001() {
        webDriverOperations.click(id("msmn05"));
        webDriverOperations
    ...
    public void testMSMN0601002() {
        webDriverOperations.click(id("msmn0601002"));
        webDriverOperations.waitForDisplayed(textToBe(By.id("screenTitle"), "ResultMessageの表示"));
