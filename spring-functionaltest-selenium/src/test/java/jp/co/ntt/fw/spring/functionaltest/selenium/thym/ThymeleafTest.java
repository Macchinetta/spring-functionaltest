...
public class ThymeleafTest extends FunctionTestSupport {
    ...
    public void testTHYM0103001() throws IOException {
        ...
        assertThat(webDriverOperations.getWebDriver().findElement(By.name("searchForm"))
                .getAttribute("action"), is(applicationContextUrl + "/thym"));
    ...
    public void testTHYM0104001() throws IOException {
        ...
        // 検証
        assertThat(webDriverOperations.getTitle(), is("Search No NameSpace Screen"));
        assertThat(webDriverOperations.getText(By.tagName("h1")), is("Search No NameSpace"));
        assertThat(webDriverOperations.getWebDriver().findElement(By.name("searchForm"))
                .getAttribute("action"), is(applicationContextUrl + "/thym"));
    ...
    public void testTHYM0201001() throws IOException {
        ...
        assertThat(webDriverOperations.getText(By.tagName("h1")), is("Search"));
        assertThat(webDriverOperations.getWebDriver().findElement(By.name("searchForm"))
                .getAttribute("action"), is(applicationContextUrl + "/thym/0201/002"));
    ...
    public void testTHYM0401001() throws IOException {
        ...
        ResponseEntity<byte[]> entity = restTemplate
                .getForEntity(applicationContextUrl + "/thym/0401/001.json", byte[].class);
    ...
    public void testTHYM0402001() throws IOException {
        ...
        // .jsonの拡張子付きURLでリクエスト
        ResponseEntity<byte[]> entity = restTemplate
                .getForEntity(applicationContextUrl + "/thym/0402/001.json", byte[].class);
    ...
    public void testTHYM0803001() throws IOException {
        ...
        ResponseEntity<String> entity = restTemplate.getForEntity(
                applicationContextUrl + "/thym/0803/javascript/thym0803.js", String.class);
    ...
    public void testTHYM0803002() throws IOException {
        ...
        try {
            restTemplate.getForEntity(
                    applicationContextUrl + "/thym/0803/resources/app/js/welcome.js", byte[].class);
    ...
    public void testTHYM0803003() throws IOException {
        // テンプレートJavaScriptへのアクセス
        ResponseEntity<String> entity = restTemplate.getForEntity(
                applicationContextUrl + "/thym/0803/003/resources/app/js/thym0803003.js",
                String.class);
