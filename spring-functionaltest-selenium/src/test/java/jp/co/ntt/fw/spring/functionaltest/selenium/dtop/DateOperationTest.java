...
public class DateOperationTest extends FunctionTestSupport {
    ...
    public void testDTOP0101003() {
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getDateResult")), is("13:50:12"));
        }
    }
    ...
    public void testDTOP0102001() {
        ...
        {
            webDriverOperations.appendText(id("targetTimeZone"), "America/Los_Angeles");
    ...
    public void testDTOP0103001() {
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getDateResultYear")), is("2013"));
            assertThat(webDriverOperations.getText(id("getDateResultMonth")), is("12"));
            assertThat(webDriverOperations.getText(id("getDateResultDay")), is("9"));
            assertThat(webDriverOperations.getText(id("getDateResultWeek")), is("1"));
            assertThat(webDriverOperations.getText(id("getDateResultHour")), is("13"));
            assertThat(webDriverOperations.getText(id("getDateResultMinute")), is("50"));
            assertThat(webDriverOperations.getText(id("getDateResultSecond")), is("12"));
            assertThat(webDriverOperations.getText(id("getDateResultMillis")), is("100"));
        }
    }
    ...
    public void testDTOP0301001() {
        ...
        {
            webDriverOperations.appendText(id("targetIncDecDate"), "2013/12/09");
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2013/12/10"));
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2013/12/08"));
        }
    }
    ...
    public void testDTOP0301002() {
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2014/01/09"));
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2013/11/09"));
        }
    }
    ...
    public void testDTOP0301003() {
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2014/12/09"));
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2012/12/09"));
        }
    }
    ...
    public void testDTOP0301004() {
        ...
        {
            webDriverOperations.appendText(id("targetIncDecDate"), "2012/02/28");
            webDriverOperations.appendText(id("targetIncreaseNum"), "1");
            webDriverOperations.appendText(id("targetDecreaseNum"), "1");
            webDriverOperations.click(id("calcDayDate"));
        }
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2012/02/29"));
        }
        ...
        {
            webDriverOperations.appendText(id("targetIncDecDate"), "2012/03/01");
            webDriverOperations.appendText(id("targetIncreaseNum"), "1");
            webDriverOperations.appendText(id("targetDecreaseNum"), "1");
            webDriverOperations.click(id("calcDayDate"));
        }
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2012/02/29"));
        }
    }
    ...
    public void testDTOP0301005() {
        ...
        {
            webDriverOperations.appendText(id("targetIncDecDate"), "2012/01/31");
            webDriverOperations.appendText(id("targetIncreaseNum"), "1");
            webDriverOperations.appendText(id("targetDecreaseNum"), "1");
            webDriverOperations.click(id("calcMonthDate"));
        }
        ...
        {
            webDriverOperations.appendText(id("targetIncDecDate"), "2012/03/31");
            webDriverOperations.appendText(id("targetIncreaseNum"), "1");
            webDriverOperations.appendText(id("targetDecreaseNum"), "1");
            webDriverOperations.click(id("calcMonthDate"));
        }
    ...
    public void testDTOP0301006() {
        ...
        {
            webDriverOperations.appendText(id("targetIncDecDate"), "2012/02/29");
            webDriverOperations.appendText(id("targetIncreaseNum"), "1");
            webDriverOperations.appendText(id("targetDecreaseNum"), "1");
            webDriverOperations.click(id("calcYearDate"));
        }
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2013/02/28"));
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2011/02/28"));
        }
    }
    ...
    public void testDTOP0302001() {
        ...
        {
            webDriverOperations.appendText(id("targetStartEndDate"), "2013/12/09");
            webDriverOperations.click(id("calcMonthStartEndDate"));
        }

        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2013/12/31"));
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2013/12/01"));
        }
    }
    ...
    public void testDTOP0302002() {
        ...
        {
            webDriverOperations.appendText(id("targetStartEndDate"), "2012/02/15");
            webDriverOperations.click(id("calcMonthStartEndDate"));
        }
        ...
        {
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2012/02/29"));
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2012/02/01"));
        }
    }
    ...
    public void testDTOP0303001() {
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2012/02/19"));
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2012/02/13"));
        }
    }
    ...
    public void testDTOP0303002() {
        ...
        {
            webDriverOperations.appendText(id("targetStartEndDate"), "2004/02/27");
            webDriverOperations.click(id("calcWeekStartEndDate"));
        }

        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2004/02/29"));
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2004/02/23"));
        }
        ...
        {
            webDriverOperations.appendText(id("targetStartEndDate"), "2016/03/01");
            webDriverOperations.click(id("calcWeekStartEndDate"));
        }

        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2016/03/06"));
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2016/02/29"));
        }
    }
    ...
    public void testDTOP0401001() {
        ...
        // 「期間クラス1」の期間に、「日付クラス」の期間が含まれているかチェックを行う。
        {
            assertThat(webDriverOperations.getText(id("getResult")), is("false"));
        }
        ...
        // 「期間クラス1」、「期間クラス2」を取得。(確認3)
        {
            webDriverOperations.appendText(id("targetTermFrom"), "2013/11/01");
            webDriverOperations.appendText(id("targetTermTo"), "2013/11/11");
            webDriverOperations.appendText(id("targetCheckTermFrom"), "2013/11/01");
            webDriverOperations.appendText(id("targetCheckTermTo"), "2013/11/02");
        ...
        // 「期間クラス1」、「期間クラス3」を取得。(確認4)
        {
            webDriverOperations.appendText(id("targetTermFrom"), "2013/11/01");
            webDriverOperations.appendText(id("targetTermTo"), "2013/11/11");
            webDriverOperations.appendText(id("targetCheckTermFrom"), "2013/11/12");
            webDriverOperations.appendText(id("targetCheckTermTo"), "2013/11/13");
            webDriverOperations.click(id("checkContainTermToTerm"));
        }
    ...
    public void testDTOP0401002() {
        ...
        // 「期間クラス1」、「期間クラス2」を取得。(確認1)
        {
            webDriverOperations.appendText(id("targetTermFrom"), "2013/11/01");
            webDriverOperations.appendText(id("targetTermTo"), "2013/11/11");
            webDriverOperations.appendText(id("targetCheckTermFrom"), "2013/11/11");
            webDriverOperations.appendText(id("targetCheckTermTo"), "2013/11/13");
    ...
    public void testDTOP0401003() {
        ...
        {
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2013/11/11"));
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2013/11/12"));
        }
        ...
        {
            assertThat(webDriverOperations.getText(id("getDateResult")), is("なし"));
        }
    ...
    public void testDTOP0401004() {
        ...
        {
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2013/11/12"));
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2013/11/13"));
        }
    }
    ...
    public void testDTOP0401005() {
        ...
        // 「期間クラス1」、「期間クラス2」を取得。(確認3)
        {
            webDriverOperations.appendText(id("targetTermFrom"), "2012/02/27");
            webDriverOperations.appendText(id("targetTermTo"), "2012/02/29");
            webDriverOperations.appendText(id("targetCheckTermFrom"), "2012/02/28");
            webDriverOperations.appendText(id("targetCheckTermTo"), "2012/02/29");
            webDriverOperations.click(id("checkContainTermToTerm"));
        }
        ...
        // 「期間クラス1」、「期間クラス3」を取得。(確認4)
        {
            webDriverOperations.appendText(id("targetTermFrom"), "2012/02/27");
            webDriverOperations.appendText(id("targetTermTo"), "2012/02/29");
            webDriverOperations.appendText(id("targetCheckTermFrom"), "2012/02/29");
            webDriverOperations.appendText(id("targetCheckTermTo"), "2012/03/01");
            webDriverOperations.click(id("checkContainTermToTerm"));
        }
    ...
    public void testDTOP0401006() {
        ...
        // 「期間クラス1」、「期間クラス2」を取得。(確認1)
        {
            ...
            webDriverOperations.appendText(id("targetTermTo"), "2012/02/29");
            webDriverOperations.appendText(id("targetCheckTermFrom"), "2012/02/29");
            webDriverOperations.appendText(id("targetCheckTermTo"), "2012/03/02");
            webDriverOperations.click(id("checkAbutsTerm"));
        }
        ...
        // 「期間クラス1」、「期間クラス3」を取得。(確認2)
        {
            webDriverOperations.appendText(id("targetTermFrom"), "2012/02/28");
            webDriverOperations.appendText(id("targetTermTo"), "2012/02/29");
            webDriverOperations.appendText(id("targetCheckTermFrom"), "2012/03/01");
            webDriverOperations.appendText(id("targetCheckTermTo"), "2012/03/03");
            webDriverOperations.click(id("checkAbutsTerm"));
        }
    ...
    public void testDTOP0401007() {
        ...
        {
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2012/02/29"));
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2012/03/01"));
        }
    ...
    public void testDTOP0401008() {
        ...
        {
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2012/02/28"));
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2012/02/29"));
        }
    ...
    public void testDTOP0402001() {
        ...
        {
            webDriverOperations.appendText(id("targetIncDecDate"), "2013/03/01");
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2013/04/01"));
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2013/02/01"));
        }
        ...
        // 指定した日時を設定したPeriodクラスから指定した単一期間（月のみ）を増減した場合に、指定した値分増減した日付が取得する。
        {
            webDriverOperations.appendText(id("targetIncDecDate"), "2013/04/01");
            webDriverOperations.appendText(id("targetIncreaseMonthNum"), "1");
            webDriverOperations.appendText(id("targetDecreaseMonthNum"), "1");
            webDriverOperations.click(id("calcMonthDate"));
        }
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2013/05/01"));
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2013/03/01"));
        }
    }
    ...
    public void testDTOP0402002() {
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2013/04/11"));
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2013/01/22"));
        }
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getStartDateResult")), is("2013/05/11"));
            assertThat(webDriverOperations.getText(id("getEndDateResult")), is("2013/02/19"));
        }
    }
    ...
    public void testDTOP0501001() {
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getDateResult")),
                    is("2013/12/09 13:50:12.100 +09:00"));
            assertThat(webDriverOperations.getText(id("getResultStyle")), is("13/12/09 13:50:12"));
        }
    }
    ...
    public void testDTOP0501003() {
        ...
        {
            assertThat(webDriverOperations.getText(id("getDateResult")), is("2013/12/09"));
            assertThat(webDriverOperations.getText(id("getResultStyle")), is("13/12/09"));
        }
    }
    ...
    public void testDTOP0501004() {
        ...
        {
            assertThat(webDriverOperations.getText(id("getDateResult")), is("13:50:12"));
            assertThat(webDriverOperations.getText(id("getResultStyle")), is("13:50:12"));
        }
    }
    ...
    public void testDTOP0601001() {
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getDateResult")), is("H25.12.09"));
        }
    }
    ...
    public void testDTOP0601002() {
        ...
        // 取得した文字列を確認
        {
            assertThat(webDriverOperations.getText(id("getDateResult")), is("平成25/12/09"));
        }
    }
