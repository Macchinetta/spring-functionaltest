...
public class ExceptionHandlingTest extends FunctionTestSupport {
    ...
    public void testEXHN0202001() throws IOException {
        ...
        restOperations.getForEntity(
                applicationContextUrl + "/exhn/delete?temporaryFileName=" + temporaryFileName,
                String.class);
    ...
    public void testEXHN0203001() throws IOException, InterruptedException {
        ...
        restOperations.getForEntity(applicationContextUrl
                + "/exhn/copy/temporaryFile?temporaryFileName=" + temporaryFileName, void.class);
    ...
    public void testEXHN0601001() throws IOException {
        ...
        try {
            restOperations.getForEntity(
                    applicationContextUrl + "/exhn/0601/register?uploadTemporaryFileId="
    ...
    public void testEXHN0601002() throws IOException {
        ...
        try {
            restOperations.getForEntity(
                    applicationContextUrl + "/exhn/0601/002/register?uploadTemporaryFileId="
                            + temporaryFileName + "&title=test&fileName=exhn.html&upload",
                    String.class);
        } catch (HttpServerErrorException e) {
            // ヘッダに設定された値の整合性確認
    ...
    public void testEXHN0601006() throws IOException {
        ...
        webDriverOperations.click(id("exhn0601006"));
     ...
     */
    @Test
    public void testEXHN0601007() throws IOException {

        webDriverOperations.click(id("exhn0601007"));
    ...
    public void testEXHN0701001() throws IOException {
        try {
            restOperations.headForHeaders(applicationContextUrl + "/exhn/0701/001");
    ...
    public void testEXHN0701002() throws IOException {
        try {
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/002", String.class);
        } catch (HttpClientErrorException e) {
            // 415 が返却されていること
    ...
    public void testEXHN0701003() throws IOException {
        try {
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/003", String.class);
        } catch (HttpClientErrorException e) {
            // 406 が返却されていること
    ...
    public void testEXHN0701004() throws IOException {
        try {
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/004", String.class);
        } catch (HttpServerErrorException e) {
            // 500 が返却されていること
    ...
    public void testEXHN0701005() throws IOException {
        try {
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/005", String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
    ...
    public void testEXHN0701006() throws IOException {
        try {
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/006", String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.BAD_REQUEST));
    ...
    public void testEXHN0701007() throws IOException {
        try {
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/007", String.class);
        } catch (HttpServerErrorException e) {
            // 500 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.INTERNAL_SERVER_ERROR));
    ...
    public void testEXHN0701008() throws IOException {
        try {
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/008?id=a",
                    String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.BAD_REQUEST));
    ...
    public void testEXHN0701009() throws IOException {
        try {
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/009", String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.BAD_REQUEST));
    ...
    public void testEXHN0701010() throws IOException {
        try {
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/010", String.class);
        } catch (HttpServerErrorException e) {
            // 500 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.INTERNAL_SERVER_ERROR));
    ...
    public void testEXHN0701011() throws IOException {
        try {
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/011", String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.BAD_REQUEST));
    ...
    public void testEXHN0701012() throws IOException {
        try {
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/012", String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.BAD_REQUEST));
    ...
    public void testEXHN0701013() throws IOException {
        try {
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/013", String.class);
        } catch (HttpClientErrorException e) {
            // 400 が返却されていること
            assertThat(e.getStatusCode(), is(HttpStatus.BAD_REQUEST));
    ...
    public void testEXHN0701014() throws IOException {
        try {
            // 存在しないパスを指定する。
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/014", String.class);
    ...
    public void testEXHN0701015() throws IOException {
        try {
            restOperations.getForEntity(applicationContextUrl + "/exhn/0701/015", String.class);
        } catch (HttpServerErrorException e) {
            // 503 が返却されていること
    ...
    public void testEXHN0701016() throws IOException {
        try {
            ResponseEntity<String> res = restOperations
                    .getForEntity(applicationContextUrl + "/exhn/0701/016", String.class);
    ...
    public void deleteTempDirectoryAndFiles() {
        restOperations.getForEntity(applicationContextUrl + "/exhn/delete/all", void.class);
    }
}
