...
public class RestClientServiceImpl implements RestClientService {
    ...
    public UserResource exchangeWithSourceHttpMessageConverter(UserResource user) {
        ...
        ResponseEntity<DOMSource> res = this.restTemplate.exchange(requestEntity, DOMSource.class);
        ...
        resUser.setName(doc.getElementsByTagName("name").item(0).getFirstChild().getNodeValue());
        resUser.setAge(Integer
                .parseInt(doc.getElementsByTagName("age").item(0).getFirstChild().getNodeValue()));
