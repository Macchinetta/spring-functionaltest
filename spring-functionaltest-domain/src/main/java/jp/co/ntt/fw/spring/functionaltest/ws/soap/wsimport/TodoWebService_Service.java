 ...
 * 2.2
 */
@WebServiceClient(name = "TodoWebService",
        targetNamespace = "http://functionaltest.spring.fw.ntt.co.jp/todo",
        wsdlLocation = "http://localhost:8080/spring-functionaltest-web/ws/TodoWebService?wsdl")
public class TodoWebService_Service extends Service {
    ...
    private final static QName TODOWEBSERVICE_QNAME =
    ...
    public TodoWebService_Service(URL wsdlLocation, WebServiceFeature... features) {
