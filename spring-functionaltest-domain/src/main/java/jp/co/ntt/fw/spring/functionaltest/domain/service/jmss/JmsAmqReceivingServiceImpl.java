...
public class JmsAmqReceivingServiceImpl implements JmsAmqReceivingService {
    ...
    @Override
    public void receiveMessageByJmsMessage(javax.jms.TextMessage message)
    ...
    @Override
    public void receiveMessageMany(javax.jms.TextMessage message)
    ...
    @Override
    public void receiveMessageByCallback(javax.jms.TextMessage message)
            throws IOException, JMSException {
    ...
    public boolean receiveMessage_TxSndOK(String id)
        ...
        List<javax.jms.Message> msgs = jmsSharedService.getMessagesSelected(jndiConCacheJmsTemplate,
                distinationName, messageSelector);
